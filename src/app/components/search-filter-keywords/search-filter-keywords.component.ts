...
@Component({
  selector: 'app-search-filter-keywords',
  standalone: true,
  imports: [CommonModule],
  templateUrl: './search-filter-keywords.component.html',
  styleUrl: './search-filter-keywords.component.scss'
})
export class SearchFilterKeywordsComponent {
