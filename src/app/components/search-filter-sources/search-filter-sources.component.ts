...
@Component({
  selector: 'app-search-filter-sources',
  standalone: true,
  imports: [CommonModule],
  templateUrl: './search-filter-sources.component.html',
  styleUrl: './search-filter-sources.component.scss'
})
export class SearchFilterSourcesComponent {
