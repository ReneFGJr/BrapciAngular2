...
.tools-wrap[_ngcontent-ng-c330138268] {
  color: var(--theme-ink);
}
.tools-card[_ngcontent-ng-c330138268] {
  background: var(--theme-card-bg);
  border: 1px solid var(--theme-line);
  border-radius: 0.9rem;
}
.tools-eyebrow[_ngcontent-ng-c330138268] {
  font-size: 0.78rem;
  letter-spacing: 0.16rem;
  margin: 0;
  text-transform: uppercase;
}
.tools-subtitle[_ngcontent-ng-c330138268] {
  color: var(--theme-hint);
}
.tool-item[_ngcontent-ng-c330138268] {
  background: var(--theme-sand);
  border: 1px solid var(--theme-line);
  border-radius: 0.65rem;
}
.tool-item[_ngcontent-ng-c330138268]   p[_ngcontent-ng-c330138268] {
  color: var(--theme-hint);
}
.tool-item-link[_ngcontent-ng-c330138268] {
  color: inherit;
  text-decoration: none;
  transition:
    border-color 0.2s ease,
...
.tool-item-link[_ngcontent-ng-c330138268]:hover, 
.tool-item-link[_ngcontent-ng-c330138268]:focus-visible {
  border-color: var(--theme-link);
  box-shadow: 0 0.35rem 1rem rgba(0, 0, 0, 0.08);
  transform: translateY(-2px);
}
/*# sourceMappingURL=/tools-bibliografics.page.css.map */</style><style ng-app-id="ng">
