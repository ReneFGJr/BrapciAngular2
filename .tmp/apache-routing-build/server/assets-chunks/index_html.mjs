...
.loading-screen[_ngcontent-ng-c1627500460] {
  min-height: 60vh;
  display: grid;
  place-items: center;
  text-align: center;
...
p[_ngcontent-ng-c1627500460] {
  font-size: 1.25rem;
}
.loading-spinner[_ngcontent-ng-c1627500460] {
  display: inline-block;
  width: 3rem;
  height: 3rem;
  ...
  border-radius: 50%;
  animation: _ngcontent-ng-c1627500460_loading-spin 0.8s linear infinite;
}
@keyframes _ngcontent-ng-c1627500460_loading-spin {
  to {
...
/*# sourceMappingURL=/home.page.css.map */</style></head>
