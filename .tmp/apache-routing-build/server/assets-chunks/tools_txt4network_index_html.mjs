...
.txt4network-wrap[_ngcontent-ng-c1932443238] {
  color: var(--theme-ink);
}
.txt4network-card[_ngcontent-ng-c1932443238] {
  background: var(--theme-card-bg);
  border: 1px solid var(--theme-line);
  border-radius: 0.9rem;
}
.txt4network-subtitle[_ngcontent-ng-c1932443238] {
  color: var(--theme-hint);
}
textarea[_ngcontent-ng-c1932443238] {
  resize: vertical;
}
.instructions-card[_ngcontent-ng-c1932443238] {
  background: var(--theme-sand);
  border: 1px solid var(--theme-line);
  border-radius: 0.65rem;
}
.instructions-card[_ngcontent-ng-c1932443238]   li[_ngcontent-ng-c1932443238]    + li[_ngcontent-ng-c1932443238] {
  margin-top: 0.65rem;
}
/*# sourceMappingURL=/tools-txt4network.page.css.map */</style><style ng-app-id="ng">
