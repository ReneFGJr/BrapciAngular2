...
.term4net-wrap[_ngcontent-ng-c2531449199] {
  color: var(--theme-ink);
}
.term4net-card[_ngcontent-ng-c2531449199] {
  background: var(--theme-card-bg);
  border: 1px solid var(--theme-line);
  border-radius: 0.9rem;
}
.term4net-subtitle[_ngcontent-ng-c2531449199] {
  color: var(--theme-hint);
}
textarea[_ngcontent-ng-c2531449199] {
  resize: vertical;
}
/*# sourceMappingURL=/tools-term4net.page.css.map */</style><style ng-app-id="ng">
