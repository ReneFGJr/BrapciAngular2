...
.specialist-wrap[_ngcontent-ng-c3576694464] {
  color: var(--theme-ink);
}
.specialist-card[_ngcontent-ng-c3576694464] {
  background: var(--theme-card-bg);
  border: 1px solid var(--theme-line);
  border-radius: 0.9rem;
}
.specialist-subtitle[_ngcontent-ng-c3576694464] {
  color: var(--theme-hint);
}
textarea[_ngcontent-ng-c3576694464] {
  resize: vertical;
}
.result[_ngcontent-ng-c3576694464] {
  background: var(--theme-sand);
  border: 1px solid var(--theme-line);
...
.result-content[_ngcontent-ng-c3576694464] {
  margin: 0;
  overflow-wrap: anywhere;
  white-space: pre-wrap;
}
/*# sourceMappingURL=/tools-text-specialist.page.css.map */</style><style ng-app-id="ng">
