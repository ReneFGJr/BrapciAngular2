...
var ToolsBibliometricPage = class _ToolsBibliometricPage {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ToolsBibliometricPage, selectors: [["app-tools-bibliometric-page"]], decls: 41, vars: 27, consts: [["aria-labelledby", "tools-bibliometric-title", 1, "tools-wrap", "py-4"], [1, "container"], [1, "tools-card", "p-4", "p-md-5"], [1, "tools-eyebrow", "mb-2"], ["id", "tools-bibliometric-title", 1, "h2", "mb-2"], [1, "tools-subtitle", "mb-4"], [1, "row", "g-3"], [1, "col-12", "col-md-6"], ["href", "/tools/txt4net", 1, "d-block", "h-100", "text-decoration-none", "text-reset"], [1, "tool-item", "p-3", "h-100"], [1, "h5", "mb-2"], [1, "mb-0"], ["href", "/tools/term4net", 1, "d-block", "h-100", "text-decoration-none", "text-reset"], ["href", "/tools/txt4network", 1, "d-block", "h-100", "text-decoration-none", "text-reset"]], template: function ToolsBibliometricPage_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275pipe(31, "translate");
      \u0275\u0275elementEnd()()()();
      \u0275\u0275elementStart(32, "div", 7)(33, "a", 13)(34, "article", 9)(35, "h2", 10);
      \u0275\u0275text(36);
      \u0275\u0275pipe(37, "translate");
      \u0275\u0275elementEnd();
    ...
    if (rf & 2) {
      ...
      \u0275\u0275advance(3);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(9, 11, "tools.bibliometric.title"));
      \u0275\u0275advance(3);
      \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(12, 13, "tools.bibliometric.subtitle"), " ");
      \u0275\u0275advance(7);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(19, 15, "tools.bibliometric.card1Title"));
      \u0275\u0275advance(3);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(22, 17, "tools.bibliometric.card1Text"));
      \u0275\u0275advance(6);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(28, 19, "tools.bibliometric.card2Title"));
      \u0275\u0275advance(3);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(31, 21, "tools.bibliometric.card2Text"));
      \u0275\u0275advance(6);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(37, 23, "tools.bibliometric.card3Title"));
      \u0275\u0275advance(3);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(40, 25, "tools.bibliometric.card3Text"));
    }
...
\r
      <div class="row g-3">\r
        <div class="col-12 col-md-6">\r
          <a href="/tools/txt4net" class="d-block h-100 text-decoration-none text-reset">\r
        ...
        <div class="col-12 col-md-6">\r
          <a href="/tools/term4net" class="d-block h-100 text-decoration-none text-reset">\r
            <article class="tool-item p-3 h-100">\r
        ...
        <div class="col-12 col-md-6">\r
          <a href="/tools/txt4network" class="d-block h-100 text-decoration-none text-reset">\r
            <article class="tool-item p-3 h-100">\r
              <h2 class="h5 mb-2">{{ 'tools.bibliometric.card3Title' | translate }}</h2>\r
              <p class="mb-0">{{ 'tools.bibliometric.card3Text' | translate }}</p>\r
            </article>\r
          </a>\r
        </div>\r
      </div>\r
...
//# sourceMappingURL=chunk-ANS57JTZ.js.map
