...
var routes = [
  ...
  __spreadValues({
    path: "chat",
    loadChildren: () => import("./chunk-OLX6FZLM.js").then((m) => m.CHAT_ROUTES)
  }, false ? { \u0275entryName: "src/app/chat/chat.routes.ts" } : {}),
  __spreadValues({
    path: "autoridade",
    loadComponent: () => import("./chunk-GLVXOR56.js").then((m) => m.AutoridadePage)
  }, false ? { \u0275entryName: "src/app/pages/autoridade/autoridade.page.ts" } : {}),
  __spreadValues({
    path: "v/:id",
    loadComponent: () => import("./chunk-WCOZXJ5O.js").then((m) => m.VIdPage)
  }, false ? { \u0275entryName: "src/app/pages/v-id/v-id.page.ts" } : {}),
  __spreadValues({
    path: "admin/a/:id",
    canActivate: [adminGuard],
    loadComponent: () => import("./chunk-NGMQGD6G.js").then((m) => m.AdminEditPage)
  ...
  __spreadValues({
    ...
    loadComponent: () => import("./chunk-3QQY66MC.js").then((m) => m.BasketSelectedPage)
  }, false ? { \u0275entryName: "src/app/pages/basket-selected/basket-selected.page.ts" } : {}),
  __spreadValues({
    path: "painel",
    loadComponent: () => import("./chunk-KM36KN7W.js").then((m) => m.PainelPage)
  }, false ? { \u0275entryName: "src/app/pages/painel/painel.page.ts" } : {}),
  __spreadValues({
    path: "about/:page",
    loadComponent: () => import("./chunk-B56M3ATX.js").then((m) => m.SobreBrapciPage)
  }, false ? { \u0275entryName: "src/app/pages/sobre-brapci/sobre-brapci.page.ts" } : {}),
  __spreadValues({
    path: "doc",
    loadComponent: () => import("./chunk-H2BRTQRH.js").then((m) => m.DocPage)
  }, false ? { \u0275entryName: "src/app/pages/doc/doc.page.ts" } : {}),
  __spreadValues({
    path: "pq",
    loadComponent: () => import("./chunk-YABO6NCJ.js").then((m) => m.PqPage)
  }, false ? { \u0275entryName: "src/app/pages/pq/pq.page.ts" } : {}),
  __spreadValues({
    path: "revistas",
    loadComponent: () => import("./chunk-2KBOTYLX.js").then((m) => m.RevistasPage)
  }, false ? { \u0275entryName: "src/app/pages/revistas/revistas.page.ts" } : {}),
  __spreadValues({
    path: "revistas/avaliation",
    loadComponent: () => import("./chunk-XGLNAZEX.js").then((m) => m.RevistaAvaliationPage)
  }, false ? { \u0275entryName: "src/app/pages/revista-avaliation/revista-avaliation.page.ts" } : {}),
  __spreadValues({
    path: "revistas/timeline",
    loadComponent: () => import("./chunk-BHR3HWVM.js").then((m) => m.RevistaTimelinePage)
  ...
  __spreadValues({
    path: "cited",
    loadComponent: () => import("./chunk-LFW3ZAW2.js").then((m) => m.CitedPage)
  }, false ? { \u0275entryName: "src/app/pages/cited/cited.page.ts" } : {}),
  __spreadValues({
    path: "small_world",
    loadComponent: () => import("./chunk-G7JDELQ6.js").then((m) => m.SmallWorldPage)
  }, false ? { \u0275entryName: "src/app/pages/small-world/small-world.page.ts" } : {}),
  __spreadValues({
    path: "statistics",
    loadComponent: () => import("./chunk-AGG4TX2A.js").then((m) => m.StatisticsPage)
  }, false ? { \u0275entryName: "src/app/pages/statistics/statistics.page.ts" } : {}),
  __spreadValues({
    path: "monitor",
    loadComponent: () => import("./chunk-N763DRCB.js").then((m) => m.MonitorPage)
  }, false ? { \u0275entryName: "src/app/pages/monitor/monitor.page.ts" } : {}),
  __spreadValues({
    path: "",
    loadComponent: () => import("./chunk-XOTOBH7J.js").then((m) => m.HomePage)
