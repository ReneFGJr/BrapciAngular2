...
(() => {
  ...
  </aside>@if(open()){<button class="backdrop" type="button" (click)="close.emit()" aria-label="Fechar menu"></button>}`, styles: ["/* angular:styles/component:scss;c74cd1006db68ef719742a3ee248618b8b8ac8c730afa6de8fe2f782f62f0822;D:/www/BrapciAngular2/src/app/chat/components/chat-sidebar/chat-sidebar.component.ts */\n.sidebar {\n  width: 17rem;\n  flex: 0 0 17rem;\n  background: #242238;\n  color: #eeedf7;\n  padding: 0.75rem;\n  display: flex;\n  flex-direction: column;\n  gap: 0.7rem;\n  min-height: 0;\n  z-index: 20;\n  transition: width 0.2s, transform 0.2s;\n}\n.brand {\n  height: 2.6rem;\n  display: flex;\n  align-items: center;\n  gap: 0.55rem;\n  padding: 0 0.4rem;\n}\n.brand > i {\n  color: #b8afea;\n}\n.brand button {\n  margin-left: auto;\n  border: 0;\n  background: transparent;\n  color: #cfcbdf;\n}\n.new-chat {\n  display: flex;\n  align-items: center;\n  gap: 0.6rem;\n  border: 1px solid #55506d;\n  border-radius: 0.65rem;\n  background: #312e49;\n  color: #fff;\n  padding: 0.65rem 0.75rem;\n  text-align: left;\n}\n.search {\n  display: flex;\n  align-items: center;\n  gap: 0.5rem;\n  background: #1d1b2d;\n  border-radius: 0.55rem;\n  padding: 0.5rem 0.65rem;\n}\n.search input {\n  min-width: 0;\n  width: 100%;\n  border: 0;\n  outline: 0;\n  background: transparent;\n  color: #fff;\n}\n.section-title {\n  display: flex;\n  justify-content: space-between;\n  color: #aaa5bd;\n  font-size: 0.7rem;\n  font-weight: 700;\n  text-transform: uppercase;\n  letter-spacing: 0.08em;\n  padding: 0.7rem 0.55rem 0.3rem;\n}\n.section-title button {\n  border: 0;\n  background: transparent;\n  color: #aaa5bd;\n}\n.recent {\n  margin-top: 0.55rem;\n}\n.item {\n  width: 100%;\n  display: flex;\n  align-items: center;\n  gap: 0.55rem;\n  border: 0;\n  border-radius: 0.5rem;\n  background: transparent;\n  color: #d9d7e3;\n  padding: 0.55rem;\n  text-align: left;\n}\n.item span {\n  overflow: hidden;\n  text-overflow: ellipsis;\n  white-space: nowrap;\n}\n.item:hover,\n.item.active {\n  background: #3b3755;\n  color: #fff;\n}\n.chat-row {\n  display: flex;\n  align-items: center;\n  flex-wrap: nowrap;\n  border-radius: 0.5rem;\n  padding: 0.15rem;\n}\n.chat-open,\n.chat-title,\n.delete-chat {\n  border: 0;\n  box-shadow: none;\n  background: transparent;\n}\n.chat-open {\n  color: #d9d7e3;\n  padding: 0.4rem;\n}\n.chat-title {\n  min-width: 0;\n  flex: 1 1 auto;\n  overflow: hidden;\n  text-overflow: ellipsis;\n  white-space: nowrap;\n  color: #d9d7e3;\n  padding: 0.4rem 0.15rem;\n  text-align: left;\n}\n.chat-title:hover {\n  text-decoration: underline;\n}\n.delete-chat {\n  display: inline-flex;\n  align-items: center;\n  flex: 0 0 auto;\n  color: #dc3545;\n  padding: 0.25rem 0.4rem;\n}\n.title-editor {\n  min-width: 0;\n  flex: 1 1 auto;\n  border: 1px solid #8c82c7;\n  border-radius: 0.3rem;\n  outline: 0;\n  background: #1d1b2d;\n  color: #fff;\n  padding: 0.32rem 0.4rem;\n}\n.collapsed .chat-title,\n.collapsed .delete-chat,\n.collapsed .title-editor {\n  display: none;\n}\nnav {\n  overflow: auto;\n  flex: 1;\n}\n.back {\n  color: #c8c4d7;\n  text-decoration: none;\n  padding: 0.55rem;\n  display: flex;\n  gap: 0.55rem;\n}\n.collapsed {\n  width: 4.2rem;\n  flex-basis: 4.2rem;\n}\n.collapsed strong,\n.collapsed span,\n.collapsed .search,\n.collapsed .section-title {\n  display: none;\n}\n.collapsed .brand button {\n  margin-left: 0;\n}\n.collapsed .new-chat,\n.collapsed .item {\n  justify-content: center;\n}\n.backdrop {\n  display: none;\n}\n@media (max-width: 850px) {\n  .sidebar {\n    position: fixed;\n    inset: 0 auto 0 0;\n    transform: translateX(-105%);\n    width: min(18rem, 86vw) !important;\n  }\n  .sidebar.open {\n    transform: translateX(0);\n  }\n  .backdrop {\n    display: block;\n    position: fixed;\n    inset: 0;\n    border: 0;\n    background: rgba(0, 0, 0, 0.45);\n    z-index: 15;\n  }\n}\n/*# sourceMappingURL=chat-sidebar.component.css.map */\n"] }]
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(ModelSelectorComponent, [{
    ...
    </select>`, styles: ["/* angular:styles/component:scss;d891ef96da0f38f758d2d7730fba6fb5d977eaa559edd42f7e39e61f128b8044;D:/www/BrapciAngular2/src/app/chat/components/model-selector/model-selector.component.ts */\n.model-label {\n  display: block;\n  font-size: 0.7rem;\n  font-weight: 700;\n  letter-spacing: 0.08em;\n  text-transform: uppercase;\n  color: var(--theme-hint);\n  margin-bottom: 0.2rem;\n}\n.form-select {\n  min-width: 11rem;\n  background-color: var(--theme-card-bg);\n  color: var(--theme-ink);\n  border-color: var(--theme-line);\n}\n/*# sourceMappingURL=model-selector.component.css.map */\n"] }]
...
(() => {
  ...
  </header>`, styles: ['/* angular:styles/component:scss;f400b8e30006c5b15d4407f873ddbf35afbd2d76e4ad0f0fa0059ddf158bf1d1;D:/www/BrapciAngular2/src/app/chat/components/chat-header/chat-header.component.ts */\n.chat-header {\n  min-height: 4.5rem;\n  padding: 0.7rem 1.25rem;\n  border-bottom: 1px solid var(--theme-line);\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  gap: 1rem;\n  background: var(--theme-card-bg);\n}\n.title-row {\n  display: flex;\n  align-items: center;\n  gap: 0.65rem;\n  min-width: 0;\n}\n.title-block {\n  min-width: 0;\n}\n.title-block span {\n  font-size: 0.72rem;\n  color: var(--theme-hint);\n}\nh1 {\n  font: 600 1.05rem/1.25 "Raleway", sans-serif;\n  margin: 0;\n  color: var(--theme-ink);\n  white-space: nowrap;\n  overflow: hidden;\n  text-overflow: ellipsis;\n}\n.icon-btn {\n  border: 0;\n  background: transparent;\n  color: var(--theme-ink);\n  font-size: 1.35rem;\n}\n.menu-btn {\n  display: none;\n}\n@media (max-width: 850px) {\n  .menu-btn {\n    display: inline-flex;\n  }\n  .chat-header {\n    padding: 0.65rem;\n  }\n  .title-block {\n    max-width: 42vw;\n  }\n}\n/*# sourceMappingURL=chat-header.component.css.map */\n'] }]
...
(() => {
  ...
  </div>`, styles: ["/* angular:styles/component:scss;7d235d9801e35aec47e1968fd9f4661e66ded47a95a5edd4f91f6c96a1d31d9d;D:/www/BrapciAngular2/src/app/chat/components/chat-input/chat-input.component.ts */\n.composer-shell {\n  padding: 0.85rem clamp(0.75rem, 3vw, 2rem) 1rem;\n  background: var(--theme-card-bg);\n  border-top: 1px solid var(--theme-line);\n}\n.composer {\n  max-width: 52rem;\n  margin: auto;\n  display: flex;\n  align-items: flex-end;\n  gap: 0.5rem;\n  border: 1px solid var(--theme-line);\n  border-radius: 1rem;\n  padding: 0.55rem;\n  background: var(--theme-bg);\n  box-shadow: 0 5px 20px rgba(0, 0, 0, 0.05);\n}\ntextarea {\n  flex: 1;\n  border: 0;\n  outline: 0;\n  background: transparent;\n  color: var(--theme-ink);\n  resize: none;\n  min-height: 2.25rem;\n  max-height: 11rem;\n  padding: 0.45rem;\n  font: inherit;\n}\n.send {\n  flex: 0 0 auto;\n  border: 0;\n  border-radius: 0.7rem;\n  width: 2.35rem;\n  height: 2.35rem;\n  background: #483d8b;\n  color: #fff;\n}\n.send:disabled {\n  opacity: 0.4;\n}\n.stop {\n  background: #9d3340;\n}\nsmall {\n  display: block;\n  text-align: center;\n  color: var(--theme-hint);\n  font-size: 0.68rem;\n  margin-top: 0.35rem;\n}\n/*# sourceMappingURL=chat-input.component.css.map */\n"] }]
...
(() => {
  ...
  </article>`, styles: ["/* angular:styles/component:scss;1271b3fe78c32fb3e8858d1065f80cbd7dee5410abb9297e1047167236294343;D:/www/BrapciAngular2/src/app/chat/components/chat-message/chat-message.component.ts */\n.message {\n  display: grid;\n  grid-template-columns: 2rem minmax(0, 1fr);\n  gap: 0.75rem;\n  padding: 1rem clamp(0.85rem, 3vw, 1.5rem);\n  max-width: 56rem;\n  margin: auto;\n}\n.message.user {\n  background: color-mix(in srgb, var(--theme-sand) 45%, transparent);\n  border-radius: 1rem;\n}\n.avatar {\n  display: grid;\n  place-items: center;\n  width: 2rem;\n  height: 2rem;\n  border-radius: 0.6rem;\n  background: #483d8b;\n  color: #fff;\n}\n.user .avatar {\n  background: #50725b;\n}\n.content {\n  min-width: 0;\n  position: relative;\n}\n.meta {\n  display: flex;\n  align-items: center;\n  gap: 0.5rem;\n  font-size: 0.75rem;\n  margin-bottom: 0.35rem;\n}\n.meta span {\n  color: var(--theme-hint);\n  font-size: 0.68rem;\n}\n.body {\n  line-height: 1.65;\n  color: var(--theme-ink);\n}\np {\n  white-space: pre-wrap;\n  margin: 0 0 0.65rem;\n}\nh3 {\n  font-size: 1.08rem;\n  margin: 1rem 0 0.45rem;\n}\nblockquote {\n  border-left: 3px solid #776db5;\n  padding-left: 0.8rem;\n  color: var(--theme-hint);\n}\n.code {\n  border-radius: 0.65rem;\n  overflow: hidden;\n  background: #171821;\n  color: #edf0f7;\n  margin: 0.65rem 0;\n}\n.code > div {\n  display: flex;\n  justify-content: space-between;\n  padding: 0.4rem 0.7rem;\n  background: #252735;\n  font-size: 0.7rem;\n}\n.code button {\n  border: 0;\n  background: transparent;\n  color: #d9dce7;\n}\n.code pre {\n  margin: 0;\n  padding: 0.8rem;\n  overflow: auto;\n  font-size: 0.82rem;\n}\n.copy-answer {\n  position: absolute;\n  right: 0;\n  top: 0;\n  border: 0;\n  background: transparent;\n  color: var(--theme-hint);\n  opacity: 0;\n}\n.message:hover .copy-answer,\n.copy-answer:focus-visible {\n  opacity: 1;\n}\n.cursor {\n  display: inline-block;\n  width: 0.45rem;\n  height: 1.05rem;\n  background: #6f63aa;\n  animation: blink 1s infinite;\n  vertical-align: text-bottom;\n}\n@keyframes blink {\n  50% {\n    opacity: 0.2;\n  }\n}\n/*# sourceMappingURL=chat-message.component.css.map */\n"] }]
...
(() => {
  ...
  </section></div>}`, styles: ["/* angular:styles/component:scss;a7696fa33df469665faa33608f745a27d46c3cb92cfb134a50794ec6023da2ce;D:/www/BrapciAngular2/src/app/chat/components/diagnostics-panel/diagnostics-panel.component.ts */\n.shade {\n  position: fixed;\n  inset: 0;\n  background: rgba(0, 0, 0, 0.55);\n  z-index: 60;\n  display: flex;\n  justify-content: flex-end;\n}\n.panel {\n  width: min(48rem, 100%);\n  height: 100%;\n  background: var(--theme-card-bg);\n  color: var(--theme-ink);\n  box-shadow: -1rem 0 3rem rgba(0, 0, 0, 0.2);\n  display: flex;\n  flex-direction: column;\n}\nheader {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  padding: 1rem 1.2rem;\n  border-bottom: 1px solid var(--theme-line);\n}\nheader span {\n  color: var(--theme-hint);\n  font-size: 0.7rem;\n  text-transform: uppercase;\n  letter-spacing: 0.08em;\n}\nh2 {\n  font-size: 1.25rem;\n  margin: 0.1rem 0 0;\n}\nheader button,\n.toolbar button {\n  border: 0;\n  background: transparent;\n  color: inherit;\n}\n.toolbar {\n  display: flex;\n  justify-content: space-between;\n  gap: 1rem;\n  padding: 0.65rem 1.2rem;\n  border-bottom: 1px solid var(--theme-line);\n  color: var(--theme-hint);\n}\n.entries {\n  padding: 1rem;\n  overflow: auto;\n  display: grid;\n  align-content: start;\n  gap: 0.65rem;\n}\n.entries article {\n  border: 1px solid var(--theme-line);\n  border-left: 4px solid #777;\n  border-radius: 0.55rem;\n  padding: 0.7rem;\n  background: var(--theme-bg);\n}\n.entries article.success {\n  border-left-color: #43845d;\n}\n.entries article.error {\n  border-left-color: #b13a48;\n}\n.entries article.pending {\n  border-left-color: #c39036;\n}\n.entries article.cancelled {\n  border-left-color: #777;\n}\n.entry-head {\n  display: grid;\n  grid-template-columns: auto minmax(0, 1fr) auto;\n  gap: 0.6rem;\n  align-items: center;\n}\n.entry-head strong {\n  font-size: 0.72rem;\n  color: #6b5fb1;\n}\n.entry-head code {\n  white-space: nowrap;\n  overflow: hidden;\n  text-overflow: ellipsis;\n  color: var(--theme-ink);\n}\n.entry-head > span,\n.entry-meta {\n  color: var(--theme-hint);\n  font-size: 0.7rem;\n}\n.entry-meta {\n  display: flex;\n  gap: 1rem;\n  margin-top: 0.45rem;\n}\n.entries pre {\n  white-space: pre-wrap;\n  margin: 0.6rem 0 0;\n  padding: 0.55rem;\n  border-radius: 0.35rem;\n  background: #351e24;\n  color: #ffdce2;\n  font-size: 0.75rem;\n}\n.empty {\n  text-align: center;\n  padding: 4rem 1rem;\n  color: var(--theme-hint);\n}\n.empty i {\n  font-size: 2rem;\n}\n@media (max-width: 600px) {\n  .entry-head {\n    grid-template-columns: auto 1fr;\n  }\n  .entry-head > span {\n    grid-column: 2;\n  }\n  .entry-meta {\n    flex-wrap: wrap;\n  }\n}\n/*# sourceMappingURL=diagnostics-panel.component.css.map */\n"] }]
...
//# sourceMappingURL=chunk-LLCYRARC.js.map
