...
.normalize-wrap[_ngcontent-ng-c3474926558] {
  color: var(--theme-ink);
}
.normalize-card[_ngcontent-ng-c3474926558] {
  background: var(--theme-card-bg);
  border: 1px solid var(--theme-line);
  border-radius: 0.9rem;
}
.normalize-eyebrow[_ngcontent-ng-c3474926558] {
  font-size: 0.78rem;
  letter-spacing: 0.16rem;
  text-transform: uppercase;
}
.normalize-subtitle[_ngcontent-ng-c3474926558] {
  color: var(--theme-hint);
}
.standard-options[_ngcontent-ng-c3474926558] {
  display: flex;
  flex-wrap: wrap;
  gap: 0.65rem;
}
.standard-option[_ngcontent-ng-c3474926558] {
  align-items: center;
  background: var(--theme-sand);
  border: 1px solid var(--theme-line);
...
.standard-option.selected[_ngcontent-ng-c3474926558] {
  border-color: var(--theme-link);
  box-shadow: 0 0 0 1px var(--theme-link);
}
.editor-shell[_ngcontent-ng-c3474926558] {
  border: 1px solid var(--theme-line);
  border-radius: 0.65rem;
  overflow: hidden;
}
.editor-shell[_ngcontent-ng-c3474926558]:focus-within {
  border-color: var(--theme-link);
  box-shadow: 0 0 0 0.2rem rgba(13, 110, 253, 0.2);
}
.editor-toolbar[_ngcontent-ng-c3474926558] {
  align-items: center;
  background: var(--theme-sand);
  border-bottom: 1px solid var(--theme-line);
  display: flex;
...
.format-button[_ngcontent-ng-c3474926558] {
  background: var(--theme-card-bg);
  border: 1px solid var(--theme-line);
...
.format-button[_ngcontent-ng-c3474926558]:hover:not(:disabled), 
.format-button[_ngcontent-ng-c3474926558]:focus-visible {
  border-color: var(--theme-link);
}
.rich-editor[_ngcontent-ng-c3474926558] {
  background: var(--theme-card-bg);
  color: var(--theme-ink);
  min-height: 16rem;
  outline: 0;
...
.rich-editor[_ngcontent-ng-c3474926558]:empty::before {
  color: var(--theme-hint);
  content: attr(data-placeholder);
  pointer-events: none;
}
.result[_ngcontent-ng-c3474926558] {
  border-top: 1px solid var(--theme-line);
  padding-top: 1.5rem;
}
.result-content[_ngcontent-ng-c3474926558] {
  background: var(--theme-sand);
  border: 1px solid var(--theme-line);
  border-radius: 0.65rem;
  overflow-x: auto;
...
.result-tabs[_ngcontent-ng-c3474926558] {
  border-bottom: 1px solid var(--theme-line);
  display: flex;
  gap: 0.25rem;
  margin-bottom: 1rem;
}
.result-tab[_ngcontent-ng-c3474926558] {
  background: transparent;
  border: 0;
...
.result-tab[_ngcontent-ng-c3474926558]:hover, 
.result-tab[_ngcontent-ng-c3474926558]:focus-visible {
  color: var(--theme-link);
}
.result-tab.active[_ngcontent-ng-c3474926558] {
  border-bottom-color: var(--theme-link);
  color: var(--theme-link);
}
.result-json[_ngcontent-ng-c3474926558] {
  font-family: var(--bs-font-monospace);
  font-size: 0.875rem;
  white-space: pre;
}
/*# sourceMappingURL=/tools-normalize-cites.page.css.map */</style><style ng-app-id="ng">
