...
.halflive-wrap[_ngcontent-ng-c772007377] {
  color: var(--theme-ink);
}
.halflive-card[_ngcontent-ng-c772007377] {
  background: var(--theme-card-bg);
  border: 1px solid var(--theme-line);
  border-radius: 0.9rem;
}
.halflive-eyebrow[_ngcontent-ng-c772007377] {
  font-size: 0.78rem;
  letter-spacing: 0.16rem;
  text-transform: uppercase;
}
.halflive-subtitle[_ngcontent-ng-c772007377] {
  color: var(--theme-hint);
}
.analysis-result[_ngcontent-ng-c772007377] {
  border-top: 1px solid var(--theme-line);
  padding-top: 1.5rem;
}
.result-tabs[_ngcontent-ng-c772007377] {
  border-bottom: 1px solid var(--theme-line);
  display: flex;
  gap: 0.25rem;
  margin-bottom: 1rem;
}
.result-tab[_ngcontent-ng-c772007377] {
  background: transparent;
  border: 0;
...
.result-tab[_ngcontent-ng-c772007377]:hover, 
.result-tab[_ngcontent-ng-c772007377]:focus-visible, 
.result-tab.active[_ngcontent-ng-c772007377] {
  color: var(--theme-link);
}
.result-tab.active[_ngcontent-ng-c772007377] {
  border-bottom-color: var(--theme-link);
}
.result-content[_ngcontent-ng-c772007377] {
  background: var(--theme-sand);
  border: 1px solid var(--theme-line);
...
.result-json[_ngcontent-ng-c772007377] {
  font-family: var(--bs-font-monospace);
  font-size: 0.875rem;
  white-space: pre;
}
.analysis-dashboard[_ngcontent-ng-c772007377] {
  display: grid;
  gap: 1.25rem;
}
.machine-disclaimer[_ngcontent-ng-c772007377] {
...
.machine-disclaimer[_ngcontent-ng-c772007377]   i[_ngcontent-ng-c772007377] {
  color: #b26a00;
  flex: 0 0 auto;
  font-size: 1.35rem;
  line-height: 1.2;
}
.machine-disclaimer[_ngcontent-ng-c772007377]   strong[_ngcontent-ng-c772007377] {
  display: block;
  margin-bottom: 0.2rem;
}
.machine-disclaimer[_ngcontent-ng-c772007377]   p[_ngcontent-ng-c772007377] {
  color: var(--theme-hint);
  font-size: 0.9rem;
}
.summary-grid[_ngcontent-ng-c772007377] {
  display: grid;
  gap: 1rem;
  grid-template-columns: minmax(15rem, 0.8fr) minmax(0, 1.7fr);
}
.half-life-card[_ngcontent-ng-c772007377] {
  align-items: center;
  background:
    linear-gradient(
      135deg,
...
.summary-label[_ngcontent-ng-c772007377] {
  font-size: 0.82rem;
  font-weight: 700;
  text-transform: uppercase;
}
.half-life-value[_ngcontent-ng-c772007377] {
  font-size: clamp(3.5rem, 8vw, 5.5rem);
  line-height: 1;
  margin-top: 0.55rem;
}
.half-life-unit[_ngcontent-ng-c772007377] {
  font-size: 1.05rem;
  font-weight: 600;
}
.half-life-card[_ngcontent-ng-c772007377]   small[_ngcontent-ng-c772007377] {
  color: rgba(255, 255, 255, 0.78);
}
.metric-grid[_ngcontent-ng-c772007377] {
  display: grid;
  gap: 1rem;
  grid-template-columns: repeat(2, minmax(0, 1fr));
}
.metric-card[_ngcontent-ng-c772007377], 
.dashboard-section[_ngcontent-ng-c772007377] {
  background: var(--theme-sand);
  border: 1px solid var(--theme-line);
  border-radius: 0.8rem;
}
...
.metric-card-success[_ngcontent-ng-c772007377] {
  border-left-color: #198754;
}
.metric-card-warning[_ngcontent-ng-c772007377] {
  border-left-color: #d98b00;
}
.metric-card[_ngcontent-ng-c772007377]   span[_ngcontent-ng-c772007377] {
  color: var(--theme-hint);
  font-size: 0.85rem;
}
.metric-card[_ngcontent-ng-c772007377]   strong[_ngcontent-ng-c772007377] {
  font-size: 2rem;
  line-height: 1.15;
  margin-top: 0.35rem;
}
.metric-card[_ngcontent-ng-c772007377]   .period-value[_ngcontent-ng-c772007377] {
  font-size: 1.5rem;
}
.dashboard-section[_ngcontent-ng-c772007377] {
  padding: 1.25rem;
}
.section-heading[_ngcontent-ng-c772007377] {
  align-items: end;
  display: flex;
  justify-content: space-between;
  margin-bottom: 1rem;
}
.section-kicker[_ngcontent-ng-c772007377] {
  color: var(--theme-hint);
  font-size: 0.72rem;
  font-weight: 700;
...
.typology-grid[_ngcontent-ng-c772007377] {
  display: grid;
  gap: 0.75rem;
  grid-template-columns: repeat(4, minmax(0, 1fr));
}
.language-grid[_ngcontent-ng-c772007377] {
  display: grid;
  gap: 0.75rem;
  grid-template-columns: repeat(5, minmax(0, 1fr));
}
.language-card[_ngcontent-ng-c772007377] {
  align-items: center;
  background: var(--theme-card-bg);
  border: 1px solid var(--theme-line);
  border-radius: 0.65rem;
...
.language-flag[_ngcontent-ng-c772007377], 
.unknown-language[_ngcontent-ng-c772007377] {
  border: 1px solid var(--theme-line);
...
.language-info[_ngcontent-ng-c772007377] {
  display: flex;
  flex: 1;
  flex-direction: column;
  min-width: 0;
}
.language-info[_ngcontent-ng-c772007377]   strong[_ngcontent-ng-c772007377] {
  font-size: 0.88rem;
}
.language-info[_ngcontent-ng-c772007377]   span[_ngcontent-ng-c772007377] {
  color: var(--theme-hint);
  font-size: 0.7rem;
}
.language-count[_ngcontent-ng-c772007377] {
  color: var(--theme-link);
  font-size: 1.35rem;
}
.typology-card[_ngcontent-ng-c772007377] {
  background: var(--theme-card-bg);
  border: 1px solid var(--theme-line);
  border-radius: 0.65rem;
  padding: 0.85rem;
}
.typology-heading[_ngcontent-ng-c772007377] {
  align-items: start;
  display: flex;
  gap: 0.5rem;
  justify-content: space-between;
}
.typology-heading[_ngcontent-ng-c772007377]   span[_ngcontent-ng-c772007377] {
  font-size: 0.86rem;
  font-weight: 600;
}
.typology-heading[_ngcontent-ng-c772007377]   strong[_ngcontent-ng-c772007377] {
  color: var(--theme-link);
  font-size: 1.3rem;
}
.typology-progress[_ngcontent-ng-c772007377] {
  height: 0.35rem;
  margin-top: 0.55rem;
}
.typology-progress[_ngcontent-ng-c772007377]   .progress-bar[_ngcontent-ng-c772007377], 
.year-track[_ngcontent-ng-c772007377]   span[_ngcontent-ng-c772007377] {
  background: var(--theme-link);
}
.typology-card[_ngcontent-ng-c772007377]   small[_ngcontent-ng-c772007377], 
.current-year[_ngcontent-ng-c772007377] {
  color: var(--theme-hint);
}
.current-year[_ngcontent-ng-c772007377] {
  font-size: 0.82rem;
}
.year-list[_ngcontent-ng-c772007377] {
  display: grid;
  gap: 0.65rem;
}
.year-item[_ngcontent-ng-c772007377] {
  align-items: center;
  display: grid;
  gap: 0.75rem;
  grid-template-columns: 3.5rem minmax(4rem, 1fr) 2rem;
}
.year-track[_ngcontent-ng-c772007377] {
...
.references-table[_ngcontent-ng-c772007377] {
  --bs-table-bg: transparent;
  color: var(--theme-ink);
}
.references-table[_ngcontent-ng-c772007377]   th[_ngcontent-ng-c772007377] {
  color: var(--theme-hint);
  font-size: 0.72rem;
  text-transform: uppercase;
}
.type-badge[_ngcontent-ng-c772007377] {
...
/*# sourceMappingURL=/tools-halflive.page.css.map */</style><style ng-app-id="ng">
