...
.signin-page[_ngcontent-ng-c3904026928] {
  background: var(--theme-bg);
  min-height: calc(100dvh - 180px);
}
.signin-layout[_ngcontent-ng-c3904026928] {
  align-content: center;
  min-height: 70vh;
  row-gap: 1.4rem;
}
.signin-intro[_ngcontent-ng-c3904026928] {
  color: var(--theme-ink);
}
.signin-kicker[_ngcontent-ng-c3904026928] {
...
.signin-title[_ngcontent-ng-c3904026928] {
  font-family:
    "Raleway",
    "Trebuchet MS",
    sans-serif;
...
.signin-subtitle[_ngcontent-ng-c3904026928] {
  color: var(--theme-hint);
  font-size: 0.98rem;
}
@media (max-width: 991.98px) {
...
/*# sourceMappingURL=/signin.page.css.map */</style><style ng-app-id="ng">

.signin-card[_ngcontent-ng-c2939160160] {
  background: var(--theme-card-bg);
  border: 1px solid var(--theme-line);
  border-radius: 0.8rem;
  box-shadow: 0 8px 20px rgba(0, 0, 0, 0.08);
}
.signin-card-subtitle[_ngcontent-ng-c2939160160] {
  color: var(--theme-hint);
  font-size: 0.94rem;
}
[_nghost-ng-c2939160160]     .auth-form .btn.btn-primary {
  border-radius: 0.75rem;
  font-weight: 600;
  min-height: 2.65rem;
}
[_nghost-ng-c2939160160]     .auth-form .form-control {
  border-radius: 0.7rem;
  min-height: 2.7rem;
}
/*# sourceMappingURL=/auth-signin.component.css.map */</style><style ng-app-id="ng">

.auth-form[_ngcontent-ng-c622619979] {
  display: grid;
  gap: 0.6rem;
}
.auth-form[_ngcontent-ng-c622619979]   .form-label[_ngcontent-ng-c622619979] {
  color: var(--theme-ink);
}
.auth-links[_ngcontent-ng-c622619979] {
  align-items: center;
  display: flex;
  gap: 1rem;
...
.auth-links--single[_ngcontent-ng-c622619979] {
  justify-content: flex-start;
}
.auth-links[_ngcontent-ng-c622619979]   .btn-link[_ngcontent-ng-c622619979] {
  color: var(--theme-hint);
  text-decoration: none;
}
.auth-links[_ngcontent-ng-c622619979]   .btn-link[_ngcontent-ng-c622619979]:hover, 
.auth-links[_ngcontent-ng-c622619979]   .btn-link[_ngcontent-ng-c622619979]:focus-visible {
  color: var(--theme-ink);
  text-decoration: underline;
}
.error[_ngcontent-ng-c622619979] {
  color: var(--theme-error);
}
.success[_ngcontent-ng-c622619979] {
  color: var(--theme-success);
}
/*# sourceMappingURL=/auth-panel.component.css.map */</style></head>
