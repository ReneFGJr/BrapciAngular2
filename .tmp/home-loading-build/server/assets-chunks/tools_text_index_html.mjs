...
.tools-wrap[_ngcontent-ng-c3028637921] {
  color: var(--theme-ink);
}
.tools-card[_ngcontent-ng-c3028637921] {
  background: var(--theme-card-bg);
  border: 1px solid var(--theme-line);
  border-radius: 0.9rem;
}
.tools-eyebrow[_ngcontent-ng-c3028637921] {
  font-size: 0.78rem;
  letter-spacing: 0.16rem;
  margin: 0;
  text-transform: uppercase;
}
.tools-subtitle[_ngcontent-ng-c3028637921] {
  color: var(--theme-hint);
}
.tool-item[_ngcontent-ng-c3028637921] {
  background: var(--theme-sand);
  border: 1px solid var(--theme-line);
  border-radius: 0.65rem;
}
.tool-item[_ngcontent-ng-c3028637921]   p[_ngcontent-ng-c3028637921] {
  color: var(--theme-hint);
}
/*# sourceMappingURL=/tools-text.page.css.map */</style><style ng-app-id="ng">
