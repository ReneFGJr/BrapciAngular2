...
.txt4net-wrap[_ngcontent-ng-c1877192182] {
  color: var(--theme-ink);
}
.txt4net-card[_ngcontent-ng-c1877192182] {
  background: var(--theme-card-bg);
  border: 1px solid var(--theme-line);
  border-radius: 0.9rem;
}
.txt4net-subtitle[_ngcontent-ng-c1877192182] {
  color: var(--theme-hint);
}
textarea[_ngcontent-ng-c1877192182] {
  resize: vertical;
}
.video-frame[_ngcontent-ng-c1877192182] {
  background: #000;
  border-radius: 0.65rem;
  overflow: hidden;
}
/*# sourceMappingURL=/tools-txt4net.page.css.map */</style><style ng-app-id="ng">
