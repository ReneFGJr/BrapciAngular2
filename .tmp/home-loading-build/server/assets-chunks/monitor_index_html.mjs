...
[_nghost-ng-c2565554109] {
  display: block;
}
.monitor-page[_ngcontent-ng-c2565554109] {
  min-height: 70vh;
  color: var(--theme-ink);
}
.monitor-hero[_ngcontent-ng-c2565554109] {
  padding: 2.5rem 0 2rem;
  border-bottom: 1px solid var(--theme-line);
  background: color-mix(in srgb, var(--theme-card-bg) 84%, transparent);
}
.monitor-back[_ngcontent-ng-c2565554109] {
  display: inline-flex;
...
.monitor-heading[_ngcontent-ng-c2565554109] {
  display: flex;
  align-items: flex-end;
  justify-content: space-between;
  gap: 1.5rem;
}
.monitor-kicker[_ngcontent-ng-c2565554109], 
.section-kicker[_ngcontent-ng-c2565554109] {
  margin: 0 0 0.3rem;
...
h1[_ngcontent-ng-c2565554109] {
  margin: 0;
  font-family: "Bitter", serif;
  font-size: clamp(2rem, 5vw, 3rem);
}
.monitor-description[_ngcontent-ng-c2565554109] {
  margin: 0.5rem 0 0;
  color: var(--theme-muted);
}
.refresh-button[_ngcontent-ng-c2565554109] {
  display: inline-flex;
...
.refresh-button[_ngcontent-ng-c2565554109]:disabled {
  opacity: 0.6;
}
.spinning[_ngcontent-ng-c2565554109] {
  animation: _ngcontent-ng-c2565554109_spin 0.8s linear infinite;
}
@keyframes _ngcontent-ng-c2565554109_spin {
  to {
    transform: rotate(360deg);
  }
}
.monitor-content[_ngcontent-ng-c2565554109] {
  padding-top: 2rem;
  padding-bottom: 3rem;
}
.loading-heading[_ngcontent-ng-c2565554109] {
  display: flex;
  margin-bottom: 1rem;
  align-items: flex-end;
  justify-content: space-between;
...
.loading-heading[_ngcontent-ng-c2565554109]   h2[_ngcontent-ng-c2565554109] {
  margin: 0;
  font-size: 1.35rem;
}
.loading-indicator[_ngcontent-ng-c2565554109] {
  display: inline-flex;
  align-items: center;
  gap: 0.4rem;
  color: var(--theme-muted);
...
.monitor-summary[_ngcontent-ng-c2565554109] {
  display: grid;
  margin-bottom: 2.25rem;
  gap: 1rem;
  grid-template-columns: repeat(3, 1fr);
}
.summary-card[_ngcontent-ng-c2565554109] {
  display: flex;
...
.summary-card[_ngcontent-ng-c2565554109]   span[_ngcontent-ng-c2565554109] {
  display: flex;
  align-items: center;
  gap: 0.45rem;
  color: var(--theme-muted);
...
.summary-card[_ngcontent-ng-c2565554109]   strong[_ngcontent-ng-c2565554109] {
  font-size: 1.65rem;
}
.summary-card--online[_ngcontent-ng-c2565554109] {
...
.summary-card--offline[_ngcontent-ng-c2565554109] {
...
.summary-card--online[_ngcontent-ng-c2565554109]   i[_ngcontent-ng-c2565554109] {
  color: var(--theme-success);
}
.summary-card--offline[_ngcontent-ng-c2565554109]   i[_ngcontent-ng-c2565554109] {
  color: var(--theme-error);
}
.section-heading[_ngcontent-ng-c2565554109] {
  display: flex;
  margin-bottom: 1rem;
  align-items: flex-end;
  justify-content: space-between;
...
.section-heading[_ngcontent-ng-c2565554109]   h2[_ngcontent-ng-c2565554109] {
  margin: 0;
  font-size: 1.35rem;
}
.section-heading[_ngcontent-ng-c2565554109]   small[_ngcontent-ng-c2565554109] {
  color: var(--theme-muted);
}
.computer-grid[_ngcontent-ng-c2565554109] {
  display: grid;
  gap: 0.85rem;
  grid-template-columns: repeat(auto-fit, minmax(260px, 1fr));
}
.computer-card[_ngcontent-ng-c2565554109] {
  display: grid;
  padding: 1rem;
  align-items: center;
...
.computer-card--online[_ngcontent-ng-c2565554109] {
  border-left: 4px solid var(--theme-success);
  background: color-mix(in srgb, var(--theme-success) 15%, var(--theme-card-bg));
}
.computer-card--offline[_ngcontent-ng-c2565554109] {
  border-color: color-mix(in srgb, var(--theme-error) 42%, var(--theme-line));
  border-left: 4px solid var(--theme-error);
  background: color-mix(in srgb, var(--theme-error) 15%, var(--theme-card-bg));
}
.computer-card--loading[_ngcontent-ng-c2565554109] {
  min-height: 5rem;
  overflow: hidden;
}
.skeleton[_ngcontent-ng-c2565554109] {
  display: block;
  position: relative;
  overflow: hidden;
...
.skeleton[_ngcontent-ng-c2565554109]::after, 
.skeleton-lines[_ngcontent-ng-c2565554109]   i[_ngcontent-ng-c2565554109]::after {
  content: "";
  position: absolute;
  inset: 0;
  ...
  background:
    linear-gradient(
      ...
      transparent);
  animation: _ngcontent-ng-c2565554109_shimmer 1.25s infinite;
}
.skeleton-icon[_ngcontent-ng-c2565554109] {
  width: 2.7rem;
  height: 2.7rem;
}
.skeleton-lines[_ngcontent-ng-c2565554109] {
  display: grid;
  gap: 0.55rem;
}
.skeleton-lines[_ngcontent-ng-c2565554109]   i[_ngcontent-ng-c2565554109] {
  display: block;
  position: relative;
  overflow: hidden;
  width: 65%;
...
.skeleton-lines[_ngcontent-ng-c2565554109]   i[_ngcontent-ng-c2565554109]:first-child {
  width: 85%;
  height: 0.85rem;
}
.skeleton-badge[_ngcontent-ng-c2565554109] {
  width: 3.8rem;
  height: 1.35rem;
  border-radius: 999px;
}
@keyframes _ngcontent-ng-c2565554109_shimmer {
  100% {
    transform: translateX(100%);
  }
}
.computer-icon[_ngcontent-ng-c2565554109] {
  display: grid;
  position: relative;
  width: 2.7rem;
  height: 2.7rem;
...
.status-dot[_ngcontent-ng-c2565554109] {
  position: absolute;
  right: -0.1rem;
  bottom: -0.1rem;
  width: 0.7rem;
...
.computer-card[_ngcontent-ng-c2565554109]   h3[_ngcontent-ng-c2565554109] {
  margin: 0;
  font-size: 1rem;
}
.computer-card[_ngcontent-ng-c2565554109]   p[_ngcontent-ng-c2565554109] {
  margin: 0.2rem 0 0;
  color: var(--theme-muted);
  font-family: monospace;
  font-size: 0.78rem;
}
.status-badge[_ngcontent-ng-c2565554109] {
...
.computer-card--offline[_ngcontent-ng-c2565554109]   .status-badge[_ngcontent-ng-c2565554109] {
  color: var(--theme-error);
  background: color-mix(in srgb, var(--theme-error) 12%, transparent);
}
.offline-section[_ngcontent-ng-c2565554109] {
  margin-top: 2rem;
  padding-top: 1rem;
  border-top: 1px solid var(--theme-line);
}
.offline-section[_ngcontent-ng-c2565554109]   summary[_ngcontent-ng-c2565554109] {
  color: var(--theme-muted);
  cursor: pointer;
  font-weight: 600;
}
.offline-section[_ngcontent-ng-c2565554109]   summary[_ngcontent-ng-c2565554109]   span[_ngcontent-ng-c2565554109] {
  margin-left: 0.35rem;
...
.monitor-state[_ngcontent-ng-c2565554109], 
.empty-online[_ngcontent-ng-c2565554109] {
  display: grid;
  min-height: 16rem;
  place-items: center;
...
.monitor-state--error[_ngcontent-ng-c2565554109]   i[_ngcontent-ng-c2565554109], 
.empty-online[_ngcontent-ng-c2565554109]   i[_ngcontent-ng-c2565554109] {
  color: var(--theme-error);
  font-size: 2rem;
}
...
/*# sourceMappingURL=/monitor.page.css.map */</style></head>
