...
function PerfilPage_Conditional_9_Conditional_0_Conditional_15_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 13);
    \u0275\u0275listener("click", function PerfilPage_Conditional_9_Conditional_0_Conditional_15_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r3);
...
function PerfilPage_Conditional_9_Conditional_0_Conditional_16_Conditional_38_Template(rf, ctx) {
  if (rf & 1) {
...
function PerfilPage_Conditional_9_Conditional_0_Conditional_16_Conditional_39_Template(rf, ctx) {
  if (rf & 1) {
...
function PerfilPage_Conditional_9_Conditional_0_Conditional_16_Conditional_45_Conditional_30_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275text(0);
    \u0275\u0275pipe(1, "date");
  }
...
function PerfilPage_Conditional_9_Conditional_0_Conditional_16_Conditional_45_Conditional_31_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275text(0, " - ");
  }
}
function PerfilPage_Conditional_9_Conditional_0_Conditional_16_Conditional_45_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "dl", 19)(1, "div", 20)(2, "dt");
    \u0275\u0275text(3);
    \u0275\u0275pipe(4, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "dd");
    ...
    \u0275\u0275text(12);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(13, "div", 20)(14, "dt");
    \u0275\u0275text(15);
    \u0275\u0275pipe(16, "translate");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(18);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(19, "div", 20)(20, "dt");
    \u0275\u0275text(21);
    \u0275\u0275pipe(22, "translate");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(24);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(25, "div", 20)(26, "dt");
    \u0275\u0275text(27);
    \u0275\u0275pipe(28, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(29, "dd");
    \u0275\u0275conditionalCreate(30, PerfilPage_Conditional_9_Conditional_0_Conditional_16_Conditional_45_Conditional_30_Template, 2, 4)(31, PerfilPage_Conditional_9_Conditional_0_Conditional_16_Conditional_45_Conditional_31_Template, 1, 0);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    let tmp_15_0;
...
function PerfilPage_Conditional_9_Conditional_0_Conditional_16_Conditional_46_Template(rf, ctx) {
  if (rf & 1) {
...
function PerfilPage_Conditional_9_Conditional_0_Conditional_16_Conditional_48_Template(rf, ctx) {
  if (rf & 1) {
...
function PerfilPage_Conditional_9_Conditional_0_Conditional_16_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "section", 18);
    \u0275\u0275pipe(1, "translate");
    \u0275\u0275elementStart(2, "dl", 19)(3, "div", 20)(4, "dt");
    \u0275\u0275text(5);
    \u0275\u0275pipe(6, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(7, "dd");
    ...
    \u0275\u0275text(14);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(15, "div", 20)(16, "dt");
    \u0275\u0275text(17);
    \u0275\u0275pipe(18, "translate");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(20);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(21, "div", 20)(22, "dt");
    \u0275\u0275text(23);
    \u0275\u0275pipe(24, "translate");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275listener("click", function PerfilPage_Conditional_9_Conditional_0_Conditional_16_Template_button_click_35_listener() {
      \u0275\u0275restoreView(_r4);
      const ctx_r1 = \u0275\u0275nextContext(3);
    ...
    \u0275\u0275pipe(37, "translate");
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(38, PerfilPage_Conditional_9_Conditional_0_Conditional_16_Conditional_38_Template, 3, 3, "p", 25)(39, PerfilPage_Conditional_9_Conditional_0_Conditional_16_Conditional_39_Template, 3, 3, "p", 26);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(40, "section", 18);
    \u0275\u0275pipe(41, "translate");
    \u0275\u0275elementStart(42, "h2", 21);
    \u0275\u0275text(43);
    \u0275\u0275pipe(44, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(45, PerfilPage_Conditional_9_Conditional_0_Conditional_16_Conditional_45_Template, 32, 20, "dl", 19)(46, PerfilPage_Conditional_9_Conditional_0_Conditional_16_Conditional_46_Template, 3, 3, "p", 27);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(47, "div", 28);
    \u0275\u0275conditionalCreate(48, PerfilPage_Conditional_9_Conditional_0_Conditional_16_Conditional_48_Template, 3, 4, "a", 29);
    \u0275\u0275elementStart(49, "button", 30);
    \u0275\u0275listener("click", function PerfilPage_Conditional_9_Conditional_0_Conditional_16_Template_button_click_49_listener() {
      \u0275\u0275restoreView(_r4);
      const ctx_r1 = \u0275\u0275nextContext(3);
...
function PerfilPage_Conditional_9_Conditional_0_Conditional_17_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "section", 16)(1, "div", 31)(2, "span", 32);
    \u0275\u0275element(3, "i", 33);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "div")(5, "h2", 34);
    \u0275\u0275text(6);
    \u0275\u0275pipe(7, "translate");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275pipe(10, "translate");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(11, "div", 35)(12, "a", 36);
    \u0275\u0275element(13, "i", 37);
...
function PerfilPage_Conditional_9_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(14, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(15, PerfilPage_Conditional_9_Conditional_0_Conditional_15_Template, 4, 6, "button", 15);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(16, PerfilPage_Conditional_9_Conditional_0_Conditional_16_Template, 52, 45)(17, PerfilPage_Conditional_9_Conditional_0_Conditional_17_Template, 32, 18, "section", 16);
  }
  if (rf & 2) {
    const user_r6 = ctx;
    const ctx_r1 = \u0275\u0275nextContext(2);
    ...
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(6, 10, "auth.welcome"));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(user_r6.name);
    \u0275\u0275advance();
    \u0275\u0275attribute("aria-label", \u0275\u0275pipeBind1(10, 12, "profile.tabsLabel"));
    \u0275\u0275advance(2);
    \u0275\u0275classProp("active", ctx_r1.activeTab() === "session");
    \u0275\u0275attribute("aria-selected", ctx_r1.activeTab() === "session");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(14, 14, "profile.sessionTab"), " ");
    \u0275\u0275advance(2);
    \u0275\u0275conditional(ctx_r1.isAdmin() ? 15 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r1.activeTab() === "session" ? 16 : ctx_r1.isAdmin() ? 17 : -1);
  }
}
function PerfilPage_Conditional_9_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275conditionalCreate(0, PerfilPage_Conditional_9_Conditional_0_Template, 18, 16);
  }
  if (rf & 2) {
    let tmp_1_0;
...
//# sourceMappingURL=chunk-ZBC7P2BJ.js.map
