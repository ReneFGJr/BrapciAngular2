...
\r
        @if (activeTab() === 'bolsistas') {\r
          <div class="section-heading"><div><span class="eyebrow">Rela\xE7\xE3o nominal</span><h2>Bolsistas e modalidades</h2></div><span class="result-count">{{ filteredScholars().length }} resultado(s)</span></div>\r
...
//# sourceMappingURL=chunk-LVDZZZAR.js.map
