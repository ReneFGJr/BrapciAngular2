...
var BrapciApiService = class _BrapciApiService {
  ...
  postForm(endpoint, body) {
    ...
    return this.http.post(url, form.toString(), {
      headers: { "Content-Type": "application/x-www-form-urlencoded" }
    });
  }
  search(query, filters, method = "v4") {
    ...
    return this.get(`brapci/search/${method}`, params);
  }
  citedSearch(term) {
...
//# sourceMappingURL=chunk-7RYT5TAS.js.map
