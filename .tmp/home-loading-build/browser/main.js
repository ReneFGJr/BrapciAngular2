...
var routes = [
  __spreadValues({
    ...
    loadComponent: () => import("./chunk-QRUMGJZS.js").then((m) => m.Error501Page)
  ...
  __spreadValues({
    path: "pq",
    loadComponent: () => import("./chunk-LVDZZZAR.js").then((m) => m.PqPage)
  ...
  __spreadValues({
    path: "",
    loadComponent: () => import("./chunk-LI7BFTYD.js").then((m) => m.HomePage)
