...
\r
      <div class="row g-3">\r
        <div class="col-12 col-md-6">\r
          <a class="tool-item tool-item-link d-block p-3 h-100" routerLink="/tools/normalize_cites">\r
        ...
        <div class="col-12 col-md-6">\r
          <a class="tool-item tool-item-link d-block p-3 h-100" routerLink="/tools/halflive">\r
            <h2 class="h5 mb-2">{{ 'tools.bibliographics.card3Title' | translate }}</h2>\r
            <p class="mb-0">{{ 'tools.bibliographics.card3Text' | translate }}</p>\r
          </a>\r
        </div>\r
      </div>\r
    </div>\r
...
//# sourceMappingURL=chunk-JS5VTDJ4.js.map
