import {
  BasketService
} from "./chunk-WDXZBJPK.js";
import {
  AuthService,
  SessionService
} from "./chunk-N6GNUZ62.js";
import {
  BrapciApiService
} from "./chunk-7RYT5TAS.js";
import {
  TranslateModule,
  TranslatePipe
...
} from "./chunk-L72NH7AV.js";
import "./chunk-CDWCYVW5.js";
import {
  CommonModule,
  NgComponentOutlet,
  NgForOf,
...
function AreaEventsComponent_p_5_Template(rf, ctx) {
  ...
  if (rf & 2) {
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(2, 1, "home.events.loading"));
  }
}
function AreaEventsComponent_p_6_Template(rf, ctx) {
  if (rf & 1) {
...
function AreaEventsComponent_ul_7_li_1_img_3_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "img", 17);
    \u0275\u0275pipe(1, "translate");
    \u0275\u0275listener("error", function AreaEventsComponent_ul_7_li_1_img_3_Template_img_error_0_listener() {
      \u0275\u0275restoreView(_r4);
  ...
  if (rf & 2) {
    const event_r3 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275property("src", event_r3.logo, \u0275\u0275sanitizeUrl)("alt", \u0275\u0275pipeBind2(1, 2, "home.events.logoAlt", \u0275\u0275pureFunction1(5, _c0, event_r3.title)));
  }
}
function AreaEventsComponent_ul_7_li_1_div_4_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(2, 1, "home.events.logoFallback"), " ");
  }
}
function AreaEventsComponent_ul_7_li_1_Template(rf, ctx) {
  if (rf & 1) {
    const _r2 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "li", 10);
    \u0275\u0275pipe(1, "translate");
    \u0275\u0275listener("click", function AreaEventsComponent_ul_7_li_1_Template_li_click_0_listener() {
      const event_r3 = \u0275\u0275restoreView(_r2).$implicit;
      const ctx_r0 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r0.goToEvent(event_r3));
    })("keydown.enter", function AreaEventsComponent_ul_7_li_1_Template_li_keydown_enter_0_listener() {
      const event_r3 = \u0275\u0275restoreView(_r2).$implicit;
      const ctx_r0 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r0.goToEvent(event_r3));
    })("keydown.space", function AreaEventsComponent_ul_7_li_1_Template_li_keydown_space_0_listener() {
      const event_r3 = \u0275\u0275restoreView(_r2).$implicit;
      const ctx_r0 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r0.goToEvent(event_r3));
    });
    \u0275\u0275elementStart(2, "div", 11);
    \u0275\u0275template(3, AreaEventsComponent_ul_7_li_1_img_3_Template, 2, 7, "img", 12)(4, AreaEventsComponent_ul_7_li_1_div_4_Template, 3, 3, "div", 13);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "h4", 14);
    \u0275\u0275text(6);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275listener("click", function AreaEventsComponent_ul_7_li_1_Template_a_click_10_listener($event) {
      \u0275\u0275restoreView(_r2);
  ...
  if (rf & 2) {
    ...
    \u0275\u0275attribute("aria-label", \u0275\u0275pipeBind2(1, 9, "home.events.openDetails", \u0275\u0275pureFunction1(16, _c0, event_r3.title)));
    \u0275\u0275advance(3);
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate3("", \u0275\u0275pipeBind1(9, 12, "home.events.date"), ": ", event_r3.date, " - ", event_r3.location);
    \u0275\u0275advance(2);
    \u0275\u0275property("href", event_r3.redirectUrl, \u0275\u0275sanitizeUrl);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(12, 14, "home.events.moreDetails"), " ");
  }
}
function AreaEventsComponent_ul_7_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "ul", 8);
    \u0275\u0275template(1, AreaEventsComponent_ul_7_li_1_Template, 13, 18, "li", 9);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
...
function AreaEventsComponent_p_8_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p", 6);
    \u0275\u0275text(1);
    \u0275\u0275pipe(2, "translate");
  ...
  if (rf & 2) {
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(2, 1, "home.events.empty"), " ");
  }
}
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(AreaEventsComponent, [{
    type: Component,
    args: [{ selector: "app-area-events", imports: [CommonModule, TranslateModule], template: `<section class="area-events" aria-labelledby="area-events-title">\r
  <header class="area-events-header">\r
    <h3 id="area-events-title" class="area-events-title">{{ 'home.events.title' | translate }}</h3>\r
  </header>\r
\r
  <p *ngIf="loading()" class="area-events-state">{{ 'home.events.loading' | translate }}</p>\r
  <p *ngIf="error()" class="area-events-state area-events-state-error">{{ error() | translate }}</p>\r
\r
  <ul *ngIf="!loading() && !error() && events().length" class="area-events-list">\r
    <li\r
      *ngFor="let event of events(); trackBy: trackByEventId"\r
      ...
      [attr.aria-label]="'home.events.openDetails' | translate: { title: event.title }"\r
    >\r
      <div class="area-events-logo-wrap">\r
        <img\r
          *ngIf="event.logo"\r
          ...
          [src]="event.logo"\r
          [alt]="'home.events.logoAlt' | translate: { title: event.title }"\r
          width="200"\r
          height="200"\r
          loading="lazy"\r
          decoding="async"\r
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AreaEventsComponent, { className: "AreaEventsComponent", filePath: "src/app/components/area-events/area-events.component.ts", lineNumber: 24 });
})();

// src/app/components/area-news/area-news.component.ts
function AreaNewsComponent_p_9_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(2, 1, "home.news.loading"));
  }
}
...
function AreaNewsComponent_div_11_article_1_li_6_ng_container_1_span_3_Template(rf, ctx) {
  if (rf & 1) {
...
function AreaNewsComponent_div_11_article_1_li_6_ng_container_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275elementStart(1, "strong", 22);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275template(3, AreaNewsComponent_div_11_article_1_li_6_ng_container_1_span_3_Template, 2, 1, "span", 23);
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(6, 4, "home.news.view"));
  }
}
function AreaNewsComponent_div_11_article_1_li_6_ng_template_2_ng_container_0_span_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span", 25);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function AreaNewsComponent_div_11_article_1_li_6_ng_template_2_ng_container_0_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275elementStart(1, "a", 26)(2, "strong", 22);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    \u0275\u0275template(4, AreaNewsComponent_div_11_article_1_li_6_ng_template_2_ng_container_0_span_4_Template, 2, 1, "span", 23);
    \u0275\u0275elementEnd();
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
...
function AreaNewsComponent_div_11_article_1_li_6_ng_template_2_ng_template_1_span_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span", 25);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function AreaNewsComponent_div_11_article_1_li_6_ng_template_2_ng_template_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "strong", 22);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
    \u0275\u0275template(2, AreaNewsComponent_div_11_article_1_li_6_ng_template_2_ng_template_1_span_2_Template, 2, 1, "span", 23);
  }
  if (rf & 2) {
    const item_r2 = \u0275\u0275nextContext(2).$implicit;
    \u0275\u0275advance();
...
function AreaNewsComponent_div_11_article_1_li_6_ng_template_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275template(0, AreaNewsComponent_div_11_article_1_li_6_ng_template_2_ng_container_0_Template, 5, 3, "ng-container", 21)(1, AreaNewsComponent_div_11_article_1_li_6_ng_template_2_ng_template_1_Template, 3, 2, "ng-template", null, 1, \u0275\u0275templateRefExtractor);
  }
  if (rf & 2) {
...
function AreaNewsComponent_div_11_article_1_li_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "li", 20);
    \u0275\u0275template(1, AreaNewsComponent_div_11_article_1_li_6_ng_container_1_Template, 7, 6, "ng-container", 21)(2, AreaNewsComponent_div_11_article_1_li_6_ng_template_2_Template, 3, 2, "ng-template", null, 0, \u0275\u0275templateRefExtractor);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function AreaNewsComponent_div_11_article_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "article", 14)(1, "header", 15)(2, "span", 16);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(4, "div", 17)(5, "ul", 18);
    \u0275\u0275template(6, AreaNewsComponent_div_11_article_1_li_6_Template, 4, 2, "li", 19);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
...
function AreaNewsComponent_div_11_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 12);
    \u0275\u0275template(1, AreaNewsComponent_div_11_article_1_Template, 7, 3, "article", 13);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
...
function AreaNewsComponent_p_12_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p", 10);
    \u0275\u0275text(1);
    \u0275\u0275pipe(2, "translate");
  ...
  if (rf & 2) {
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(2, 1, "home.news.empty"), " ");
  }
}
var AreaNewsComponent = class _AreaNewsComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AreaNewsComponent, selectors: [["app-area-news"]], decls: 13, vars: 10, consts: [["legacyLinkItem", ""], ["plainItem", ""], ["aria-labelledby", "area-news-title", 1, "area-news"], [1, "area-news-header"], [1, "area-news-header__text"], [1, "area-news-kicker"], ["id", "area-news-title", 1, "area-news-title"], ["class", "area-news-state", 4, "ngIf"], ["class", "area-news-state area-news-state-error", 4, "ngIf"], ["class", "area-news-list", 4, "ngIf"], [1, "area-news-state"], [1, "area-news-state", "area-news-state-error"], [1, "area-news-list"], ["class", "area-news-block", 4, "ngFor", "ngForOf", "ngForTrackBy"], [1, "area-news-block"], [1, "area-news-block__header"], [1, "area-news-version"], [1, "area-news-content"], [1, "area-news-items"], ["class", "area-news-item", 4, "ngFor", "ngForOf", "ngForTrackBy"], [1, "area-news-item"], [4, "ngIf", "ngIfElse"], [1, "area-news-item__title"], ["class", "area-news-item__description", 4, "ngIf"], ["target", "_blank", "rel", "noopener noreferrer", 1, "area-news-item__action", 3, "href"], [1, "area-news-item__description"], ["target", "_blank", "rel", "noopener noreferrer", 1, "area-news-item__link", 3, "href"]], template: function AreaNewsComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275pipe(8, "translate");
      \u0275\u0275elementEnd()()();
      \u0275\u0275template(9, AreaNewsComponent_p_9_Template, 3, 3, "p", 7)(10, AreaNewsComponent_p_10_Template, 3, 3, "p", 8)(11, AreaNewsComponent_div_11_Template, 2, 2, "div", 9)(12, AreaNewsComponent_p_12_Template, 3, 3, "p", 7);
      \u0275\u0275elementEnd();
    }
    if (rf & 2) {
      \u0275\u0275advance(4);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(5, 6, "home.news.kicker"));
      \u0275\u0275advance(3);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(8, 8, "home.news.title"));
      \u0275\u0275advance(2);
      \u0275\u0275property("ngIf", ctx.loading());
      \u0275\u0275advance();
      \u0275\u0275property("ngIf", ctx.error());
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(AreaNewsComponent, [{
    type: Component,
    args: [{ selector: "app-area-news", imports: [CommonModule, TranslateModule], template: `<section class="area-news" aria-labelledby="area-news-title">\r
  <header class="area-news-header">\r
    <div class="area-news-header__text">\r
      <p class="area-news-kicker">{{ 'home.news.kicker' | translate }}</p>\r
      <h3 id="area-news-title" class="area-news-title">{{ 'home.news.title' | translate }}</h3>\r
    </div>\r
  </header>\r
\r
  <p *ngIf="loading()" class="area-news-state">{{ 'home.news.loading' | translate }}</p>\r
  <p *ngIf="error()" class="area-news-state area-news-state-error">{{ error() | translate }}</p>\r
\r
  <div *ngIf="!loading() && !error() && updates().length" class="area-news-list">\r
    <article *ngFor="let block of updates(); trackBy: trackByVersion" class="area-news-block">\r
      <header class="area-news-block__header">\r
        <span class="area-news-version">{{ block.version }}</span>\r
      </header>\r
\r
      <div class="area-news-content">\r
        <ul class="area-news-items">\r
          <li *ngFor="let item of block.items; trackBy: trackByItem" class="area-news-item">\r
            <ng-container *ngIf="item.link; else legacyLinkItem">\r
              <strong class="area-news-item__title">{{ item.title }}</strong>\r
              <span *ngIf="item.description" class="area-news-item__description">{{ item.description }}</span>\r
              <a class="area-news-item__action" [href]="item.link" target="_blank" rel="noopener noreferrer">{{ 'home.news.view' | translate }}</a>\r
            </ng-container>\r
\r
            <ng-template #legacyLinkItem>\r
              <ng-container *ngIf="item.nwLink; else plainItem">\r
              <a\r
                class="area-news-item__link"\r
                [href]="item.nwLink"\r
                target="_blank"\r
...
\r
  <p *ngIf="!loading() && !error() && !updates().length" class="area-news-state">\r
    {{ 'home.news.empty' | translate }}\r
  </p>\r
</section>\r
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AreaNewsComponent, { className: "AreaNewsComponent", filePath: "src/app/components/area-news/area-news.component.ts", lineNumber: 26 });
})();

// src/app/components/area-statistics/area-statistics.component.ts
var _c02 = (a0) => ({ date: a0 });
function AreaStatisticsComponent_p_13_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p", 11);
    \u0275\u0275text(1);
    \u0275\u0275pipe(2, "translate");
  ...
  if (rf & 2) {
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(2, 1, "home.statistics.loading"));
  }
}
function AreaStatisticsComponent_p_14_Template(rf, ctx) {
  if (rf & 1) {
...
function AreaStatisticsComponent_ul_15_li_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "li", 15)(1, "span", 16);
    \u0275\u0275text(2);
    \u0275\u0275pipe(3, "translate");
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    const item_r2 = ctx.$implicit;
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(item_r2.translationKey ? \u0275\u0275pipeBind1(3, 2, item_r2.translationKey) : item_r2.name);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(item_r2.total);
  }
}
function AreaStatisticsComponent_ul_15_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "ul", 13);
    \u0275\u0275template(1, AreaStatisticsComponent_ul_15_li_1_Template, 6, 4, "li", 14);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
...
function AreaStatisticsComponent_p_16_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p", 11);
    \u0275\u0275text(1);
    \u0275\u0275pipe(2, "translate");
  ...
  if (rf & 2) {
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(2, 1, "home.statistics.empty"), " ");
  }
}
function AreaStatisticsComponent_small_17_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(2, 1, "home.statistics.updatedAt", \u0275\u0275pureFunction1(4, _c02, ctx_r0.updateDate())), " ");
  }
}
var AreaStatisticsComponent = class _AreaStatisticsComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AreaStatisticsComponent, selectors: [["app-area-statistics"]], decls: 18, vars: 14, consts: [["aria-labelledby", "area-statistics-title", 1, "area-statistics"], [1, "area-statistics-header"], [1, "area-statistics-header__text"], [1, "area-statistics-kicker"], ["id", "area-statistics-title", 1, "area-statistics-title"], ["routerLink", "/statistics", 1, "area-statistics-link"], ["aria-hidden", "true", 1, "bi", "bi-arrow-up-right"], ["class", "area-statistics-state", 4, "ngIf"], ["class", "area-statistics-state area-statistics-state-error", 4, "ngIf"], ["class", "area-statistics-list", 4, "ngIf"], ["class", "area-statistics-update", 4, "ngIf"], [1, "area-statistics-state"], [1, "area-statistics-state", "area-statistics-state-error"], [1, "area-statistics-list"], ["class", "area-statistics-item", 4, "ngFor", "ngForOf", "ngForTrackBy"], [1, "area-statistics-item"], [1, "area-statistics-name"], [1, "area-statistics-total"], [1, "area-statistics-update"]], template: function AreaStatisticsComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275element(12, "i", 6);
      \u0275\u0275elementEnd()();
      \u0275\u0275template(13, AreaStatisticsComponent_p_13_Template, 3, 3, "p", 7)(14, AreaStatisticsComponent_p_14_Template, 3, 3, "p", 8)(15, AreaStatisticsComponent_ul_15_Template, 2, 2, "ul", 9)(16, AreaStatisticsComponent_p_16_Template, 3, 3, "p", 7)(17, AreaStatisticsComponent_small_17_Template, 3, 6, "small", 10);
      \u0275\u0275elementEnd();
    }
    if (rf & 2) {
      \u0275\u0275advance(4);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(5, 8, "home.statistics.kicker"));
      \u0275\u0275advance(3);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(8, 10, "home.statistics.title"));
      \u0275\u0275advance(3);
      \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(11, 12, "home.statistics.title"), " ");
      \u0275\u0275advance(3);
      \u0275\u0275property("ngIf", ctx.loading());
      \u0275\u0275advance();
      \u0275\u0275property("ngIf", ctx.error());
  ...
  }, dependencies: [CommonModule, NgForOf, NgIf, RouterLink, TranslateModule, TranslatePipe], styles: ["\n\n.area-statistics[_ngcontent-%COMP%] {\n  border: 1px solid var(--theme-line);\n  border-radius: 1rem;\n  background: var(--theme-card-bg);\n  box-shadow: 0 8px 24px rgba(16, 37, 66, 0.05);\n  padding: 1.1rem;\n  height: 100%;\n}\n.area-statistics-header[_ngcontent-%COMP%] {\n  align-items: flex-start;\n  display: flex;\n  justify-content: space-between;\n  gap: 1rem;\n  margin-bottom: 1rem;\n}\n.area-statistics-header__text[_ngcontent-%COMP%] {\n  display: grid;\n  gap: 0.15rem;\n}\n.area-statistics-link[_ngcontent-%COMP%] {\n  align-items: center;\n  color: var(--bs-primary);\n  display: inline-flex;\n  flex: 0 0 auto;\n  font-size: 0.78rem;\n  font-weight: 600;\n  gap: 0.35rem;\n  text-decoration: none;\n}\n.area-statistics-link[_ngcontent-%COMP%]:hover, \n.area-statistics-link[_ngcontent-%COMP%]:focus-visible {\n  text-decoration: underline;\n}\n.area-statistics-kicker[_ngcontent-%COMP%] {\n  color: var(--theme-muted);\n  font-size: 0.68rem;\n  letter-spacing: 0.11rem;\n  margin: 0;\n  text-transform: uppercase;\n}\n.area-statistics-title[_ngcontent-%COMP%] {\n  font-size: 1.03rem;\n  font-weight: 600;\n  margin: 0;\n  color: var(--theme-ink);\n}\n.area-statistics-summary[_ngcontent-%COMP%] {\n  align-items: flex-end;\n  background: rgba(255, 255, 255, 0.34);\n  border: 1px solid var(--theme-line);\n  border-radius: 0.9rem;\n  display: grid;\n  gap: 0.1rem;\n  min-width: 7.75rem;\n  padding: 0.6rem 0.75rem;\n  text-align: right;\n}\n.area-statistics-summary__label[_ngcontent-%COMP%] {\n  color: var(--theme-muted);\n  font-size: 0.74rem;\n}\n.area-statistics-summary__value[_ngcontent-%COMP%] {\n  color: var(--theme-muted);\n  font-size: 0.82rem;\n  font-weight: 600;\n}\n.area-statistics-list[_ngcontent-%COMP%] {\n  list-style: none;\n  margin: 0;\n  padding: 0.15rem 0 0;\n  display: grid;\n  gap: 0.3rem;\n}\n.area-statistics-item[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: baseline;\n  justify-content: space-between;\n  gap: 0.5rem;\n  background: transparent;\n  border: 0;\n  border-radius: 0;\n  padding: 0.15rem 0;\n}\n.area-statistics-name[_ngcontent-%COMP%] {\n  font-size: 0.88rem;\n  font-weight: 500;\n  color: var(--theme-ink);\n}\n.area-statistics-total[_ngcontent-%COMP%] {\n  align-items: center;\n  background: transparent;\n  border: 0;\n  border-radius: 0;\n  color: var(--theme-muted);\n  display: inline-flex;\n  font-size: 0.9rem;\n  font-weight: 700;\n  justify-content: center;\n  min-width: auto;\n  padding: 0;\n}\n.area-statistics-state[_ngcontent-%COMP%] {\n  margin: 0;\n  font-size: 0.95rem;\n  color: var(--theme-muted);\n}\n.area-statistics-state-error[_ngcontent-%COMP%] {\n  color: #a02b2b;\n}\n.area-statistics-update[_ngcontent-%COMP%] {\n  display: block;\n  margin-top: 0.75rem;\n  color: var(--theme-muted);\n  font-size: 0.78rem;\n  letter-spacing: 0.01em;\n}\n/*# sourceMappingURL=area-statistics.component.css.map */"] });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(AreaStatisticsComponent, [{
    type: Component,
    args: [{ selector: "app-area-statistics", imports: [CommonModule, RouterLink, TranslateModule], template: `<section class="area-statistics" aria-labelledby="area-statistics-title">\r
  <header class="area-statistics-header">\r
    <div class="area-statistics-header__text">\r
      <p class="area-statistics-kicker">{{ 'home.statistics.kicker' | translate }}</p>\r
      <h3 id="area-statistics-title" class="area-statistics-title">{{ 'home.statistics.title' | translate }}</h3>\r
    </div>\r
    <a class="area-statistics-link" routerLink="/statistics">\r
      {{ 'home.statistics.title' | translate }}\r
      <i class="bi bi-arrow-up-right" aria-hidden="true"></i>\r
    </a>\r
  </header>\r
\r
  <p *ngIf="loading()" class="area-statistics-state">{{ 'home.statistics.loading' | translate }}</p>\r
  <p *ngIf="error()" class="area-statistics-state area-statistics-state-error">{{ error() | translate }}</p>\r
\r
  <ul *ngIf="!loading() && !error() && stats().length" class="area-statistics-list">\r
    <li *ngFor="let item of stats(); trackBy: trackByName" class="area-statistics-item">\r
      <span class="area-statistics-name">{{ item.translationKey ? (item.translationKey | translate) : item.name }}</span>\r
      <strong class="area-statistics-total">{{ item.total }}</strong>\r
    </li>\r
  </ul>\r
\r
  <p *ngIf="!loading() && !error() && !stats().length" class="area-statistics-state">\r
    {{ 'home.statistics.empty' | translate }}\r
  </p>\r
\r
  <small *ngIf="!loading() && !error() && updateDate()" class="area-statistics-update">\r
    {{ 'home.statistics.updatedAt' | translate: { date: updateDate() } }}\r
  </small>\r
</section>\r
`, styles: ["/* src/app/components/area-statistics/area-statistics.component.scss */\n.area-statistics {\n  border: 1px solid var(--theme-line);\n  border-radius: 1rem;\n  background: var(--theme-card-bg);\n  box-shadow: 0 8px 24px rgba(16, 37, 66, 0.05);\n  padding: 1.1rem;\n  height: 100%;\n}\n.area-statistics-header {\n  align-items: flex-start;\n  display: flex;\n  justify-content: space-between;\n  gap: 1rem;\n  margin-bottom: 1rem;\n}\n.area-statistics-header__text {\n  display: grid;\n  gap: 0.15rem;\n}\n.area-statistics-link {\n  align-items: center;\n  color: var(--bs-primary);\n  display: inline-flex;\n  flex: 0 0 auto;\n  font-size: 0.78rem;\n  font-weight: 600;\n  gap: 0.35rem;\n  text-decoration: none;\n}\n.area-statistics-link:hover,\n.area-statistics-link:focus-visible {\n  text-decoration: underline;\n}\n.area-statistics-kicker {\n  color: var(--theme-muted);\n  font-size: 0.68rem;\n  letter-spacing: 0.11rem;\n  margin: 0;\n  text-transform: uppercase;\n}\n.area-statistics-title {\n  font-size: 1.03rem;\n  font-weight: 600;\n  margin: 0;\n  color: var(--theme-ink);\n}\n.area-statistics-summary {\n  align-items: flex-end;\n  background: rgba(255, 255, 255, 0.34);\n  border: 1px solid var(--theme-line);\n  border-radius: 0.9rem;\n  display: grid;\n  gap: 0.1rem;\n  min-width: 7.75rem;\n  padding: 0.6rem 0.75rem;\n  text-align: right;\n}\n.area-statistics-summary__label {\n  color: var(--theme-muted);\n  font-size: 0.74rem;\n}\n.area-statistics-summary__value {\n  color: var(--theme-muted);\n  font-size: 0.82rem;\n  font-weight: 600;\n}\n.area-statistics-list {\n  list-style: none;\n  margin: 0;\n  padding: 0.15rem 0 0;\n  display: grid;\n  gap: 0.3rem;\n}\n.area-statistics-item {\n  display: flex;\n  align-items: baseline;\n  justify-content: space-between;\n  gap: 0.5rem;\n  background: transparent;\n  border: 0;\n  border-radius: 0;\n  padding: 0.15rem 0;\n}\n.area-statistics-name {\n  font-size: 0.88rem;\n  font-weight: 500;\n  color: var(--theme-ink);\n}\n.area-statistics-total {\n  align-items: center;\n  background: transparent;\n  border: 0;\n  border-radius: 0;\n  color: var(--theme-muted);\n  display: inline-flex;\n  font-size: 0.9rem;\n  font-weight: 700;\n  justify-content: center;\n  min-width: auto;\n  padding: 0;\n}\n.area-statistics-state {\n  margin: 0;\n  font-size: 0.95rem;\n  color: var(--theme-muted);\n}\n.area-statistics-state-error {\n  color: #a02b2b;\n}\n.area-statistics-update {\n  display: block;\n  margin-top: 0.75rem;\n  color: var(--theme-muted);\n  font-size: 0.78rem;\n  letter-spacing: 0.01em;\n}\n/*# sourceMappingURL=area-statistics.component.css.map */\n"] }]
  }], () => [], null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AreaStatisticsComponent, { className: "AreaStatisticsComponent", filePath: "src/app/components/area-statistics/area-statistics.component.ts", lineNumber: 21 });
})();
...
function SearchFilterAuthorsComponent_For_8_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275domElementStart(0, "li", 5)(1, "span", 8);
    \u0275\u0275text(2);
    \u0275\u0275domElementEnd();
...
function SearchFilterAuthorsComponent_Conditional_9_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275domListener("click", function SearchFilterAuthorsComponent_Conditional_9_Template_button_click_0_listener() {
      ...
      return \u0275\u0275resetView(ctx_r2.togglePanel());
    });
    \u0275\u0275text(1);
    \u0275\u0275domElementEnd();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r2.expanded() ? "Close" : "View more", " ");
  }
}
...
function SearchFilterAuthorsComponent_Conditional_10_For_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275domElementStart(0, "li", 12)(1, "span", 8);
    \u0275\u0275text(2);
    \u0275\u0275domElementEnd();
...
function SearchFilterAuthorsComponent_Conditional_10_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(2, SearchFilterAuthorsComponent_Conditional_10_For_3_Template, 4, 2, "li", 12, _forTrack1);
    \u0275\u0275domElementEnd()();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275advance(2);
    \u0275\u0275repeater(ctx_r2.panelItems());
  }
}
var SearchFilterAuthorsComponent = class _SearchFilterAuthorsComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SearchFilterAuthorsComponent, selectors: [["app-search-filter-authors"]], inputs: { items: "items" }, decls: 11, vars: 3, consts: [["aria-labelledby", "search-filter-authors-title", 1, "filter-block"], [1, "filter-head"], ["id", "search-filter-authors-title", 1, "filter-title"], [1, "filter-count"], [1, "filter-list"], [1, "filter-item"], ["type", "button", 1, "view-more"], ["aria-label", "Authors list", 1, "panel"], [1, "label"], [1, "badge"], ["type", "button", 1, "view-more", 3, "click"], [1, "panel-list"], [1, "panel-item"]], template: function SearchFilterAuthorsComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275repeaterCreate(7, SearchFilterAuthorsComponent_For_8_Template, 4, 2, "li", 5, _forTrack0);
      \u0275\u0275domElementEnd();
  ...
  <ul class="filter-list">\r
    @for (item of topItems(); track item.label + '-' + $index) {\r
      <li class="filter-item">\r
        <span class="label">{{ item.label }}</span>\r
...
function SearchFilterKeywordsComponent_Conditional_10_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275domElementStart(0, "section", 7)(1, "ul", 11);
    \u0275\u0275repeaterCreate(2, SearchFilterKeywordsComponent_Conditional_10_For_3_Template, 4, 2, "li", 12, _forTrack12);
    \u0275\u0275domElementEnd()();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
...
var SearchFilterKeywordsComponent = class _SearchFilterKeywordsComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SearchFilterKeywordsComponent, selectors: [["app-search-filter-keywords"]], inputs: { items: "items" }, decls: 11, vars: 3, consts: [["aria-labelledby", "search-filter-keywords-title", 1, "filter-block"], [1, "filter-head"], ["id", "search-filter-keywords-title", 1, "filter-title"], [1, "filter-count"], [1, "filter-list"], [1, "filter-item"], ["type", "button", 1, "view-more"], ["aria-label", "Keywords list", 1, "panel"], [1, "label"], [1, "badge"], ["type", "button", 1, "view-more", 3, "click"], [1, "panel-list"], [1, "panel-item"]], template: function SearchFilterKeywordsComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275domElementStart(0, "section", 0)(1, "header", 1)(2, "h3", 2);
      \u0275\u0275text(3, "Keywords");
      \u0275\u0275domElementEnd();
      ...
      \u0275\u0275domElementEnd()();
      \u0275\u0275domElementStart(6, "ul", 4);
      \u0275\u0275repeaterCreate(7, SearchFilterKeywordsComponent_For_8_Template, 4, 2, "li", 5, _forTrack02);
      \u0275\u0275domElementEnd();
...
function SearchFilterSourcesComponent_Conditional_10_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275domElementStart(0, "section", 7)(1, "ul", 11);
    \u0275\u0275repeaterCreate(2, SearchFilterSourcesComponent_Conditional_10_For_3_Template, 4, 2, "li", 12, _forTrack13);
    \u0275\u0275domElementEnd()();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
...
var SearchFilterSourcesComponent = class _SearchFilterSourcesComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SearchFilterSourcesComponent, selectors: [["app-search-filter-sources"]], inputs: { items: "items" }, decls: 11, vars: 3, consts: [["aria-labelledby", "search-filter-sources-title", 1, "filter-block"], [1, "filter-head"], ["id", "search-filter-sources-title", 1, "filter-title"], [1, "filter-count"], [1, "filter-list"], [1, "filter-item"], ["type", "button", 1, "view-more"], ["aria-label", "Sources list", 1, "panel"], [1, "label"], [1, "badge"], ["type", "button", 1, "view-more", 3, "click"], [1, "panel-list"], [1, "panel-item"]], template: function SearchFilterSourcesComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275domElementStart(0, "section", 0)(1, "header", 1)(2, "h3", 2);
      \u0275\u0275text(3, "Sources");
      \u0275\u0275domElementEnd();
      ...
      \u0275\u0275domElementEnd()();
      \u0275\u0275domElementStart(6, "ul", 4);
      \u0275\u0275repeaterCreate(7, SearchFilterSourcesComponent_For_8_Template, 4, 2, "li", 5, _forTrack03);
      \u0275\u0275domElementEnd();
...
function SearchResultComponent_For_13_Conditional_21_For_2_Template(rf, ctx) {
  if (rf & 1) {
...
function SearchResultComponent_For_13_Conditional_21_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 22);
    \u0275\u0275repeaterCreate(1, SearchResultComponent_For_13_Conditional_21_For_2_Template, 2, 1, "span", 23, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const card_r2 = \u0275\u0275nextContext().$implicit;
...
function SearchResultComponent_For_13_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(14);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(15, "h3", 18)(16, "input", 19);
    \u0275\u0275listener("change", function SearchResultComponent_For_13_Template_input_change_16_listener($event) {
      const card_r2 = \u0275\u0275restoreView(_r1).$implicit;
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.toggleMarked(card_r2.id, $event.target.checked));
    });
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(17, "a", 20);
    \u0275\u0275text(18);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(19, "p", 21);
    \u0275\u0275text(20);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(21, SearchResultComponent_For_13_Conditional_21_Template, 3, 0, "div", 22);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate2("#", $index_r5 + 1, "/", ctx_r2.totalResults());
    \u0275\u0275advance(2);
    ...
    \u0275\u0275advance();
    \u0275\u0275conditional(card_r2.keywords.length ? 21 : -1);
  }
}
...
var SearchResultComponent = class _SearchResultComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SearchResultComponent, selectors: [["app-search-result"]], hostBindings: function SearchResultComponent_HostBindings(rf, ctx) {
    ...
    if (rf & 1) {
      ...
      \u0275\u0275repeaterCreate(12, SearchResultComponent_For_13_Template, 22, 11, "li", 8, _forTrack04);
      \u0275\u0275elementEnd();
    ...
    if (rf & 2) {
      \u0275\u0275advance(3);
      \u0275\u0275property("ngComponentOutlet", ctx.sourcesFilterComponent)("ngComponentOutletInputs", \u0275\u0275pureFunction1(10, _c03, ctx.sources));
      \u0275\u0275advance();
      \u0275\u0275property("ngComponentOutlet", ctx.authorsFilterComponent)("ngComponentOutletInputs", \u0275\u0275pureFunction1(12, _c03, ctx.authors));
      \u0275\u0275advance();
      \u0275\u0275property("ngComponentOutlet", ctx.keywordsFilterComponent)("ngComponentOutletInputs", \u0275\u0275pureFunction1(14, _c03, ctx.keywords));
      \u0275\u0275advance(2);
...
\r
              <header class="meta-top">\r
                ...
                <span class="pill">#{{ $index + 1 }}/{{ totalResults() }}</span>\r
              </header>\r
            </div>\r
\r
            <h3 class="title">\r
...
function SearchArticlesComponent_div_20_a_1_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(3, 2, "search.selected"), " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(ctx_r2.markedCount);
  }
}
function SearchArticlesComponent_div_20_button_2_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 41);
    \u0275\u0275listener("click", function SearchArticlesComponent_div_20_button_2_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r4);
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.clearMarked());
    });
    \u0275\u0275text(1);
    \u0275\u0275pipe(2, "translate");
    \u0275\u0275elementEnd();
...
function SearchArticlesComponent_div_20_button_3_Template(rf, ctx) {
  if (rf & 1) {
    const _r5 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 42);
    \u0275\u0275listener("click", function SearchArticlesComponent_div_20_button_3_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r5);
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.selectAllWorks());
    });
    \u0275\u0275text(1);
    \u0275\u0275pipe(2, "translate");
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(2);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(2, 1, "search.select_all_items", \u0275\u0275pureFunction1(4, _c04, ctx_r2.works.length)), " ");
  }
}
function SearchArticlesComponent_div_20_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 34);
    \u0275\u0275template(1, SearchArticlesComponent_div_20_a_1_Template, 6, 4, "a", 35)(2, SearchArticlesComponent_div_20_button_2_Template, 3, 3, "button", 36)(3, SearchArticlesComponent_div_20_button_3_Template, 3, 6, "button", 37);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r2.hasMarked);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r2.hasMarked);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", !ctx_r2.loading() && ctx_r2.works.length > 0);
  }
}
function SearchArticlesComponent_option_31_Template(rf, ctx) {
  if (rf & 1) {
...
function SearchArticlesComponent_option_37_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "option", 43);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function SearchArticlesComponent_div_42_Template(rf, ctx) {
  if (rf & 1) {
    const _r8 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div")(1, "input", 44);
    \u0275\u0275listener("change", function SearchArticlesComponent_div_42_Template_input_change_1_listener($event) {
      \u0275\u0275restoreView(_r8);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.onCollectionChange($event));
    });
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    const pub_r9 = ctx.$implicit;
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275property("id", \u0275\u0275interpolate1("col-", pub_r9.value))("value", pub_r9.value)("checked", ctx_r2.filtersForm.value.collection.includes(pub_r9.value));
    \u0275\u0275advance();
    \u0275\u0275property("for", \u0275\u0275interpolate1("col-", pub_r9.value));
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1("\xA0", \u0275\u0275pipeBind1(4, 7, "search.filters.types." + pub_r9.value));
  }
}
function SearchArticlesComponent_div_47_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div");
    \u0275\u0275element(1, "input", 46);
    \u0275\u0275elementStart(2, "label", 47);
    \u0275\u0275text(3);
    \u0275\u0275pipe(4, "translate");
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    ...
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275property("id", \u0275\u0275interpolate1("field-", field_r10.value))("value", field_r10.value)("checked", ctx_r2.filtersForm.value.fields === field_r10.value);
    \u0275\u0275advance();
    \u0275\u0275property("for", \u0275\u0275interpolate1("field-", field_r10.value));
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(4, 7, "search.filters.fields." + field_r10.value));
  }
}
function SearchArticlesComponent_div_52_Template(rf, ctx) {
  if (rf & 1) {
    const _r11 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div")(1, "input", 48);
    \u0275\u0275listener("change", function SearchArticlesComponent_div_52_Template_input_change_1_listener() {
      const method_r12 = \u0275\u0275restoreView(_r11).$implicit;
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.saveSearchMethod(method_r12));
    });
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(2, "label", 47);
    \u0275\u0275text(3);
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275property("value", method_r12)("id", "search-method-" + method_r12);
    \u0275\u0275advance();
    \u0275\u0275property("for", "search-method-" + method_r12);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(4, 4, "search.methods." + method_r12));
  }
}
function SearchArticlesComponent_div_57_Template(rf, ctx) {
  if (rf & 1) {
    const _r13 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div")(1, "input", 49);
    \u0275\u0275listener("change", function SearchArticlesComponent_div_57_Template_input_change_1_listener() {
      const limit_r14 = \u0275\u0275restoreView(_r13).$implicit;
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.saveSearchLimit(limit_r14));
    });
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(2, "label", 47);
    \u0275\u0275text(3);
  ...
  if (rf & 2) {
    const limit_r14 = ctx.$implicit;
    \u0275\u0275advance();
    \u0275\u0275property("value", limit_r14)("id", "search-limit-" + limit_r14);
    \u0275\u0275advance();
    \u0275\u0275property("for", "search-limit-" + limit_r14);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(limit_r14);
  }
}
function SearchArticlesComponent_Conditional_58_ng_container_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275element(1, "app-search-result", 51);
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(2);
    \u0275\u0275advance();
    \u0275\u0275property("results", ctx_r2.apiResults())("sources", ctx_r2.filterSources())("authors", ctx_r2.filterAuthors())("keywords", ctx_r2.filterKeywords());
  }
}
function SearchArticlesComponent_Conditional_58_ng_container_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
...
function SearchArticlesComponent_Conditional_58_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 30)(1, "div", 50);
    \u0275\u0275template(2, SearchArticlesComponent_Conditional_58_ng_container_2_Template, 2, 4, "ng-container", 10)(3, SearchArticlesComponent_Conditional_58_ng_container_3_Template, 4, 3, "ng-container", 10);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275advance(2);
    \u0275\u0275property("ngIf", ctx_r2.hasResults());
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", !ctx_r2.loading() && !ctx_r2.hasResults());
  }
}
function SearchArticlesComponent_div_59_ng_container_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainer(0);
  }
}
function SearchArticlesComponent_div_59_ng_container_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainer(0);
  }
}
function SearchArticlesComponent_div_59_ng_container_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainer(0);
  }
}
function SearchArticlesComponent_div_59_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 53)(1, "section", 54);
    \u0275\u0275template(2, SearchArticlesComponent_div_59_ng_container_2_Template, 1, 0, "ng-container", 55);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "section", 56);
    \u0275\u0275template(4, SearchArticlesComponent_div_59_ng_container_4_Template, 1, 0, "ng-container", 55);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "section", 57);
    \u0275\u0275template(6, SearchArticlesComponent_div_59_ng_container_6_Template, 1, 0, "ng-container", 55);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275advance(2);
    \u0275\u0275property("ngComponentOutlet", ctx_r2.areaNewsComponent);
    \u0275\u0275advance(2);
    \u0275\u0275property("ngComponentOutlet", ctx_r2.areaStatisticsComponent);
    \u0275\u0275advance(2);
    \u0275\u0275property("ngComponentOutlet", ctx_r2.areaEventsComponent);
  }
}
var SearchArticlesComponent = class _SearchArticlesComponent {
  ...
  searchMethods = computed(() => this.currentUser()?.role === "admin" ? ["v3", "v4", "v5"] : ["v3", "v4"], ...ngDevMode ? [{ debugName: "searchMethods" }] : []);
  searchMethodCookie = "brapci_search_method";
  searchLimits = [1e3, 2e3, 3e3, 4e3, 5e3];
  searchLimitCookie = "brapci_search_limit";
  ...
  toggleFilters(panel) {
    ...
    animation.onfinish = () => {
      if (this.filtersAnimation === animation)
        this.filtersAnimation = void 0;
    };
  }
  filtersForm;
  yearsStart = [];
  ...
  savedSearchMethod() {
    try {
      ...
      return this.searchMethods().includes(saved) ? saved : "v4";
    } catch {
      return "v4";
    }
  }
  saveSearchMethod(method) {
  ...
  normalizeSearchLimit(value) {
    const limit = Number(value);
    return this.searchLimits.includes(limit) ? limit : 1e3;
  }
  savedSearchLimit() {
    try {
  ...
  saveSearchLimit(limit) {
    this.sessionService.setCookie(this.searchLimitCookie, String(this.normalizeSearchLimit(limit)));
  }
  initYears() {
  ...
  searchInBrapci(filtersPanel) {
    ...
    this.search = true;
    this.loading.set(true);
    const selectedMethod = this.filtersForm.value.method;
    const method = this.searchMethods().includes(selectedMethod) ? selectedMethod : "v4";
    this.brapciApiService.search(term, filters, method).subscribe({
      next: (response) => {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SearchArticlesComponent, selectors: [["app-search-articles"]], decls: 60, vars: 50, consts: [["filtersPanel", ""], ["id", "search", "aria-labelledby", "search-title", "itemprop", "mainEntity", "itemscope", "", "itemtype", "https://schema.org/Dataset", 1, "col-12"], [1, "cardx", "h-100x", "shadow-sm", "border-0"], [1, "card-body"], ["id", "search-title", 1, "search-title"], [1, "search-form", "mb-0", 3, "ngSubmit"], ["for", "query", 1, "form-label", "mb-0"], [1, "input-group", "mt-0"], ["id", "query", "name", "query", "rows", "3", 1, "form-control", "border", "border-secondary", 3, "ngModelChange", "ngModel", "placeholder"], ["type", "submit", 1, "btn", "btn-primary", 3, "disabled"], [4, "ngIf"], ["class", "d-inline-flex align-items-center gap-2", 4, "ngIf"], [1, "search-actions"], ["type", "button", "aria-controls", "search-filters-panel", 1, "link", "search-action-link", "search-filters-toggle", 3, "click"], ["class", "selection-actions", 4, "ngIf"], ["id", "search-filters-panel", 1, "search-filters-collapse"], [1, "search-filters-clip"], [1, "search-filters"], [1, "search-filters-form", 3, "formGroup"], [1, "search-filter-col-year"], ["for", "year_start"], ["id", "year_start", "formControlName", "year_start", 1, "form-control"], [3, "value", 4, "ngFor", "ngForOf"], ["for", "year_end"], ["id", "year_end", "formControlName", "year_end", 1, "form-control"], [1, "search-filter-col-wide"], [1, "search-filter-title"], [4, "ngFor", "ngForOf"], [1, "search-filter-col-method"], [1, "search-filter-col-limit"], [1, "search-results-grid", "mt-4"], ["class", "idle-layout mt-5", 4, "ngIf"], [1, "d-inline-flex", "align-items-center", "gap-2"], ["role", "status", "aria-hidden", "true", 1, "spinner-border", "spinner-border-sm"], [1, "selection-actions"], ["class", "btn btn-outline-success btn-sm selection-summary", "routerLink", "/basket/selected", 4, "ngIf"], ["type", "button", "class", "btn btn-outline-danger btn-sm", 3, "click", 4, "ngIf"], ["type", "button", "class", "btn btn-primary btn-sm selection-all", 3, "click", 4, "ngIf"], ["routerLink", "/basket/selected", 1, "btn", "btn-outline-success", "btn-sm", "selection-summary"], ["aria-hidden", "true", 1, "bi", "bi-check2-square"], [1, "badge", "rounded-pill", "text-bg-success"], ["type", "button", 1, "btn", "btn-outline-danger", "btn-sm", 3, "click"], ["type", "button", 1, "btn", "btn-primary", "btn-sm", "selection-all", 3, "click"], [3, "value"], ["type", "checkbox", 3, "change", "value", "checked", "id"], [3, "for"], ["type", "radio", "name", "fields", "formControlName", "fields", 3, "value", "id", "checked"], [1, "ms-1", 3, "for"], ["type", "radio", "name", "method", "formControlName", "method", 3, "change", "value", "id"], ["type", "radio", "name", "limit", "formControlName", "limit", 3, "change", "value", "id"], [1, "search-results-main"], [3, "results", "sources", "authors", "keywords"], [1, "hint", "mb-0", "mt-3"], [1, "idle-layout", "mt-5"], [1, "idle-col", "idle-col-news"], [4, "ngComponentOutlet"], [1, "idle-col", "idle-col-stats"], [1, "idle-col", "idle-col-events"]], template: function SearchArticlesComponent_Template(rf, ctx) {
    if (rf & 1) {
      const _r1 = \u0275\u0275getCurrentView();
      \u0275\u0275elementStart(0, "article", 1)(1, "div", 2)(2, "div", 3)(3, "h2", 4);
      \u0275\u0275text(4);
      \u0275\u0275pipe(5, "translate");
      \u0275\u0275elementEnd();
      ...
      \u0275\u0275listener("ngSubmit", function SearchArticlesComponent_Template_form_ngSubmit_6_listener() {
        \u0275\u0275restoreView(_r1);
        const filtersPanel_r2 = \u0275\u0275reference(22);
        return \u0275\u0275resetView(ctx.searchInBrapci(filtersPanel_r2));
      });
      \u0275\u0275elementStart(7, "label", 6);
      \u0275\u0275text(8);
      \u0275\u0275pipe(9, "translate");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(10, "div", 7)(11, "textarea", 8);
      \u0275\u0275pipe(12, "translate");
      \u0275\u0275listener("ngModelChange", function SearchArticlesComponent_Template_textarea_ngModelChange_11_listener($event) {
        \u0275\u0275restoreView(_r1);
        return \u0275\u0275resetView(ctx.query.set($event));
      });
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(13, "button", 9);
      \u0275\u0275template(14, SearchArticlesComponent_span_14_Template, 3, 3, "span", 10)(15, SearchArticlesComponent_span_15_Template, 5, 3, "span", 11);
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(16, "div", 12)(17, "button", 13);
      \u0275\u0275listener("click", function SearchArticlesComponent_Template_button_click_17_listener() {
        \u0275\u0275restoreView(_r1);
        const filtersPanel_r2 = \u0275\u0275reference(22);
        return \u0275\u0275resetView(ctx.toggleFilters(filtersPanel_r2));
      });
      \u0275\u0275text(18);
      \u0275\u0275pipe(19, "translate");
      \u0275\u0275elementEnd()();
      \u0275\u0275template(20, SearchArticlesComponent_div_20_Template, 4, 3, "div", 14);
      \u0275\u0275elementStart(21, "div", 15, 0)(23, "div", 16)(24, "div", 17)(25, "form", 18)(26, "div", 19)(27, "label", 20);
      \u0275\u0275text(28);
      \u0275\u0275pipe(29, "translate");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(30, "select", 21);
      \u0275\u0275template(31, SearchArticlesComponent_option_31_Template, 2, 2, "option", 22);
      \u0275\u0275elementEnd()();
      ...
      \u0275\u0275template(37, SearchArticlesComponent_option_37_Template, 2, 2, "option", 22);
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(38, "div", 25)(39, "label", 26);
      \u0275\u0275text(40);
      \u0275\u0275pipe(41, "translate");
      \u0275\u0275elementEnd();
      \u0275\u0275template(42, SearchArticlesComponent_div_42_Template, 5, 9, "div", 27);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(43, "div", 25)(44, "label", 26);
      \u0275\u0275text(45);
      \u0275\u0275pipe(46, "translate");
      \u0275\u0275elementEnd();
      \u0275\u0275template(47, SearchArticlesComponent_div_47_Template, 5, 9, "div", 27);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(48, "fieldset", 28)(49, "legend", 26);
      \u0275\u0275text(50);
      \u0275\u0275pipe(51, "translate");
      \u0275\u0275elementEnd();
      \u0275\u0275template(52, SearchArticlesComponent_div_52_Template, 5, 6, "div", 27);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(53, "fieldset", 29)(54, "legend", 26);
      \u0275\u0275text(55);
      \u0275\u0275pipe(56, "translate");
      \u0275\u0275elementEnd();
      \u0275\u0275template(57, SearchArticlesComponent_div_57_Template, 4, 4, "div", 27);
      \u0275\u0275elementEnd()()()()();
      \u0275\u0275conditionalCreate(58, SearchArticlesComponent_Conditional_58_Template, 4, 2, "div", 30);
      \u0275\u0275elementEnd()();
      \u0275\u0275template(59, SearchArticlesComponent_div_59_Template, 7, 3, "div", 31);
      \u0275\u0275elementEnd();
    }
    if (rf & 2) {
      \u0275\u0275advance(4);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(5, 30, "search.title"));
      \u0275\u0275advance(4);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(9, 32, "search.input"));
      \u0275\u0275advance(3);
      \u0275\u0275property("placeholder", \u0275\u0275interpolate(\u0275\u0275pipeBind1(12, 34, "search.input")))("ngModel", ctx.query());
      \u0275\u0275advance(2);
      ...
      \u0275\u0275property("ngIf", ctx.loading());
      \u0275\u0275advance(2);
      \u0275\u0275attribute("aria-expanded", ctx.showFilters);
      \u0275\u0275advance();
      \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(19, 36, "search.filters.title"), " ");
      \u0275\u0275advance(2);
      \u0275\u0275property("ngIf", ctx.hasMarked || !ctx.loading() && ctx.works.length > 0);
      \u0275\u0275advance();
      \u0275\u0275classProp("is-open", ctx.showFilters);
      \u0275\u0275attribute("inert", ctx.showFilters ? null : "")("aria-hidden", !ctx.showFilters);
      \u0275\u0275advance(4);
      \u0275\u0275property("formGroup", ctx.filtersForm);
      \u0275\u0275advance(3);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(29, 38, "search.filters.year_start"));
      \u0275\u0275advance(3);
      \u0275\u0275property("ngForOf", ctx.yearsStart);
      \u0275\u0275advance(3);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(35, 40, "search.filters.year_end"));
      \u0275\u0275advance(3);
      \u0275\u0275property("ngForOf", ctx.yearsEnd);
      \u0275\u0275advance(3);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(41, 42, "search.filters.publication_type"));
      \u0275\u0275advance(2);
      \u0275\u0275property("ngForOf", ctx.publicationTypes);
      \u0275\u0275advance(3);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(46, 44, "search.filters.search_field"));
      \u0275\u0275advance(2);
      \u0275\u0275property("ngForOf", ctx.searchFields);
      \u0275\u0275advance(3);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(51, 46, "search.method"));
      \u0275\u0275advance(2);
      \u0275\u0275property("ngForOf", ctx.searchMethods());
      \u0275\u0275advance(3);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(56, 48, "search.result_limit"));
      \u0275\u0275advance(2);
      \u0275\u0275property("ngForOf", ctx.searchLimits);
      \u0275\u0275advance();
      \u0275\u0275conditional(ctx.search ? 58 : -1);
      \u0275\u0275advance();
...
\r
      <form (ngSubmit)="searchInBrapci(filtersPanel)" class="search-form mb-0">\r
...
\r
      ...
      <div class="search-actions">\r
        <button type="button" (click)="toggleFilters(filtersPanel)" class="link search-action-link search-filters-toggle" [attr.aria-expanded]="showFilters" aria-controls="search-filters-panel">\r
          {{ 'search.filters.title' | translate }}\r
        </button>\r
\r
      </div>\r
\r
      <div *ngIf="hasMarked || (!loading() && works.length > 0)" class="selection-actions">\r
        <a\r
          *ngIf="hasMarked"\r
          class="btn btn-outline-success btn-sm selection-summary"\r
          routerLink="/basket/selected"\r
        >\r
          <i class="bi bi-check2-square" aria-hidden="true"></i>\r
          {{ 'search.selected' | translate }}\r
          <span class="badge rounded-pill text-bg-success">{{ markedCount }}</span>\r
        </a>\r
        <button\r
          *ngIf="hasMarked"\r
          type="button"\r
        ...
        <button\r
          *ngIf="!loading() && works.length > 0"\r
          type="button"\r
          class="btn btn-primary btn-sm selection-all"\r
          (click)="selectAllWorks()"\r
        >\r
          {{ 'search.select_all_items' | translate: { total: works.length } }}\r
        </button>\r
      </div>\r
\r
      <div #filtersPanel id="search-filters-panel" class="search-filters-collapse" [class.is-open]="showFilters" [attr.inert]="showFilters ? null : ''" [attr.aria-hidden]="!showFilters">\r
        <div class="search-filters-clip">\r
        ...
        <form [formGroup]="filtersForm" class="search-filters-form">\r
          ...
          <fieldset class="search-filter-col-method">\r
            <legend class="search-filter-title">{{ 'search.method' | translate }}</legend>\r
            <div *ngFor="let method of searchMethods()">\r
              <input\r
                type="radio"\r
                name="method"\r
                formControlName="method"\r
                [value]="method"\r
                [id]="'search-method-' + method"\r
                (change)="saveSearchMethod(method)"\r
              />\r
              <label [for]="'search-method-' + method" class="ms-1">{{ 'search.methods.' + method | translate }}</label>\r
            </div>\r
          </fieldset>\r
          <fieldset class="search-filter-col-limit">\r
            <legend class="search-filter-title">{{ 'search.result_limit' | translate }}</legend>\r
            <div *ngFor="let limit of searchLimits">\r
              <input\r
                type="radio"\r
                name="limit"\r
                formControlName="limit"\r
                [value]="limit"\r
                [id]="'search-limit-' + limit"\r
                (change)="saveSearchLimit(limit)"\r
              />\r
              <label [for]="'search-limit-' + limit" class="ms-1">{{ limit }}</label>\r
            </div>\r
          </fieldset>\r
        </form>\r
        </div>\r
...
`, styles: ["/* src/app/components/search-articles/search-articles.component.scss */\n.search-form {\n  display: grid;\n  gap: 0.6rem;\n}\n.search-title {\n  color: var(--theme-title);\n  text-align: left;\n  line-height: 10px;\n  size: 2rem;\n}\n.hint {\n  color: var(--theme-hint);\n}\n.search-actions {\n  margin-bottom: 0;\n  display: flex;\n  align-items: center;\n  gap: 0.5rem;\n  font-size: 0.75rem;\n}\n.search-action-link {\n  font-weight: 400;\n  font-size: 0.75rem;\n  display: inline-flex;\n  align-items: center;\n  gap: 0.5rem;\n}\n.search-actions-separator {\n  font-weight: 600;\n  color: var(--theme-muted);\n}\n.search-filters {\n  border: 1px solid var(--theme-line);\n  padding: 1rem;\n  border-radius: 8px;\n  margin-bottom: 1rem;\n  background: var(--theme-card-bg);\n  color: var(--theme-ink);\n}\n.search-filters-form {\n  display: flex;\n  gap: 2rem;\n  flex-wrap: wrap;\n}\n.search-filter-col-year {\n  min-width: 100px;\n}\n.search-filter-col-wide {\n  min-width: 220px;\n}\n.search-filter-title {\n  font-weight: 600;\n}\n.search-results-grid {\n  display: grid;\n  grid-template-columns: minmax(0, 1fr);\n  gap: 1rem;\n  align-items: start;\n  width: 100%;\n}\n.search-results-main {\n  min-width: 0;\n  width: 100%;\n}\n.search-json-sidebar {\n  position: sticky;\n  top: 1rem;\n  align-self: start;\n}\n.search-json-toolbar {\n  display: flex;\n  gap: 0.35rem;\n  margin-bottom: 0.5rem;\n}\n.search-json-tab {\n  border: 1px solid var(--theme-line);\n  background: var(--theme-card-bg);\n  color: var(--theme-ink);\n  border-radius: 999px;\n  padding: 0.45rem 0.75rem;\n  font-size: 0.78rem;\n  cursor: pointer;\n}\n.search-json-tab.active {\n  background: var(--bs-primary);\n  border-color: var(--bs-primary);\n  color: #fff;\n}\n.search-json-card {\n  border: 1px solid var(--theme-line);\n  border-radius: 12px;\n  background: var(--theme-card-bg);\n  padding: 1rem;\n}\n.search-json-card-help {\n  color: var(--theme-muted);\n}\n.search-json-header {\n  margin-bottom: 0.75rem;\n}\n.search-json-title {\n  margin: 0;\n  font-size: 0.98rem;\n  color: var(--theme-title);\n}\n.search-json-subtitle {\n  margin: 0.2rem 0 0;\n  font-size: 0.8rem;\n  color: var(--theme-muted);\n}\n.search-json-pre {\n  margin: 0;\n  max-height: 60vh;\n  overflow: auto;\n  padding: 0.75rem;\n  border-radius: 10px;\n  background: color-mix(in srgb, var(--theme-card-bg) 70%, var(--theme-line));\n  color: var(--theme-ink);\n  font-size: 0.74rem;\n  line-height: 1.4;\n  white-space: pre-wrap;\n  word-break: break-word;\n}\n.search-json-empty {\n  margin: 0;\n  font-size: 0.85rem;\n  color: var(--theme-muted);\n}\n.idle-layout {\n  margin-top: 1rem;\n  display: grid;\n  grid-template-columns: repeat(3, minmax(0, 1fr));\n  gap: 1rem;\n}\n.idle-col {\n  border: 1px solid var(--theme-line);\n  border-radius: 12px;\n  background: var(--theme-card-bg);\n  padding: 1rem;\n  min-height: 100%;\n}\n.idle-title {\n  margin: 0 0 0.5rem;\n  font-size: 1rem;\n  color: var(--theme-title);\n}\n.idle-text {\n  margin: 0 0 0.75rem;\n  font-size: 0.9rem;\n  color: var(--theme-muted);\n}\n.idle-links {\n  display: grid;\n  gap: 0.5rem;\n}\n.idle-link {\n  color: var(--bs-link-color);\n  text-decoration: underline;\n  cursor: pointer;\n}\n.idle-col-events {\n  padding: 0;\n  border: none;\n  background: transparent;\n}\n.idle-col-news {\n  padding: 0;\n  border: none;\n  background: transparent;\n}\n.idle-col-stats {\n  padding: 0;\n  border: none;\n  background: transparent;\n}\n@media (max-width: 991.98px) {\n  .idle-layout {\n    grid-template-columns: 1fr;\n  }\n  .search-results-grid {\n    grid-template-columns: 1fr;\n  }\n  .search-json-sidebar {\n    position: static;\n  }\n}\n.selection-actions {\n  display: flex;\n  flex-wrap: wrap;\n  align-items: center;\n  gap: 0.75rem;\n  margin: 0.75rem 0 1rem;\n  padding: 0.875rem 1rem;\n  border: 1px solid var(--theme-line);\n  border-radius: 10px;\n  background: var(--theme-card-bg);\n  color: var(--theme-ink);\n}\n.selection-summary {\n  display: inline-flex;\n  align-items: center;\n  gap: 0.5rem;\n}\n.selection-all {\n  margin-inline-start: 0;\n}\n@media (max-width: 575.98px) {\n  .idle-col-news,\n  .idle-col-stats {\n    display: none;\n  }\n  .selection-all {\n    width: 100%;\n    margin-inline-start: 0;\n  }\n}\n.search-filters-toggle {\n  border: 0;\n  padding: 0;\n  background: transparent;\n  color: var(--bs-link-color);\n  cursor: pointer;\n}\n.search-filters-collapse {\n  height: 0;\n  overflow: hidden;\n  opacity: 0;\n}\n.search-filters-clip {\n  display: flow-root;\n}\n.search-filter-col-method,\n.search-filter-col-limit {\n  min-width: 130px;\n  margin: 0;\n  padding: 0;\n  border: 0;\n}\n.search-filter-col-method legend,\n.search-filter-col-limit legend {\n  float: none;\n  width: auto;\n  margin: 0;\n  font-size: inherit;\n}\n/*# sourceMappingURL=search-articles.component.css.map */\n"] }]
  }], () => [{ type: Router }], null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SearchArticlesComponent, { className: "SearchArticlesComponent", filePath: "src/app/components/search-articles/search-articles.component.ts", lineNumber: 30 });
})();
...
//# sourceMappingURL=chunk-QWGOQY5D.js.map
