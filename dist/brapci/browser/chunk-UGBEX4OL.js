...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(ToolsNormalizeCitesPage, [{
    type: Component,
    args: [{ selector: "app-tools-normalize-cites-page", imports: [CommonModule, FormsModule, BreadcrumbsComponent], template: `<section class="normalize-wrap py-4" aria-labelledby="normalize-title">
  <div class="container">
    <app-breadcrumbs
      [labels]="{ tools: 'Ferramentas', normalize_cites: 'Normaliza\xE7\xE3o de refer\xEAncias' }"
    ></app-breadcrumbs>

    <div class="normalize-card p-4 p-md-5">
      <p class="normalize-eyebrow mb-2">Ferramentas bibliogr\xE1ficas</p>
      <h1 id="normalize-title" class="h2 mb-2">Normaliza\xE7\xE3o de refer\xEAncias</h1>
      <p class="normalize-subtitle mb-4">
        Cole suas refer\xEAncias, mantenha os destaques necess\xE1rios e escolha a norma desejada.
      </p>

      <form (ngSubmit)="normalize()">
        <fieldset class="mb-4">
          <legend class="h6 mb-2">Norma bibliogr\xE1fica</legend>
          <div class="standard-options" aria-label="Escolha a norma bibliogr\xE1fica">
        ...
        <div class="mb-3">
          <label id="references-label" class="form-label fw-semibold">Refer\xEAncias</label>
          <div class="editor-shell">
            <div class="editor-toolbar" role="toolbar" aria-label="Formata\xE7\xE3o do texto">
              <button
                type="button"
            ...
            <div
              ...
              aria-multiline="true"
              data-placeholder="Digite ou cole uma ou mais refer\xEAncias aqui"
              [attr.contenteditable]="loading ? 'false' : 'true'"
              (input)="updateText($event)"
            ></div>
          </div>
          <div class="form-text">Selecione um trecho para aplicar negrito ou it\xE1lico.</div>
        </div>
      ...
      <section class="result mt-4" aria-live="polite" aria-labelledby="result-title">
        ...
        @if (error && result === null) {
            ...
            <div id="result-panel" role="tabpanel" aria-labelledby="result-tab">
              @if (resultHtml(); as html) {
                ...
                <p class="result-content mb-0 text-body-secondary">
                  A resposta n\xE3o cont\xE9m um resultado textual para exibi\xE7\xE3o.
                </p>
              }
            </div>
          } @else {
          ...
          <p class="text-body-secondary mb-0">As refer\xEAncias normalizadas ser\xE3o exibidas aqui.</p>
        }
      </section>
    </div>
  </div>
...
//# sourceMappingURL=chunk-UGBEX4OL.js.map
