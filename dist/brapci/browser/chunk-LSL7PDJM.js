...
\r
      <div class="row g-3">\r
        ...
        <div class="col-12 col-md-6">
          <a href="/tools/txt4network" class="d-block h-100 text-decoration-none text-reset">
            <article class="tool-item p-3 h-100">
              <h2 class="h5 mb-2">{{ 'tools.bibliometric.card3Title' | translate }}</h2>
              <p class="mb-0">{{ 'tools.bibliometric.card3Text' | translate }}</p>
            </article>
          </a>
        </div>
      </div>
...
//# sourceMappingURL=chunk-LSL7PDJM.js.map
