...
var PqActiveByYearComponent = class _PqActiveByYearComponent {
  ...
  modalityColor(label) {
    ...
    return `var(--pq-series-${index % 12 + 1})`;
  }
  showYearLabel(index) {
...
var _forTrack12 = ($index, $item) => $item.id_bb + $item.inicio;
...
function PqApplicationsComponent_For_40_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275domElementStart(1, "span", 26)(2, "span", 27)(3, "span", 28);
    \u0275\u0275text(4);
    \u0275\u0275domElementEnd();
    \u0275\u0275domElementStart(5, "span", 29);
    \u0275\u0275domElement(6, "span", 30)(7, "span", 31)(8, "span", 32);
    \u0275\u0275domElementEnd()()();
    \u0275\u0275domElementStart(9, "span", 33);
    \u0275\u0275text(10);
    \u0275\u0275domElementEnd()();
  }
  if (rf & 2) {
...
function PqApplicationsComponent_Conditional_51_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275domElementStart(0, "div", 14)(1, "strong");
    \u0275\u0275text(2);
    \u0275\u0275domElementEnd();
    \u0275\u0275domElementStart(3, "span");
    \u0275\u0275domElement(4, "i", 6);
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(current_r5.year);
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(current_r5.novas);
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(current_r5.reconcedidas);
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(current_r5.novas_apos_interrupcao);
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(current_r5.total);
  }
}
function PqApplicationsComponent_For_84_Conditional_18_For_20_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275domElementStart(0, "tr")(1, "td")(2, "a", 43)(3, "strong");
    \u0275\u0275text(4);
    \u0275\u0275domElementEnd()()();
    \u0275\u0275domElementStart(5, "td")(6, "span", 44);
    \u0275\u0275text(7);
    \u0275\u0275domElementEnd()();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275domProperty("href", "/v/" + record_r8.id_bb, \u0275\u0275sanitizeUrl);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(record_r8.nome);
    \u0275\u0275advance(2);
    \u0275\u0275classProp("renewed-badge", record_r8.tipo === "reconcedida")("returned-badge", record_r8.tipo === "nova_apos_interrupcao");
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(ctx_r3.typeLabel(record_r8.tipo));
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1("PQ ", record_r8.nivel);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(record_r8.ies);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate2("", \u0275\u0275pipeBind3(14, 12, record_r8.inicio, "MM/yyyy", "UTC"), " \u2014 ", \u0275\u0275pipeBind3(15, 16, record_r8.fim, "MM/yyyy", "UTC"));
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(record_r8.dias_interrupcao ? record_r8.dias_interrupcao + " dias" : "\u2014");
  }
}
function PqApplicationsComponent_For_84_Conditional_18_ForEmpty_21_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275domElementStart(0, "tr")(1, "td", 46);
    \u0275\u0275text(2, "Nenhum registro neste ano.");
    \u0275\u0275domElementEnd()();
  }
}
function PqApplicationsComponent_For_84_Conditional_18_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275domElementStart(0, "tr", 39)(1, "td", 40)(2, "div", 41)(3, "table", 42)(4, "thead")(5, "tr")(6, "th");
    \u0275\u0275text(7, "Bolsista");
    \u0275\u0275domElementEnd();
    ...
    \u0275\u0275repeaterCreate(19, PqApplicationsComponent_For_84_Conditional_18_For_20_Template, 18, 20, "tr", null, _forTrack12, false, PqApplicationsComponent_For_84_Conditional_18_ForEmpty_21_Template, 3, 0, "tr");
    \u0275\u0275domElementEnd()()()()();
  }
  if (rf & 2) {
    const item_r7 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275domProperty("id", "applications-" + item_r7.year);
    \u0275\u0275advance(19);
    \u0275\u0275repeater(item_r7.records);
  }
}
function PqApplicationsComponent_For_84_Template(rf, ctx) {
  if (rf & 1) {
    const _r6 = \u0275\u0275getCurrentView();
    \u0275\u0275domElementStart(0, "tr", 34)(1, "td")(2, "button", 35);
    \u0275\u0275domListener("click", function PqApplicationsComponent_For_84_Template_button_click_2_listener() {
      const item_r7 = \u0275\u0275restoreView(_r6).$implicit;
      const ctx_r3 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r3.toggleYear(item_r7.year));
    });
    \u0275\u0275domElement(3, "i", 36);
    \u0275\u0275domElementStart(4, "strong");
    \u0275\u0275text(5);
    \u0275\u0275domElementEnd()()();
    \u0275\u0275domElementStart(6, "td", 23);
    \u0275\u0275text(7);
    \u0275\u0275domElementEnd();
    \u0275\u0275domElementStart(8, "td", 23);
    \u0275\u0275text(9);
    \u0275\u0275domElementEnd();
    \u0275\u0275domElementStart(10, "td", 23);
    \u0275\u0275text(11);
    \u0275\u0275domElementEnd();
    \u0275\u0275domElementStart(12, "td", 23)(13, "strong");
    \u0275\u0275text(14);
    \u0275\u0275domElementEnd()();
    \u0275\u0275domElementStart(15, "td", 37)(16, "button", 38);
    \u0275\u0275domListener("click", function PqApplicationsComponent_For_84_Template_button_click_16_listener() {
      const item_r7 = \u0275\u0275restoreView(_r6).$implicit;
      const ctx_r3 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r3.toggleYear(item_r7.year));
    });
    \u0275\u0275text(17);
    \u0275\u0275domElementEnd()()();
    \u0275\u0275conditionalCreate(18, PqApplicationsComponent_For_84_Conditional_18_Template, 22, 2, "tr", 39);
  }
  if (rf & 2) {
    const item_r7 = ctx.$implicit;
    const ctx_r3 = \u0275\u0275nextContext();
    \u0275\u0275classProp("expanded", ctx_r3.isExpanded(item_r7.year));
    \u0275\u0275advance(2);
    \u0275\u0275attribute("aria-expanded", ctx_r3.isExpanded(item_r7.year))("aria-controls", "applications-" + item_r7.year);
    \u0275\u0275advance();
    \u0275\u0275classProp("bi-chevron-down", !ctx_r3.isExpanded(item_r7.year))("bi-chevron-up", ctx_r3.isExpanded(item_r7.year));
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(item_r7.year);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(item_r7.novas);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(item_r7.reconcedidas);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(item_r7.novas_apos_interrupcao);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(item_r7.total);
    \u0275\u0275advance(2);
    \u0275\u0275attribute("aria-label", (ctx_r3.isExpanded(item_r7.year) ? "Ocultar" : "Mostrar") + " concess\xF5es de " + item_r7.year);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(ctx_r3.isExpanded(item_r7.year) ? "Ocultar" : "Mostrar");
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r3.isExpanded(item_r7.year) ? 18 : -1);
  }
}
var PqApplicationsComponent = class _PqApplicationsComponent {
  ...
  exportCsv() {
    const header = ["Ano", "Pesquisador", "ID Brapci", "Tipo", "N\xEDvel", "Institui\xE7\xE3o", "In\xEDcio", "Fim", "Dias de interrup\xE7\xE3o"];
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _PqApplicationsComponent, selectors: [["app-pq-applications"]], inputs: { data: "data" }, features: [\u0275\u0275NgOnChangesFeature], decls: 85, vars: 8, consts: [["aria-labelledby", "applications-title"], [1, "applications-heading"], [1, "applications-eyebrow"], ["id", "applications-title"], ["aria-live", "polite", 1, "selected-total"], [1, "summary-cards"], [1, "dot", "new"], [1, "dot", "renewed"], [1, "dot", "returned"], [1, "chart-panel"], [1, "chart-scroll"], ["role", "group", "aria-label", "Concess\xF5es anuais por tipo", 1, "applications-chart"], ["type", "button", 1, "year-column", 3, "selected"], [1, "legend"], [1, "selected-detail"], ["aria-labelledby", "year-table-title", 1, "year-table-section"], [1, "table-heading"], ["id", "year-table-title"], [1, "table-actions"], ["type", "button", 1, "export-button", 3, "click"], ["aria-hidden", "true", 1, "bi", "bi-file-earmark-spreadsheet"], [1, "table-responsive", "year-table-wrap"], [1, "table", "year-table"], [1, "text-center"], [1, "visually-hidden"], ["type", "button", 1, "year-column", 3, "click"], [1, "bar-slot"], [1, "bar-group"], [1, "bar-value"], [1, "year-bar"], [1, "segment", "new"], [1, "segment", "renewed"], [1, "segment", "returned"], [1, "year-label"], [1, "year-summary"], ["type", "button", 1, "year-toggle", 3, "click"], ["aria-hidden", "true", 1, "bi"], [1, "text-end"], ["type", "button", 1, "details-button", 3, "click"], [1, "details-row", 3, "id"], ["colspan", "6"], [1, "record-table-wrap"], [1, "table", "table-sm", "record-table"], ["target", "_blank", "rel", "noopener noreferrer", 1, "researcher-link", 3, "href"], [1, "type-badge"], [1, "text-nowrap"], ["colspan", "6", 1, "empty-records"]], template: function PqApplicationsComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275domElementEnd()()();
      \u0275\u0275conditionalCreate(51, PqApplicationsComponent_Conditional_51_Template, 22, 5, "div", 14);
      \u0275\u0275domElementStart(52, "section", 15)(53, "div", 16)(54, "div")(55, "span", 2);
      \u0275\u0275text(56, "Dados detalhados");
      \u0275\u0275domElementEnd();
      \u0275\u0275domElementStart(57, "h2", 17);
      \u0275\u0275text(58, "Concess\xF5es por ano");
      \u0275\u0275domElementEnd()();
      \u0275\u0275domElementStart(59, "div", 18)(60, "span");
      \u0275\u0275text(61, "Clique no ano para visualizar os registros");
      \u0275\u0275domElementEnd();
      \u0275\u0275domElementStart(62, "button", 19);
      \u0275\u0275domListener("click", function PqApplicationsComponent_Template_button_click_62_listener() {
        return ctx.exportCsv();
      });
      \u0275\u0275domElement(63, "i", 20);
      \u0275\u0275text(64, " Exportar para CSV");
      \u0275\u0275domElementEnd()()();
      \u0275\u0275domElementStart(65, "div", 21)(66, "table", 22)(67, "thead")(68, "tr")(69, "th");
      \u0275\u0275text(70, "Ano");
      \u0275\u0275domElementEnd();
      \u0275\u0275domElementStart(71, "th", 23);
      \u0275\u0275text(72, "Novas");
      \u0275\u0275domElementEnd();
      \u0275\u0275domElementStart(73, "th", 23);
      \u0275\u0275text(74, "Reconcedidas");
      \u0275\u0275domElementEnd();
      \u0275\u0275domElementStart(75, "th", 23);
      \u0275\u0275text(76, "Ap\xF3s interrup\xE7\xE3o");
      \u0275\u0275domElementEnd();
      \u0275\u0275domElementStart(77, "th", 23);
      \u0275\u0275text(78, "Total");
      \u0275\u0275domElementEnd();
      \u0275\u0275domElementStart(79, "th")(80, "span", 24);
      \u0275\u0275text(81, "Expandir");
      \u0275\u0275domElementEnd()()()();
      \u0275\u0275domElementStart(82, "tbody");
      \u0275\u0275repeaterCreate(83, PqApplicationsComponent_For_84_Template, 19, 16, null, null, _forTrack02);
      \u0275\u0275domElementEnd()()()()();
    }
    if (rf & 2) {
      let tmp_0_0;
  ...
  <section class="year-table-section" aria-labelledby="year-table-title">
    ...
    <div class="table-responsive year-table-wrap">
      <table class="table year-table">
        <thead><tr><th>Ano</th><th class="text-center">Novas</th><th class="text-center">Reconcedidas</th><th class="text-center">Ap\xF3s interrup\xE7\xE3o</th><th class="text-center">Total</th><th><span class="visually-hidden">Expandir</span></th></tr></thead>
        <tbody>
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(PqApplicationsComponent, { className: "PqApplicationsComponent", filePath: "src/app/pages/pq/pq-applications.component.ts", lineNumber: 40 });
})();
...
function PqPage_Conditional_12_Conditional_27_For_39_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(14, PqPage_Conditional_12_Conditional_27_For_39_a_14_Template, 2, 1, "a", 54)(15, PqPage_Conditional_12_Conditional_27_For_39_a_15_Template, 2, 1, "a", 55);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
function PqPage_Conditional_12_Conditional_28_For_10_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const \u0275$index_315_r14 = ctx.$index;
    const ctx_r1 = \u0275\u0275nextContext(3);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(\u0275$index_315_r14 + 1);
    \u0275\u0275advance(4);
...
function PqPage_Conditional_12_Conditional_30_For_33_Conditional_0_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const \u0275$index_466_r21 = ctx_r18.$index;
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(\u0275$index_466_r21 + 1);
    \u0275\u0275advance(2);
...
//# sourceMappingURL=chunk-ZYUKWKL6.js.map
