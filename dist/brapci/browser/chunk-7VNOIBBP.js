...
var ChatSidebarComponent = class _ChatSidebarComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ChatSidebarComponent, selectors: [["app-chat-sidebar"]], inputs: { projects: [1, "projects"], chats: [1, "chats"], activeProjectId: [1, "activeProjectId"], activeChatId: [1, "activeChatId"], open: [1, "open"], collapsed: [1, "collapsed"] }, outputs: { newChat: "newChat", newProject: "newProject", selectProject: "selectProject", selectChat: "selectChat", deleteChat: "deleteChat", close: "close", collapse: "collapse", openDiagnostics: "openDiagnostics" }, decls: 37, vars: 6, consts: [["aria-label", "Conversas", 1, "sidebar"], [1, "brand"], [1, "bi", "bi-stars"], ["type", "button", "aria-label", "Recolher barra lateral", 3, "click"], [1, "bi", "bi-layout-sidebar"], ["type", "button", 1, "new-chat", 3, "click"], [1, "bi", "bi-plus-lg"], [1, "search"], [1, "bi", "bi-search"], [1, "visually-hidden"], ["type", "search", "placeholder", "Buscar", 3, "ngModelChange", "ngModel"], [1, "section-title"], ["type", "button", "aria-label", "Criar projeto", 3, "click"], [1, "bi", "bi-plus"], ["type", "button", 1, "item", 3, "active"], [1, "section-title", "recent"], [1, "chat-row", 2, "display", "flex", "align-items", "center", "flex-wrap", "nowrap", "border-radius", ".5rem", 3, "background"], ["href", "/", 1, "back"], [1, "bi", "bi-arrow-left"], ["type", "button", 1, "back", "diagnostics", 2, "border", "0", "background", "transparent", "width", "100%", 3, "click"], [1, "bi", "bi-activity"], ["type", "button", "aria-label", "Fechar menu", 1, "backdrop"], ["type", "button", 1, "item", 3, "click"], [1, "bi", "bi-folder"], [1, "chat-row", 2, "display", "flex", "align-items", "center", "flex-wrap", "nowrap", "border-radius", ".5rem"], ["type", "button", 1, "item", "chat-select", 2, "min-width", "0", "flex", "1 1 auto", 3, "click"], [1, "bi", "bi-chat-left-text"], ["type", "button", "title", "Excluir conversa", 1, "delete-chat", 2, "display", "inline-flex", "align-items", "center", "flex", "0 0 auto", "border", "0", "box-shadow", "none", "background", "transparent", "color", "#dc3545", "padding", ".25rem .4rem", 3, "click"], [1, "bi", "bi-trash-fill"], ["type", "button", "aria-label", "Fechar menu", 1, "backdrop", 3, "click"]], template: function ChatSidebarComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275text(25, "Recentes");
      \u0275\u0275elementEnd();
      \u0275\u0275repeaterCreate(26, ChatSidebarComponent_For_27_Template, 7, 4, "div", 16, _forTrack0);
      \u0275\u0275elementEnd();
      ...
      \u0275\u0275elementEnd()()();
      \u0275\u0275conditionalCreate(36, ChatSidebarComponent_Conditional_36_Template, 1, 0, "button", 21);
    }
    if (rf & 2) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(ChatSidebarComponent, [{
    ...
    <nav>
      ...
      @for(chat of filteredChats();track chat.id){<div class="chat-row" style="display:flex;align-items:center;flex-wrap:nowrap;border-radius:.5rem" [style.background]="chat.id===activeChatId() ? '#3b3755' : 'transparent'"><button class="item chat-select" style="min-width:0;flex:1 1 auto" type="button" (click)="selectChat.emit(chat)"><i class="bi bi-chat-left-text"></i><span>{{chat.title}}</span></button><button class="delete-chat" style="display:inline-flex;align-items:center;flex:0 0 auto;border:0;box-shadow:none;background:transparent;color:#dc3545;padding:.25rem .4rem" type="button" (click)="deleteChat.emit(chat)" [attr.aria-label]="'Excluir conversa ' + chat.title" title="Excluir conversa"><i class="bi bi-trash-fill"></i></button></div>}
    </nav>
...
function ChatPageComponent_Conditional_5_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275property("queryParams", \u0275\u0275pureFunction0(2, _c02));
  }
}
...
function ChatPageComponent_Conditional_7_Template(rf, ctx) {
  if (rf & 1) {
    const _r2 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 7)(1, "div", 16);
    \u0275\u0275element(2, "i", 17);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "h2");
    ...
    \u0275\u0275listener("click", function ChatPageComponent_Conditional_7_Template_button_click_8_listener() {
      \u0275\u0275restoreView(_r2);
      const ctx_r0 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r0.send("Resuma os principais conceitos de Ci\xEAncia da Informa\xE7\xE3o."));
    });
    \u0275\u0275text(9, "Explorar um tema");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(10, "button", 19);
    \u0275\u0275listener("click", function ChatPageComponent_Conditional_7_Template_button_click_10_listener() {
      \u0275\u0275restoreView(_r2);
      const ctx_r0 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r0.send("Ajude-me a estruturar uma estrat\xE9gia de busca bibliogr\xE1fica."));
    });
    \u0275\u0275text(11, "Criar estrat\xE9gia de busca");
    \u0275\u0275elementEnd()()();
  }
}
function ChatPageComponent_For_9_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "app-chat-message", 8);
  }
  if (rf & 2) {
...
function ChatPageComponent_Conditional_10_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = \u0275\u0275getCurrentView();
    ...
    \u0275\u0275listener("click", function ChatPageComponent_Conditional_10_Template_button_click_4_listener() {
      \u0275\u0275restoreView(_r4);
      const ctx_r0 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r0.error.set(null));
    });
    \u0275\u0275text(5, "Fechar");
    \u0275\u0275elementEnd()();
  }
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ChatPageComponent, selectors: [["app-chat-page"]], decls: 14, vars: 18, consts: [[1, "chat-layout"], [3, "close", "collapse", "newChat", "newProject", "selectProject", "selectChat", "deleteChat", "openDiagnostics", "projects", "chats", "activeProjectId", "activeChatId", "open", "collapsed"], [1, "chat-main"], [3, "menu", "modelChange", "chat", "project", "models", "model", "streaming"], ["aria-live", "polite", "aria-label", "Mensagens da conversa", 1, "messages"], ["role", "alert", 1, "auth-error"], [1, "center-state"], [1, "welcome"], [3, "message"], ["role", "alert", 1, "error"], [3, "send", "cancel", "streaming", "disabled"], [3, "close", "save", "open", "saving"], [3, "close", "open"], ["aria-hidden", "true", 1, "bi", "bi-shield-exclamation"], ["routerLink", "/signin", 1, "btn", "btn-primary", 3, "queryParams"], ["aria-hidden", "true", 1, "spinner-border"], [1, "welcome-icon"], [1, "bi", "bi-stars"], [1, "suggestions"], ["type", "button", 3, "click"], [1, "bi", "bi-exclamation-circle"]], template: function ChatPageComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275listener("close", function ChatPageComponent_Template_app_chat_sidebar_close_1_listener() {
        ...
        return ctx.diagnosticsOpen.set(true);
      });
      \u0275\u0275elementEnd();
      ...
      \u0275\u0275conditionalCreate(5, ChatPageComponent_Conditional_5_Template, 8, 3, "div", 5)(6, ChatPageComponent_Conditional_6_Template, 4, 0, "div", 6)(7, ChatPageComponent_Conditional_7_Template, 12, 0, "div", 7);
      \u0275\u0275repeaterCreate(8, ChatPageComponent_For_9_Template, 1, 1, "app-chat-message", 8, _forTrack04);
      \u0275\u0275conditionalCreate(10, ChatPageComponent_Conditional_10_Template, 6, 1, "div", 9);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(11, "app-chat-input", 10);
      \u0275\u0275listener("send", function ChatPageComponent_Template_app_chat_input_send_11_listener($event) {
        return ctx.send($event);
      })("cancel", function ChatPageComponent_Template_app_chat_input_cancel_11_listener() {
        return ctx.cancel();
      });
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(12, "app-project-dialog", 11);
      \u0275\u0275listener("close", function ChatPageComponent_Template_app_project_dialog_close_12_listener() {
        return ctx.projectDialogOpen.set(false);
      })("save", function ChatPageComponent_Template_app_project_dialog_save_12_listener($event) {
        return ctx.createProject($event);
      });
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(13, "app-diagnostics-panel", 12);
      \u0275\u0275listener("close", function ChatPageComponent_Template_app_diagnostics_panel_close_13_listener() {
        return ctx.diagnosticsOpen.set(false);
      });
      \u0275\u0275elementEnd();
    }
    if (rf & 2) {
      ...
      \u0275\u0275advance(2);
      \u0275\u0275conditional(ctx.authenticationError() ? 5 : ctx.state() === "loading" && !ctx.messages().length ? 6 : !ctx.visibleMessages().length ? 7 : -1);
      \u0275\u0275advance(3);
      \u0275\u0275repeater(ctx.visibleMessages());
      \u0275\u0275advance(2);
      \u0275\u0275conditional(ctx.error() && !ctx.authenticationError() ? 10 : -1);
      \u0275\u0275advance();
...
//# sourceMappingURL=chunk-7VNOIBBP.js.map
