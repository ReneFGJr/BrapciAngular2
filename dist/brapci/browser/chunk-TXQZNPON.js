import {
  BrapciApiService
} from "./chunk-4TKDLIRL.js";
import {
  BreadcrumbsComponent
} from "./chunk-NVI7LSCX.js";
import "./chunk-NIH3DZUO.js";
import "./chunk-6NCLE24J.js";
import {
  BarChartComponent
} from "./chunk-VZ4SFGJV.js";
import {
  TranslateModule
...
var _forTrack0 = ($index, $item) => $item.area;
var _forTrack1 = ($index, $item) => $item.title;
var _forTrack2 = ($index, $item) => $item.periodStart + "-" + $item.periodEnd + "-" + $item.evaluationArea + "-" + $item.stratum;
...
function RevistaAvaliationPage_Conditional_12_Conditional_6_For_9_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("value", area_r7);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(area_r7);
  }
}
...
function RevistaAvaliationPage_Conditional_12_Conditional_6_For_25_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const stratum_r9 = ctx.$implicit;
    \u0275\u0275property("value", stratum_r9);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(stratum_r9);
  }
}
function RevistaAvaliationPage_Conditional_12_Conditional_6_For_32_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "article", 24);
    \u0275\u0275element(1, "app-bar-chart", 28);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const chart_r10 = ctx.$implicit;
    \u0275\u0275advance();
    \u0275\u0275property("title", "Estratos por ano \u2014 " + chart_r10.area)("points", chart_r10.points);
  }
}
function RevistaAvaliationPage_Conditional_12_Conditional_6_Conditional_39_For_2_Conditional_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("href", "/v/" + group_r11.rdfId, \u0275\u0275sanitizeUrl);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(group_r11.title);
  }
}
function RevistaAvaliationPage_Conditional_12_Conditional_6_Conditional_39_For_2_Conditional_3_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const group_r11 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275textInterpolate1(" ", group_r11.title, " ");
  }
}
function RevistaAvaliationPage_Conditional_12_Conditional_6_Conditional_39_For_2_For_18_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(ctx_r1.periodLabel(item_r12));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(item_r12.stratum);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(item_r12.evaluationArea);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(item_r12.numericValue === null ? "\u2014" : \u0275\u0275pipeBind2(10, 4, item_r12.numericValue, "1.3-4"));
  }
}
function RevistaAvaliationPage_Conditional_12_Conditional_6_Conditional_39_For_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "section", 30)(1, "h3", 32);
    \u0275\u0275conditionalCreate(2, RevistaAvaliationPage_Conditional_12_Conditional_6_Conditional_39_For_2_Conditional_2_Template, 2, 2, "a", 33)(3, RevistaAvaliationPage_Conditional_12_Conditional_6_Conditional_39_For_2_Conditional_3_Template, 1, 1);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "div", 34)(5, "table", 35)(6, "thead")(7, "tr")(8, "th");
    ...
    \u0275\u0275repeaterCreate(17, RevistaAvaliationPage_Conditional_12_Conditional_6_Conditional_39_For_2_For_18_Template, 11, 7, "tr", null, _forTrack2);
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    const group_r11 = ctx.$implicit;
    \u0275\u0275advance(2);
    \u0275\u0275conditional(group_r11.rdfId ? 2 : 3);
    \u0275\u0275advance(15);
    \u0275\u0275repeater(group_r11.evaluations);
  }
}
...
function RevistaAvaliationPage_Conditional_12_Conditional_6_Conditional_39_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(1, RevistaAvaliationPage_Conditional_12_Conditional_6_Conditional_39_For_2_Template, 19, 1, "section", 30, _forTrack1);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(3, RevistaAvaliationPage_Conditional_12_Conditional_6_Conditional_39_Conditional_3_Template, 3, 0, "div", 31);
  }
  if (rf & 2) {
...
function RevistaAvaliationPage_Conditional_12_Conditional_6_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "section", 16)(1, "div", 18)(2, "label")(3, "span");
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275repeaterCreate(8, RevistaAvaliationPage_Conditional_12_Conditional_6_For_9_Template, 2, 2, "option", 21, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd()();
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275repeaterCreate(16, RevistaAvaliationPage_Conditional_12_Conditional_6_For_17_Template, 2, 2, "option", 21, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(18, "label")(19, "span");
    \u0275\u0275text(20, "Estrato");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(21, "select", 19);
    ...
    \u0275\u0275elementStart(22, "option", 20);
    \u0275\u0275text(23, "Todos os estratos");
    \u0275\u0275elementEnd();
    \u0275\u0275repeaterCreate(24, RevistaAvaliationPage_Conditional_12_Conditional_6_For_25_Template, 2, 2, "option", 21, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd()();
    ...
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(30, "section", 23);
    \u0275\u0275repeaterCreate(31, RevistaAvaliationPage_Conditional_12_Conditional_6_For_32_Template, 2, 2, "article", 24, _forTrack0);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(33, "article", 16)(34, "div", 25)(35, "h2", 26);
    \u0275\u0275text(36, "Peri\xF3dicos avaliados");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(37, "span");
    \u0275\u0275text(38);
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(39, RevistaAvaliationPage_Conditional_12_Conditional_6_Conditional_39_Template, 4, 1)(40, RevistaAvaliationPage_Conditional_12_Conditional_6_Conditional_40_Template, 2, 0, "p", 27);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
...
function RevistaAvaliationPage_Conditional_12_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(5, RevistaAvaliationPage_Conditional_12_Conditional_5_Template, 23, 5)(6, RevistaAvaliationPage_Conditional_12_Conditional_6_Template, 41, 8);
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance();
...
var RevistaAvaliationPage = class _RevistaAvaliationPage {
  ...
  loadAvaliations() {
    ...
    this.error.set("");
    this.api.get("brapci/avaliations").subscribe({
      next: (response) => {
        this.items.set(this.flatten(response?.data));
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(RevistaAvaliationPage, { className: "RevistaAvaliationPage", filePath: "src/app/pages/revista-avaliation/revista-avaliation.page.ts", lineNumber: 26 });
})();
export {
  RevistaAvaliationPage
};
//# sourceMappingURL=chunk-TXQZNPON.js.map
