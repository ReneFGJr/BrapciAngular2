...
\r
      <div class="row g-3">\r
        <div class="col-12 col-md-6">
          <a href="/tools_text/specialist" class="d-block h-100 text-decoration-none text-reset">
            <article class="tool-item p-3 h-100">
              <h2 class="h5 mb-2">{{ 'tools.text.card1Title' | translate }}</h2>
              <p class="mb-0">{{ 'tools.text.card1Text' | translate }}</p>
            </article>
          </a>
        </div>\r
...
//# sourceMappingURL=chunk-NOS5M5QH.js.map
