...
import {
  toSignal
} from "./chunk-YP4CUC5U.js";
import {
  API_CONFIG
} from "./chunk-UQTTNLOX.js";
import {
  FormsModule,
  NgControlStatus,
  NgModel,
...
import {
  BasketService
} from "./chunk-USCFRWX6.js";
import {
  TranslateLoader,
  TranslateModule,
  TranslatePipe,
  TranslateService
} from "./chunk-U6CLDCGY.js";
import {
...
var routes = [
  __spreadValues({
    path: "chat",
    loadChildren: () => import("./chunk-TF2VGZVY.js").then((m) => m.CHAT_ROUTES)
  }, false ? { \u0275entryName: "src/app/chat/chat.routes.ts" } : {}),
  __spreadValues({
    path: "autoridade",
    loadComponent: () => import("./chunk-VRUQNU2P.js").then((m) => m.AutoridadePage)
  }, false ? { \u0275entryName: "src/app/pages/autoridade/autoridade.page.ts" } : {}),
  __spreadValues({
    path: "v/:id",
    loadComponent: () => import("./chunk-35POF2UJ.js").then((m) => m.VIdPage)
...
function App_Conditional_38_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "li", 10)(1, "button", 11);
    \u0275\u0275listener("click", function App_Conditional_38_Template_button_click_1_listener() {
      \u0275\u0275restoreView(_r1);
    ...
    \u0275\u0275pipe(3, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "ul", 12)(5, "li")(6, "a", 49);
    \u0275\u0275listener("click", function App_Conditional_38_Template_a_click_6_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275pipe(8, "translate");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(9, "li")(10, "a", 50);
    \u0275\u0275listener("click", function App_Conditional_38_Template_a_click_10_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.closeToolsMenu());
    });
    ...
    \u0275\u0275pipe(12, "translate");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(13, "li")(14, "a", 51);
    \u0275\u0275listener("click", function App_Conditional_38_Template_a_click_14_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.closeToolsMenu());
    });
    ...
    \u0275\u0275pipe(16, "translate");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(17, "li")(18, "a", 52);
    \u0275\u0275listener("click", function App_Conditional_38_Template_a_click_18_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.closeToolsMenu());
    });
...
function App_Conditional_90_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "app-accessibility-panel", 53);
    \u0275\u0275listener("close", function App_Conditional_90_Template_app_accessibility_panel_close_0_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.closeAccessibilityPanel());
    })("fontScaleChange", function App_Conditional_90_Template_app_accessibility_panel_fontScaleChange_0_listener($event) {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.setAccessibilityFontScale($event));
    })("letterSpacingChange", function App_Conditional_90_Template_app_accessibility_panel_letterSpacingChange_0_listener($event) {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.setAccessibilityLetterSpacing($event));
    })("cursorLargeChange", function App_Conditional_90_Template_app_accessibility_panel_cursorLargeChange_0_listener($event) {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.setAccessibilityCursorLarge($event));
    })("highlightsChange", function App_Conditional_90_Template_app_accessibility_panel_highlightsChange_0_listener($event) {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.setAccessibilityHighlights($event));
    })("darkModeChange", function App_Conditional_90_Template_app_accessibility_panel_darkModeChange_0_listener($event) {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
...
function App_div_91_Template(rf, ctx) {
  if (rf & 1) {
...
function App_Conditional_97_For_4_Template(rf, ctx) {
  if (rf & 1) {
...
function App_Conditional_97_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "select", 59);
    \u0275\u0275pipe(1, "translate");
    \u0275\u0275pipe(2, "translate");
    \u0275\u0275listener("ngModelChange", function App_Conditional_97_Template_select_ngModelChange_0_listener($event) {
      \u0275\u0275restoreView(_r4);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.setLanguage($event));
    });
    \u0275\u0275repeaterCreate(3, App_Conditional_97_For_4_Template, 2, 2, "option", 60, _forTrack02);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function App_Conditional_98_Template(rf, ctx) {
  if (rf & 1) {
    const _r6 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "a", 61);
    \u0275\u0275pipe(1, "translate");
    \u0275\u0275listener("click", function App_Conditional_98_Template_a_click_0_listener() {
      \u0275\u0275restoreView(_r6);
      const ctx_r1 = \u0275\u0275nextContext();
...
function App_Conditional_99_Template(rf, ctx) {
  if (rf & 1) {
    const _r7 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "a", 63);
    \u0275\u0275pipe(1, "translate");
    \u0275\u0275listener("click", function App_Conditional_99_Template_a_click_0_listener() {
      \u0275\u0275restoreView(_r7);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.closeDocsMenu());
    });
...
function App_Conditional_107_Template(rf, ctx) {
  if (rf & 1) {
...
var App = class _App {
  ...
  isDocRoute = computed(() => {
    ...
    return url.startsWith("/doc") || url.startsWith("/sobre/") || url.startsWith("/about/") || url.startsWith("/autoridade") || url.startsWith("/eventos") || url.startsWith("/v/") || url.startsWith("/revistas") || url.startsWith("/signin") || url.startsWith("/perfil") || url.startsWith("/search-boolean") || url.startsWith("/tools_") || url.startsWith("/basket/") || url.startsWith("/chat");
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _App, selectors: [["app-root"]], decls: 120, vars: 106, consts: [["role", "navigation", "aria-label", "navegacao principal", 1, "navbar", "navbar-expand-lg", "navbar-dark", "bg-primary", "shadow-sm"], [1, "container"], ["href", "#", "aria-label", "Brapci", 1, "navbar-brand"], ["src", "assets/img/brand_brapci_shadown.png", "alt", "Brapci", 1, "navbar-logo"], ["type", "button", "data-bs-toggle", "collapse", "data-bs-target", "#mainNavbar", "aria-controls", "mainNavbar", "aria-expanded", "false", 1, "navbar-toggler", 3, "aria-label"], [1, "navbar-toggler-icon"], ["id", "mainNavbar", 1, "collapse", "navbar-collapse"], [1, "navbar-nav", "me-auto", "mb-2", "mb-lg-0"], [1, "nav-item"], ["routerLink", "/autoridade", 1, "nav-link", 3, "click"], [1, "nav-item", "dropdown", "docs-dropdown"], ["type", "button", 1, "nav-link", "dropdown-toggle", "btn", "btn-link", 3, "click"], [1, "dropdown-menu"], ["routerLink", "/revistas", 1, "dropdown-item", 3, "click"], ["routerLink", "/revistas/timeline", 1, "dropdown-item", 3, "click"], ["routerLink", "/eventos", 1, "nav-link", 3, "click"], ["routerLink", "/v/101894", 1, "nav-link", 3, "click"], ["routerLink", "/livros", 1, "nav-link", 3, "click"], [1, "nav-item", "dropdown", "docs-dropdown", 3, "show"], ["routerLink", "/about/brapci", 1, "dropdown-item", 3, "click"], ["routerLink", "/about/benancib", 1, "dropdown-item", 3, "click"], ["routerLink", "/about/brapcilivros", 1, "dropdown-item", 3, "click"], ["routerLink", "/about/how_index", 1, "dropdown-item", 3, "click"], ["routerLink", "/about/team", 1, "dropdown-item", 3, "click"], ["href", "#", 1, "dropdown-item", 3, "click"], ["routerLink", "/doc", 1, "dropdown-item", 3, "click"], [1, "d-flex", "align-items-center", "gap-2"], [1, "accessibility-launcher"], ["type", "button", 1, "accessibility-toggle", 3, "click"], ["aria-hidden", "true", 1, "bi", "bi-universal-access"], [3, "fontScale", "letterSpacing", "cursorLarge", "highlights", "darkMode"], ["class", "basket-indicator me-2", 4, "ngIf"], [1, "language-picker"], ["type", "button", 1, "language-flag-btn", 3, "click", "aria-label", "title"], ["width", "18", "height", "12", 1, "language-flag", 3, "src", "alt"], ["id", "languageSelect", 1, "form-select", "form-select-sm", "language-select", 3, "ngModel", "aria-label", "title"], ["routerLink", "/signin", 1, "nav-login-link", 3, "aria-label"], ["routerLink", "/perfil", 1, "nav-user-chip", 3, "aria-label"], [1, "footer", "mt-auto", "py-3", "border-top"], [1, "container", "d-flex", "flex-column", "flex-md-row", "justify-content-between", "align-items-center", "gap-2"], [1, "footer-meta", "text-center", "text-md-start"], [1, "text-muted"], [1, "text-muted", "footer-session"], [1, "footer-social", 3, "aria-label"], ["href", "https://www.linkedin.com/groups/9831304/", "target", "_blank", "rel", "noreferrer", "title", "LinkedIn", 1, "footer-social-link", 3, "aria-label"], ["viewBox", "0 0 24 24", "aria-hidden", "true", "focusable", "false"], ["d", "M4.98 3.5C4.98 4.88 3.86 6 2.48 6S0 4.88 0 3.5 1.12 1 2.5 1s2.48 1.12 2.48 2.5ZM.5 8h4V23h-4V8Zm7 0h3.83v2.05h.05c.53-1 1.83-2.05 3.77-2.05C19.2 8 24 10.66 24 16.13V23h-4v-6.04c0-3.6-2.15-4.67-3.33-4.67-1.82 0-3.17 1.23-3.17 4V23h-4V8Z"], ["href", "https://www.instagram.com/brapci/", "target", "_blank", "rel", "noreferrer", "title", "Instagram", 1, "footer-social-link", 3, "aria-label"], ["d", "M7.75 2h8.5A5.76 5.76 0 0 1 22 7.75v8.5A5.76 5.76 0 0 1 16.25 22h-8.5A5.76 5.76 0 0 1 2 16.25v-8.5A5.76 5.76 0 0 1 7.75 2Zm0 1.8A3.95 3.95 0 0 0 3.8 7.75v8.5a3.95 3.95 0 0 0 3.95 3.95h8.5a3.95 3.95 0 0 0 3.95-3.95v-8.5a3.95 3.95 0 0 0-3.95-3.95h-8.5Zm8.95 1.5a1.05 1.05 0 1 1-1.05 1.05 1.05 1.05 0 0 1 1.05-1.05ZM12 7a5 5 0 1 1-5 5 5 5 0 0 1 5-5Zm0 1.8A3.2 3.2 0 1 0 15.2 12 3.2 3.2 0 0 0 12 8.8Z"], ["routerLink", "/tools_bibliografics", 1, "dropdown-item", 3, "click"], ["routerLink", "/tools_bibliometric", 1, "dropdown-item", 3, "click"], ["routerLink", "/tools_text", 1, "dropdown-item", 3, "click"], ["routerLink", "/small_world", 1, "dropdown-item", 3, "click"], [3, "close", "fontScaleChange", "letterSpacingChange", "cursorLargeChange", "highlightsChange", "darkModeChange", "fontScale", "letterSpacing", "cursorLarge", "highlights", "darkMode"], [1, "basket-indicator", "me-2"], ["id", "basket", 1, "position-relative", 2, "cursor", "pointer", 3, "title", "routerLink"], ["xmlns", "http://www.w3.org/2000/svg", "width", "22", "height", "22", "fill", "currentColor", "viewBox", "0 0 24 24"], ["d", "M7 18c-1.104 0-2 .896-2 2s.896 2 2 2 2-.896 2-2-.896-2-2-2zm10 0c-1.104 0-2 .896-2 2s.896 2 2 2 2-.896 2-2-.896-2-2-2zm1.83-3.41A2.996 2.996 0 0 0 16 13H8.42l-.94-2H20a1 1 0 0 0 0-2H7.21l-.94-2H4V5h2.42l3.6 7.59-1.35 2.44A2.996 2.996 0 0 0 7 17h10a1 1 0 0 0 0-2h-1.17z"], [1, "position-absolute", "top-0", "start-100", "translate-middle", "badge", "rounded-pill", "bg-danger", 2, "font-size", "0.8em"], ["id", "languageSelect", 1, "form-select", "form-select-sm", "language-select", 3, "ngModelChange", "ngModel", "aria-label", "title"], [3, "ngValue"], ["routerLink", "/signin", 1, "nav-login-link", 3, "click", "aria-label"], ["d", "M12 12c2.76 0 5-2.24 5-5s-2.24-5-5-5-5 2.24-5 5 2.24 5 5 5Zm0 2c-3.34 0-10 1.68-10 5v3h20v-3c0-3.32-6.66-5-10-5Z"], ["routerLink", "/perfil", 1, "nav-user-chip", 3, "click", "aria-label"]], template: function App_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275pipe(25, "translate");
      \u0275\u0275elementEnd()()()();
      \u0275\u0275elementStart(26, "li", 8)(27, "a", 15);
      ...
      \u0275\u0275pipe(37, "translate");
      \u0275\u0275elementEnd()();
      \u0275\u0275conditionalCreate(38, App_Conditional_38_Template, 21, 20, "li", 18);
      \u0275\u0275elementStart(39, "li", 10)(40, "button", 11);
      \u0275\u0275listener("click", function App_Template_button_click_40_listener() {
        return ctx.toggleDocsMenu();
      });
      \u0275\u0275text(41);
      \u0275\u0275pipe(42, "translate");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(43, "ul", 12)(44, "li")(45, "a", 19);
      \u0275\u0275listener("click", function App_Template_a_click_45_listener() {
        return ctx.closeDocsMenu();
      });
      \u0275\u0275text(46);
      \u0275\u0275pipe(47, "translate");
      ...
      \u0275\u0275pipe(83, "translate");
      \u0275\u0275elementEnd()()()()();
      \u0275\u0275elementStart(84, "div", 26)(85, "div", 27)(86, "button", 28);
      \u0275\u0275pipe(87, "translate");
      \u0275\u0275pipe(88, "translate");
      \u0275\u0275listener("click", function App_Template_button_click_86_listener() {
        return ctx.toggleAccessibilityPanel();
      });
      \u0275\u0275element(89, "i", 29);
      \u0275\u0275elementEnd();
      \u0275\u0275conditionalCreate(90, App_Conditional_90_Template, 1, 5, "app-accessibility-panel", 30);
      \u0275\u0275elementEnd();
      \u0275\u0275template(91, App_div_91_Template, 7, 6, "div", 31);
      \u0275\u0275elementStart(92, "div", 32)(93, "button", 33);
      \u0275\u0275pipe(94, "translate");
      \u0275\u0275pipe(95, "translate");
      \u0275\u0275listener("click", function App_Template_button_click_93_listener() {
        return ctx.toggleLanguageMenu();
      });
      \u0275\u0275element(96, "img", 34);
      \u0275\u0275elementEnd();
      \u0275\u0275conditionalCreate(97, App_Conditional_97_Template, 5, 9, "select", 35);
      \u0275\u0275elementEnd();
      \u0275\u0275conditionalCreate(98, App_Conditional_98_Template, 7, 7, "a", 36)(99, App_Conditional_99_Template, 6, 5, "a", 37);
      \u0275\u0275elementEnd()()()();
      \u0275\u0275element(100, "router-outlet");
      \u0275\u0275elementStart(101, "footer", 38)(102, "div", 39)(103, "div", 40)(104, "small", 41);
      \u0275\u0275text(105);
      \u0275\u0275pipe(106, "translate");
      \u0275\u0275elementEnd();
      \u0275\u0275conditionalCreate(107, App_Conditional_107_Template, 3, 4, "small", 42);
      \u0275\u0275elementEnd();
      ...
      \u0275\u0275namespaceSVG();
      \u0275\u0275elementStart(112, "svg", 45);
      \u0275\u0275element(113, "path", 46);
      \u0275\u0275elementEnd()();
      \u0275\u0275namespaceHTML();
      \u0275\u0275elementStart(114, "a", 47);
      \u0275\u0275pipe(115, "translate");
      \u0275\u0275namespaceSVG();
      \u0275\u0275elementStart(116, "svg", 45);
      \u0275\u0275element(117, "path", 48);
      \u0275\u0275elementEnd()()();
      \u0275\u0275namespaceHTML();
      \u0275\u0275elementStart(118, "small", 41);
      \u0275\u0275text(119, "BRAPCI | brapci.inf.br");
      \u0275\u0275elementEnd()()();
    }
    if (rf & 2) {
      \u0275\u0275advance(4);
      \u0275\u0275ariaProperty("aria-label", \u0275\u0275interpolate(\u0275\u0275pipeBind1(5, 52, "common.toggleNavigation")));
      \u0275\u0275advance(7);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(12, 54, "menu.navbar.authorities"));
      \u0275\u0275advance(2);
      \u0275\u0275classProp("show", ctx.revistasMenuOpen());
      \u0275\u0275advance();
      \u0275\u0275attribute("aria-expanded", ctx.revistasMenuOpen());
      \u0275\u0275advance();
      \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(16, 56, "menu.navbar.magazines"), " ");
      \u0275\u0275advance(2);
      \u0275\u0275classProp("show", ctx.revistasMenuOpen());
      \u0275\u0275advance(3);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(21, 58, "journals.publicationsList"));
      \u0275\u0275advance(4);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(25, 60, "timeline.title"));
      \u0275\u0275advance(4);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(29, 62, "menu.navbar.events"));
      \u0275\u0275advance(4);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(33, 64, "menu.navbar.benancib"));
      \u0275\u0275advance(4);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(37, 66, "menu.navbar.books"));
      \u0275\u0275advance(2);
      \u0275\u0275conditional(ctx.currentUser() ? 38 : -1);
      \u0275\u0275advance();
      \u0275\u0275classProp("show", ctx.docsMenuOpen());
      \u0275\u0275advance();
      \u0275\u0275attribute("aria-expanded", ctx.docsMenuOpen());
      \u0275\u0275advance();
      \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(42, 68, "menu.navbar.about"), " ");
      \u0275\u0275advance(2);
      \u0275\u0275classProp("show", ctx.docsMenuOpen());
      \u0275\u0275advance(3);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(47, 70, "menu.navbar.aboutBrapci"));
      \u0275\u0275advance(4);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(51, 72, "menu.navbar.aboutBenancib"));
      \u0275\u0275advance(4);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(55, 74, "menu.navbar.aboutBrapciBooks"));
      \u0275\u0275advance(4);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(59, 76, "menu.navbar.howIndex"));
      \u0275\u0275advance(4);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(63, 78, "menu.navbar.team"));
      \u0275\u0275advance(4);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(67, 80, "menu.navbar.subjectIndex"));
      \u0275\u0275advance(4);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(71, 82, "menu.navbar.authorIndex"));
      \u0275\u0275advance(4);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(75, 84, "menu.navbar.productionIndicator"));
      \u0275\u0275advance(4);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(79, 86, "menu.navbar.searchIndicator"));
      \u0275\u0275advance(4);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(83, 88, "menu.navbar.apiDoc"));
      \u0275\u0275advance(4);
      \u0275\u0275attribute("aria-expanded", ctx.accessibilityPanelOpen())("aria-label", \u0275\u0275pipeBind1(87, 90, "accessibility.launcherAria"))("title", \u0275\u0275pipeBind1(88, 92, "accessibility.launcherTitle"));
      \u0275\u0275advance(4);
      \u0275\u0275conditional(ctx.accessibilityPanelOpen() ? 90 : -1);
      \u0275\u0275advance();
      \u0275\u0275property("ngIf", ctx.markedCount() > 0);
      \u0275\u0275advance(2);
      \u0275\u0275ariaProperty("aria-label", \u0275\u0275interpolate(\u0275\u0275pipeBind1(94, 94, "common.openLanguageSelection")));
      \u0275\u0275property("title", \u0275\u0275interpolate(\u0275\u0275pipeBind1(95, 96, "common.selectLanguage")));
      \u0275\u0275advance(3);
      \u0275\u0275property("src", ctx.selectedLanguageOption().flagSrc, \u0275\u0275sanitizeUrl)("alt", ctx.selectedLanguageOption().label);
      \u0275\u0275advance();
      \u0275\u0275conditional(ctx.languageMenuOpen() ? 97 : -1);
      \u0275\u0275advance();
      \u0275\u0275conditional(!ctx.currentUser() ? 98 : 99);
      \u0275\u0275advance(7);
      \u0275\u0275textInterpolate1("", \u0275\u0275pipeBind1(106, 98, "app.title"), " \xA9 2026");
      \u0275\u0275advance(2);
      \u0275\u0275conditional(ctx.currentUser() ? 107 : -1);
      \u0275\u0275advance();
      \u0275\u0275ariaProperty("aria-label", \u0275\u0275interpolate(\u0275\u0275pipeBind1(109, 100, "footer.socialMedia")));
      \u0275\u0275advance(2);
      \u0275\u0275ariaProperty("aria-label", \u0275\u0275interpolate(\u0275\u0275pipeBind1(111, 102, "footer.linkedIn")));
      \u0275\u0275advance(4);
      \u0275\u0275ariaProperty("aria-label", \u0275\u0275interpolate(\u0275\u0275pipeBind1(115, 104, "footer.instagram")));
    }
  }, dependencies: [
    CommonModule,
    NgIf,
