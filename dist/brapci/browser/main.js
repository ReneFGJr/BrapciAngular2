...
import {
  API_CONFIG
} from "./chunk-6NCLE24J.js";
import {
  BasketService
} from "./chunk-YVSLTLYB.js";
import {
  TranslateLoader,
  TranslateModule,
  TranslatePipe,
...
var routes = [
  __spreadValues({
    path: "chat",
    loadChildren: () => import("./chunk-7KNB4MOZ.js").then((m) => m.CHAT_ROUTES)
  }, false ? { \u0275entryName: "src/app/chat/chat.routes.ts" } : {}),
  __spreadValues({
    path: "autoridade",
    loadComponent: () => import("./chunk-QTWUUMIQ.js").then((m) => m.AutoridadePage)
  }, false ? { \u0275entryName: "src/app/pages/autoridade/autoridade.page.ts" } : {}),
  __spreadValues({
    path: "v/:id",
    loadComponent: () => import("./chunk-NBHQYF35.js").then((m) => m.VIdPage)
  ...
  __spreadValues({
    ...
    loadComponent: () => import("./chunk-URG47K6R.js").then((m) => m.BasketSelectedPage)
  }, false ? { \u0275entryName: "src/app/pages/basket-selected/basket-selected.page.ts" } : {}),
  __spreadValues({
    path: "painel",
    loadComponent: () => import("./chunk-RB6QVSGK.js").then((m) => m.PainelPage)
  }, false ? { \u0275entryName: "src/app/pages/painel/painel.page.ts" } : {}),
  __spreadValues({
    path: "about/:page",
    loadComponent: () => import("./chunk-4OVXEDVG.js").then((m) => m.SobreBrapciPage)
  }, false ? { \u0275entryName: "src/app/pages/sobre-brapci/sobre-brapci.page.ts" } : {}),
  __spreadValues({
    path: "doc",
    loadComponent: () => import("./chunk-TI6GSMNI.js").then((m) => m.DocPage)
...
function App_Conditional_42_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(3, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "ul", 12)(5, "li")(6, "a", 51);
...
function App_Conditional_98_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "app-accessibility-panel", 55);
    \u0275\u0275listener("close", function App_Conditional_98_Template_app_accessibility_panel_close_0_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.closeAccessibilityPanel());
    })("fontScaleChange", function App_Conditional_98_Template_app_accessibility_panel_fontScaleChange_0_listener($event) {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.setAccessibilityFontScale($event));
    })("letterSpacingChange", function App_Conditional_98_Template_app_accessibility_panel_letterSpacingChange_0_listener($event) {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.setAccessibilityLetterSpacing($event));
    })("cursorLargeChange", function App_Conditional_98_Template_app_accessibility_panel_cursorLargeChange_0_listener($event) {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.setAccessibilityCursorLarge($event));
    })("highlightsChange", function App_Conditional_98_Template_app_accessibility_panel_highlightsChange_0_listener($event) {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.setAccessibilityHighlights($event));
    })("darkModeChange", function App_Conditional_98_Template_app_accessibility_panel_darkModeChange_0_listener($event) {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
...
function App_div_99_Template(rf, ctx) {
  if (rf & 1) {
...
function App_Conditional_105_For_4_Template(rf, ctx) {
  if (rf & 1) {
...
function App_Conditional_105_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "select", 61);
    \u0275\u0275pipe(1, "translate");
    \u0275\u0275pipe(2, "translate");
    \u0275\u0275listener("ngModelChange", function App_Conditional_105_Template_select_ngModelChange_0_listener($event) {
      \u0275\u0275restoreView(_r4);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.setLanguage($event));
    });
    \u0275\u0275repeaterCreate(3, App_Conditional_105_For_4_Template, 2, 2, "option", 62, _forTrack02);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function App_Conditional_106_Template(rf, ctx) {
  if (rf & 1) {
    const _r6 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "a", 63);
    \u0275\u0275pipe(1, "translate");
    \u0275\u0275listener("click", function App_Conditional_106_Template_a_click_0_listener() {
      \u0275\u0275restoreView(_r6);
      const ctx_r1 = \u0275\u0275nextContext();
...
function App_Conditional_107_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(1, "translate");
    \u0275\u0275listener("click", function App_Conditional_107_Template_a_click_0_listener() {
      \u0275\u0275restoreView(_r7);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.closeDocsMenu());
    });
...
function App_Conditional_115_Template(rf, ctx) {
  if (rf & 1) {
...
var App = class _App {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _App, selectors: [["app-root"]], decls: 128, vars: 112, consts: [["role", "navigation", "aria-label", "navegacao principal", 1, "navbar", "navbar-expand-lg", "navbar-dark", "bg-primary", "shadow-sm"], [1, "container"], ["href", "#", "aria-label", "Brapci", 1, "navbar-brand"], ["src", "assets/img/brand_brapci_shadown.png", "alt", "Brapci", 1, "navbar-logo"], ["type", "button", "data-bs-toggle", "collapse", "data-bs-target", "#mainNavbar", "aria-controls", "mainNavbar", "aria-expanded", "false", 1, "navbar-toggler", 3, "aria-label"], [1, "navbar-toggler-icon"], ["id", "mainNavbar", 1, "collapse", "navbar-collapse"], [1, "navbar-nav", "me-auto", "mb-2", "mb-lg-0"], [1, "nav-item"], ["routerLink", "/autoridade", 1, "nav-link", 3, "click"], [1, "nav-item", "dropdown", "docs-dropdown"], ["type", "button", 1, "nav-link", "dropdown-toggle", "btn", "btn-link", 3, "click"], [1, "dropdown-menu"], ["routerLink", "/revistas", 1, "dropdown-item", 3, "click"], ["routerLink", "/revistas/avaliation", 1, "dropdown-item", 3, "click"], ["routerLink", "/revistas/timeline", 1, "dropdown-item", 3, "click"], ["routerLink", "/eventos", 1, "nav-link", 3, "click"], ["routerLink", "/v/101894", 1, "nav-link", 3, "click"], ["routerLink", "/livros", 1, "nav-link", 3, "click"], [1, "nav-item", "dropdown", "docs-dropdown", 3, "show"], ["routerLink", "/about/brapci", 1, "dropdown-item", 3, "click"], ["routerLink", "/about/benancib", 1, "dropdown-item", 3, "click"], ["routerLink", "/about/brapcilivros", 1, "dropdown-item", 3, "click"], ["routerLink", "/about/how_index", 1, "dropdown-item", 3, "click"], ["routerLink", "/pq", 1, "dropdown-item", 3, "click"], ["routerLink", "/about/team", 1, "dropdown-item", 3, "click"], ["href", "#", 1, "dropdown-item", 3, "click"], ["routerLink", "/doc", 1, "dropdown-item", 3, "click"], [1, "d-flex", "align-items-center", "gap-2"], [1, "accessibility-launcher"], ["type", "button", 1, "accessibility-toggle", 3, "click"], ["aria-hidden", "true", 1, "bi", "bi-universal-access"], [3, "fontScale", "letterSpacing", "cursorLarge", "highlights", "darkMode"], ["class", "basket-indicator me-2", 4, "ngIf"], [1, "language-picker"], ["type", "button", 1, "language-flag-btn", 3, "click", "aria-label", "title"], ["width", "18", "height", "12", 1, "language-flag", 3, "src", "alt"], ["id", "languageSelect", 1, "form-select", "form-select-sm", "language-select", 3, "ngModel", "aria-label", "title"], ["routerLink", "/signin", 1, "nav-login-link", 3, "aria-label"], ["routerLink", "/perfil", 1, "nav-user-chip", 3, "aria-label"], [1, "footer", "mt-auto", "py-3", "border-top"], [1, "container", "d-flex", "flex-column", "flex-md-row", "justify-content-between", "align-items-center", "gap-2"], [1, "footer-meta", "text-center", "text-md-start"], [1, "text-muted"], [1, "text-muted", "footer-session"], [1, "footer-social", 3, "aria-label"], ["href", "https://www.linkedin.com/groups/9831304/", "target", "_blank", "rel", "noreferrer", "title", "LinkedIn", 1, "footer-social-link", 3, "aria-label"], ["viewBox", "0 0 24 24", "aria-hidden", "true", "focusable", "false"], ["d", "M4.98 3.5C4.98 4.88 3.86 6 2.48 6S0 4.88 0 3.5 1.12 1 2.5 1s2.48 1.12 2.48 2.5ZM.5 8h4V23h-4V8Zm7 0h3.83v2.05h.05c.53-1 1.83-2.05 3.77-2.05C19.2 8 24 10.66 24 16.13V23h-4v-6.04c0-3.6-2.15-4.67-3.33-4.67-1.82 0-3.17 1.23-3.17 4V23h-4V8Z"], ["href", "https://www.instagram.com/brapci/", "target", "_blank", "rel", "noreferrer", "title", "Instagram", 1, "footer-social-link", 3, "aria-label"], ["d", "M7.75 2h8.5A5.76 5.76 0 0 1 22 7.75v8.5A5.76 5.76 0 0 1 16.25 22h-8.5A5.76 5.76 0 0 1 2 16.25v-8.5A5.76 5.76 0 0 1 7.75 2Zm0 1.8A3.95 3.95 0 0 0 3.8 7.75v8.5a3.95 3.95 0 0 0 3.95 3.95h8.5a3.95 3.95 0 0 0 3.95-3.95v-8.5a3.95 3.95 0 0 0-3.95-3.95h-8.5Zm8.95 1.5a1.05 1.05 0 1 1-1.05 1.05 1.05 1.05 0 0 1 1.05-1.05ZM12 7a5 5 0 1 1-5 5 5 5 0 0 1 5-5Zm0 1.8A3.2 3.2 0 1 0 15.2 12 3.2 3.2 0 0 0 12 8.8Z"], ["routerLink", "/tools_bibliografics", 1, "dropdown-item", 3, "click"], ["routerLink", "/tools_bibliometric", 1, "dropdown-item", 3, "click"], ["routerLink", "/tools_text", 1, "dropdown-item", 3, "click"], ["routerLink", "/small_world", 1, "dropdown-item", 3, "click"], [3, "close", "fontScaleChange", "letterSpacingChange", "cursorLargeChange", "highlightsChange", "darkModeChange", "fontScale", "letterSpacing", "cursorLarge", "highlights", "darkMode"], [1, "basket-indicator", "me-2"], ["id", "basket", 1, "position-relative", 2, "cursor", "pointer", 3, "title", "routerLink"], ["xmlns", "http://www.w3.org/2000/svg", "width", "22", "height", "22", "fill", "currentColor", "viewBox", "0 0 24 24"], ["d", "M7 18c-1.104 0-2 .896-2 2s.896 2 2 2 2-.896 2-2-.896-2-2-2zm10 0c-1.104 0-2 .896-2 2s.896 2 2 2 2-.896 2-2-.896-2-2-2zm1.83-3.41A2.996 2.996 0 0 0 16 13H8.42l-.94-2H20a1 1 0 0 0 0-2H7.21l-.94-2H4V5h2.42l3.6 7.59-1.35 2.44A2.996 2.996 0 0 0 7 17h10a1 1 0 0 0 0-2h-1.17z"], [1, "position-absolute", "top-0", "start-100", "translate-middle", "badge", "rounded-pill", "bg-danger", 2, "font-size", "0.8em"], ["id", "languageSelect", 1, "form-select", "form-select-sm", "language-select", 3, "ngModelChange", "ngModel", "aria-label", "title"], [3, "ngValue"], ["routerLink", "/signin", 1, "nav-login-link", 3, "click", "aria-label"], ["d", "M12 12c2.76 0 5-2.24 5-5s-2.24-5-5-5-5 2.24-5 5 2.24 5 5 5Zm0 2c-3.34 0-10 1.68-10 5v3h20v-3c0-3.32-6.66-5-10-5Z"], ["routerLink", "/perfil", 1, "nav-user-chip", 3, "click", "aria-label"]], template: function App_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275pipe(91, "translate");
      \u0275\u0275elementEnd()()()()();
      \u0275\u0275elementStart(92, "div", 28)(93, "div", 29)(94, "button", 30);
      \u0275\u0275pipe(95, "translate");
      \u0275\u0275pipe(96, "translate");
      \u0275\u0275listener("click", function App_Template_button_click_94_listener() {
        return ctx.toggleAccessibilityPanel();
      });
      \u0275\u0275element(97, "i", 31);
      \u0275\u0275elementEnd();
      \u0275\u0275conditionalCreate(98, App_Conditional_98_Template, 1, 5, "app-accessibility-panel", 32);
      \u0275\u0275elementEnd();
      \u0275\u0275template(99, App_div_99_Template, 7, 6, "div", 33);
      \u0275\u0275elementStart(100, "div", 34)(101, "button", 35);
      \u0275\u0275pipe(102, "translate");
      \u0275\u0275pipe(103, "translate");
      \u0275\u0275listener("click", function App_Template_button_click_101_listener() {
        return ctx.toggleLanguageMenu();
      });
      \u0275\u0275element(104, "img", 36);
      \u0275\u0275elementEnd();
      \u0275\u0275conditionalCreate(105, App_Conditional_105_Template, 5, 9, "select", 37);
      \u0275\u0275elementEnd();
      \u0275\u0275conditionalCreate(106, App_Conditional_106_Template, 7, 7, "a", 38)(107, App_Conditional_107_Template, 6, 5, "a", 39);
      \u0275\u0275elementEnd()()()();
      \u0275\u0275element(108, "router-outlet");
      \u0275\u0275elementStart(109, "footer", 40)(110, "div", 41)(111, "div", 42)(112, "small", 43);
      \u0275\u0275text(113);
      \u0275\u0275pipe(114, "translate");
      \u0275\u0275elementEnd();
      \u0275\u0275conditionalCreate(115, App_Conditional_115_Template, 3, 4, "small", 44);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(116, "div", 45);
      \u0275\u0275pipe(117, "translate");
      \u0275\u0275elementStart(118, "a", 46);
      \u0275\u0275pipe(119, "translate");
      \u0275\u0275namespaceSVG();
      \u0275\u0275elementStart(120, "svg", 47);
      \u0275\u0275element(121, "path", 48);
      \u0275\u0275elementEnd()();
      \u0275\u0275namespaceHTML();
      \u0275\u0275elementStart(122, "a", 49);
      \u0275\u0275pipe(123, "translate");
      \u0275\u0275namespaceSVG();
      \u0275\u0275elementStart(124, "svg", 47);
      \u0275\u0275element(125, "path", 50);
      \u0275\u0275elementEnd()()();
      \u0275\u0275namespaceHTML();
      \u0275\u0275elementStart(126, "small", 43);
      \u0275\u0275text(127, "BRAPCI | brapci.inf.br");
      \u0275\u0275elementEnd()()();
    }
    if (rf & 2) {
      \u0275\u0275advance(4);
      \u0275\u0275ariaProperty("aria-label", \u0275\u0275interpolate(\u0275\u0275pipeBind1(5, 54, "common.toggleNavigation")));
      \u0275\u0275advance(7);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(12, 56, "menu.navbar.authorities"));
      \u0275\u0275advance(2);
      \u0275\u0275classProp("show", ctx.revistasMenuOpen());
      \u0275\u0275advance();
      \u0275\u0275attribute("aria-expanded", ctx.revistasMenuOpen());
      \u0275\u0275advance();
      \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(16, 58, "menu.navbar.magazines"), " ");
      \u0275\u0275advance(2);
      \u0275\u0275classProp("show", ctx.revistasMenuOpen());
      \u0275\u0275advance(3);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(21, 60, "journals.publicationsList"));
      \u0275\u0275advance(4);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(25, 62, "avaliation.menuItem"));
      \u0275\u0275advance(4);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(29, 64, "timeline.title"));
      \u0275\u0275advance(4);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(33, 66, "menu.navbar.events"));
      \u0275\u0275advance(4);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(37, 68, "menu.navbar.benancib"));
      \u0275\u0275advance(4);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(41, 70, "menu.navbar.books"));
      \u0275\u0275advance(2);
      ...
      \u0275\u0275advance();
      \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(46, 72, "menu.navbar.about"), " ");
      \u0275\u0275advance(2);
      \u0275\u0275classProp("show", ctx.docsMenuOpen());
      \u0275\u0275advance(3);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(51, 74, "menu.navbar.aboutBrapci"));
      \u0275\u0275advance(4);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(55, 76, "menu.navbar.aboutBenancib"));
      \u0275\u0275advance(4);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(59, 78, "menu.navbar.aboutBrapciBooks"));
      \u0275\u0275advance(4);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(63, 80, "menu.navbar.howIndex"));
      \u0275\u0275advance(4);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(67, 82, "pq.menuItem"));
      \u0275\u0275advance(4);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(71, 84, "menu.navbar.team"));
      \u0275\u0275advance(4);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(75, 86, "menu.navbar.subjectIndex"));
      \u0275\u0275advance(4);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(79, 88, "menu.navbar.authorIndex"));
      \u0275\u0275advance(4);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(83, 90, "menu.navbar.productionIndicator"));
      \u0275\u0275advance(4);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(87, 92, "menu.navbar.searchIndicator"));
      \u0275\u0275advance(4);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(91, 94, "menu.navbar.apiDoc"));
      \u0275\u0275advance(4);
      \u0275\u0275attribute("aria-expanded", ctx.accessibilityPanelOpen())("aria-label", \u0275\u0275pipeBind1(95, 96, "accessibility.launcherAria"))("title", \u0275\u0275pipeBind1(96, 98, "accessibility.launcherTitle"));
      \u0275\u0275advance(4);
      \u0275\u0275conditional(ctx.accessibilityPanelOpen() ? 98 : -1);
      \u0275\u0275advance();
      \u0275\u0275property("ngIf", ctx.markedCount() > 0);
      \u0275\u0275advance(2);
      \u0275\u0275ariaProperty("aria-label", \u0275\u0275interpolate(\u0275\u0275pipeBind1(102, 100, "common.openLanguageSelection")));
      \u0275\u0275property("title", \u0275\u0275interpolate(\u0275\u0275pipeBind1(103, 102, "common.selectLanguage")));
      \u0275\u0275advance(3);
      \u0275\u0275property("src", ctx.selectedLanguageOption().flagSrc, \u0275\u0275sanitizeUrl)("alt", ctx.selectedLanguageOption().label);
      \u0275\u0275advance();
      \u0275\u0275conditional(ctx.languageMenuOpen() ? 105 : -1);
      \u0275\u0275advance();
      \u0275\u0275conditional(!ctx.currentUser() ? 106 : 107);
      \u0275\u0275advance(7);
      \u0275\u0275textInterpolate1("", \u0275\u0275pipeBind1(114, 104, "app.title"), " \xA9 2026");
      \u0275\u0275advance(2);
      \u0275\u0275conditional(ctx.currentUser() ? 115 : -1);
      \u0275\u0275advance();
      \u0275\u0275ariaProperty("aria-label", \u0275\u0275interpolate(\u0275\u0275pipeBind1(117, 106, "footer.socialMedia")));
      \u0275\u0275advance(2);
      \u0275\u0275ariaProperty("aria-label", \u0275\u0275interpolate(\u0275\u0275pipeBind1(119, 108, "footer.linkedIn")));
      \u0275\u0275advance(4);
      \u0275\u0275ariaProperty("aria-label", \u0275\u0275interpolate(\u0275\u0275pipeBind1(123, 110, "footer.instagram")));
    }
  }, dependencies: [
    CommonModule,
    NgIf,
