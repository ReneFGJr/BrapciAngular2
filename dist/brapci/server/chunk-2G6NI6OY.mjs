...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(ToolsTxt4netPage, [{
    type: Component,
    args: [{ selector: "app-tools-txt4net-page", imports: [CommonModule, FormsModule, BreadcrumbsComponent], template: `<section class="txt4net-wrap py-4" aria-labelledby="txt4net-title">
  <div class="container">
    <app-breadcrumbs
      [labels]="{ tools: 'Ferramentas', txt4net: 'Converter TXT para .NET (Autor)' }"
    ></app-breadcrumbs>

    <div class="txt4net-card p-4 p-md-5">
      <h1 id="txt4net-title" class="h2 mb-2">Converter TXT para .NET (Autor)</h1>
      <p class="txt4net-subtitle mb-4">
        Insira os nomes dos autores separados por ponto e v\xEDrgula (;), ou selecione um arquivo de texto.
      </p>
      ...
      <div class="row g-4 align-items-start">
        ...
        <div class="mb-3">
          <label for="authors-text" class="form-label fw-semibold">Nomes dos autores</label>
          <textarea
            id="authors-text"
            name="authors"
            class="form-control"
            ...
            [(ngModel)]="text"
            [disabled]="loading"
            placeholder="Exemplo: Maria da Silva; Jo\xE3o dos Santos; Ana Oliveira"
            required
          ></textarea>
          <div class="form-text">Separe cada nome de autor usando ponto e v\xEDrgula (;).</div>
        </div>

        <div class="mb-3">
          <label for="authors-file" class="form-label fw-semibold">Carregar arquivo TXT</label>
          <input
            id="authors-file"
            class="form-control"
            type="file"
          ...
          />
          @if (selectedFileName) {
            <div class="form-text">Arquivo carregado: {{ selectedFileName }}</div>
          }
        </div>
        ...
        <button type="submit" class="btn btn-primary" [disabled]="!text.trim() || loading">
          @if (loading) {
            ...
            Converter e baixar .NET
          }
        </button>
          </form>
        </div>

        <aside class="col-12 col-lg-5" aria-labelledby="instructions-video-title">
          <h2 id="instructions-video-title" class="h5 mb-3">V\xEDdeo com instru\xE7\xF5es</h2>
          <div class="ratio ratio-16x9 video-frame">
            <iframe
              src="https://www.youtube-nocookie.com/embed/qOUddBznpRU"
              title="Instru\xE7\xF5es para converter TXT para .NET"
              loading="lazy"
...
//# sourceMappingURL=chunk-2G6NI6OY.mjs.map
