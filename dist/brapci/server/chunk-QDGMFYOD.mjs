...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(ToolsTerm4netPage, [{
    type: Component,
    args: [{ selector: "app-tools-term4net-page", imports: [CommonModule, FormsModule, BreadcrumbsComponent], template: `<section class="term4net-wrap py-4" aria-labelledby="term4net-title">
  <div class="container">
    <app-breadcrumbs
      [labels]="{ tools: 'Ferramentas', term4net: 'Converter TXT para .NET (Assunto)' }"
    ></app-breadcrumbs>

    <div class="term4net-card p-4 p-md-5">
      <h1 id="term4net-title" class="h2 mb-2">Converter TXT para .NET (Assunto)</h1>
      <p class="term4net-subtitle mb-4">
        Insira os assuntos separados por ponto e v\xEDrgula (;), ou selecione um arquivo de texto.
      </p>

      <form (ngSubmit)="convert()">
        <div class="mb-3">
          <label for="terms-text" class="form-label fw-semibold">Assuntos</label>
          <textarea
            id="terms-text"
            name="terms"
            class="form-control"
            ...
            [(ngModel)]="text"
            [disabled]="loading"
            placeholder="Exemplo: Ci\xEAncia da informa\xE7\xE3o; Bibliometria; Gest\xE3o do conhecimento"
            required
          ></textarea>
          <div class="form-text">Separe cada assunto usando ponto e v\xEDrgula (;).</div>
        </div>

        <div class="mb-3">
          <label for="terms-file" class="form-label fw-semibold">Carregar arquivo TXT</label>
          <input
            id="terms-file"
            class="form-control"
            type="file"
...
//# sourceMappingURL=chunk-QDGMFYOD.mjs.map
