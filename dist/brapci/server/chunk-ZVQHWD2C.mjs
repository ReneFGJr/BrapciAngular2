...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(ToolsTextSpecialistPage, [{
    type: Component,
    args: [{ selector: "app-tools-text-specialist-page", imports: [CommonModule, FormsModule, BreadcrumbsComponent], template: `<section class="specialist-wrap py-4" aria-labelledby="specialist-title">
  <div class="container">
    <app-breadcrumbs
      [labels]="{ tools_text: 'Ferramentas textuais', specialist: 'Busca por especialista' }"
    ></app-breadcrumbs>

    <div class="specialist-card p-4 p-md-5">
      <h1 id="specialist-title" class="h2 mb-2">Busca por especialista</h1>
      <p class="specialist-subtitle mb-4">
        Informe o texto que deseja analisar para localizar especialistas relacionados ao conte\xFAdo.
      </p>

      <form (ngSubmit)="analyze()">
        <div class="mb-3">
          <label for="specialist-text" class="form-label fw-semibold">Texto para an\xE1lise</label>
          <textarea
            id="specialist-text"
            name="text"
            class="form-control"
...
//# sourceMappingURL=chunk-ZVQHWD2C.mjs.map
