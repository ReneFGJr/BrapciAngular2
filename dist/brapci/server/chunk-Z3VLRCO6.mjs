...
} from "./chunk-JDPY22H2.mjs";
import {
  BannerLivrosComponent
} from "./chunk-OLVSDB4Y.mjs";
import {
  AuthService
...
function FormFileInputComponent_Conditional_4_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275domElementStart(0, "p", 4);
    \u0275\u0275text(1, "Marque os tr\xEAs termos de indexa\xE7\xE3o para continuar.");
    \u0275\u0275domElementEnd();
  }
}
function FormFileInputComponent_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(0, FormFileInputComponent_Conditional_4_Conditional_0_Template, 2, 0, "p", 4);
    \u0275\u0275domElementStart(1, "button", 5);
    \u0275\u0275domListener("click", function FormFileInputComponent_Conditional_4_Template_button_click_1_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.sendFile());
    });
    \u0275\u0275text(2, " Continuar --> ");
    \u0275\u0275domElementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275conditional(!ctx_r1.canContinue ? 0 : -1);
    \u0275\u0275advance();
    \u0275\u0275domProperty("disabled", !ctx_r1.selectedFile || !ctx_r1.canContinue || ctx_r1.uploading);
  }
}
function FormFileInputComponent_Conditional_5_Template(rf, ctx) {
  if (rf & 1) {
...
var FormFileInputComponent = class _FormFileInputComponent {
  ...
  sendFile() {
    ...
    if (!file || !this.action || !this.canContinue || this.uploading)
      return;
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _FormFileInputComponent, selectors: [["app-form-file-input"]], inputs: { action: "action", message: "message", property: "property", deferUpload: "deferUpload", canContinue: "canContinue" }, outputs: { dataset: "dataset" }, decls: 6, vars: 4, consts: [[1, "upload-body"], ["for", "book-file", 1, "form-label"], ["id", "book-file", "type", "file", 1, "form-control", 3, "change", "disabled"], ["role", "status", 1, "small", "text-muted", "mt-2"], [1, "small", "text-muted", "mt-2"], ["type", "button", 1, "btn", "btn-primary", "mt-3", 3, "click", "disabled"]], template: function FormFileInputComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275domElementEnd();
      \u0275\u0275conditionalCreate(4, FormFileInputComponent_Conditional_4_Template, 3, 2);
      \u0275\u0275conditionalCreate(5, FormFileInputComponent_Conditional_5_Template, 2, 0, "div", 3);
      \u0275\u0275domElementEnd();
    }
    if (rf & 2) {
      \u0275\u0275advance(2);
      ...
      \u0275\u0275advance();
      \u0275\u0275conditional(ctx.deferUpload ? 4 : -1);
      \u0275\u0275advance();
      \u0275\u0275conditional(ctx.uploading ? 5 : -1);
    }
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(FormFileInputComponent, [{
    ...
    <div class="upload-body">
      ...
      @if (deferUpload) {
        @if (!canContinue) {
          <p class="small text-muted mt-2">Marque os tr\xEAs termos de indexa\xE7\xE3o para continuar.</p>
        }
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(FormFileInputComponent, { className: "FormFileInputComponent", filePath: "src/app/components/form-file-input/form-file-input.component.ts", lineNumber: 63 });
})();
...
function UploadFileComponent_Conditional_6_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275property("action", ctx_r1.action)("deferUpload", ctx_r1.requireTerms)("canContinue", ctx_r1.termsAccepted);
  }
}
...
function UploadFileComponent_Conditional_9_Conditional_7_Conditional_8_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 16);
    \u0275\u0275text(1, "Informe o nome completo do autor.");
    \u0275\u0275elementEnd();
  }
}
function UploadFileComponent_Conditional_9_Conditional_7_Conditional_12_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 16);
...
function UploadFileComponent_Conditional_9_Conditional_7_Conditional_13_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "label", 19);
    \u0275\u0275element(1, "input", 21);
    \u0275\u0275text(2, " Concordo com os termos ");
    \u0275\u0275elementEnd();
  }
}
function UploadFileComponent_Conditional_9_Conditional_7_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(8, UploadFileComponent_Conditional_9_Conditional_7_Conditional_8_Template, 2, 0, "div", 16);
    \u0275\u0275elementStart(9, "label", 17);
    \u0275\u0275text(10, "Informe seu e-mail");
    \u0275\u0275elementEnd();
    \u0275\u0275element(11, "input", 18);
    \u0275\u0275conditionalCreate(12, UploadFileComponent_Conditional_9_Conditional_7_Conditional_12_Template, 2, 0, "div", 16);
    \u0275\u0275conditionalCreate(13, UploadFileComponent_Conditional_9_Conditional_7_Conditional_13_Template, 3, 0, "label", 19);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(14, "button", 20);
    \u0275\u0275text(15, " Confirmar submiss\xE3o ");
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
    ...
    \u0275\u0275advance(5);
    \u0275\u0275conditional(ctx_r1.emailForm.controls.name.invalid && ctx_r1.emailForm.controls.name.touched ? 8 : -1);
    \u0275\u0275advance(4);
    \u0275\u0275conditional(ctx_r1.emailForm.controls.email.invalid && ctx_r1.emailForm.controls.email.touched ? 12 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(!ctx_r1.requireTerms ? 13 : -1);
    \u0275\u0275advance();
    \u0275\u0275property("disabled", ctx_r1.emailForm.invalid || !ctx_r1.termsAccepted);
  }
}
function UploadFileComponent_Conditional_9_Conditional_8_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275property("disabled", !ctx_r1.termsAccepted);
    \u0275\u0275advance();
...
function UploadFileComponent_Conditional_9_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(6);
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(7, UploadFileComponent_Conditional_9_Conditional_7_Template, 16, 5, "div", 10)(8, UploadFileComponent_Conditional_9_Conditional_8_Template, 2, 2, "button", 11);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function UploadFileComponent_Conditional_11_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(2, " Este arquivo j\xE1 possui uma submiss\xE3o na base de dados. Consulte o e-mail utilizado na submiss\xE3o original para confirmar a autoriza\xE7\xE3o. Verifique tamb\xE9m a pasta de spam. Em caso de d\xFAvida, contate brapcici@gmail.com. ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "button", 24);
    \u0275\u0275listener("click", function UploadFileComponent_Conditional_11_Template_button_click_3_listener() {
      \u0275\u0275restoreView(_r5);
      const ctx_r1 = \u0275\u0275nextContext();
...
function UploadFileComponent_Conditional_12_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(11, "p");
    \u0275\u0275text(12, "Verifique seu e-mail para confirmar a autoriza\xE7\xE3o de indexa\xE7\xE3o.");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(20, "div", 27)(21, "strong");
    ...
    \u0275\u0275listener("click", function UploadFileComponent_Conditional_12_Template_button_click_24_listener() {
      \u0275\u0275restoreView(_r6);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.restart());
    });
...
var UploadFileComponent = class _UploadFileComponent {
  ...
  updateDataset(newDataset) {
    ...
    if (status >= 400 || this.action === "bookSubmit" && !newDataset["fileO"]) {
      this.dataset = null;
      this.status = 0;
      this.errorMessage = "N\xE3o foi poss\xEDvel preparar o arquivo. Tente envi\xE1-lo novamente.";
      return;
    }
  ...
  submit(payload, endpoint) {
    if (!this.termsAccepted || this.status === 2)
      return;
    ...
    this.api.post(endpoint, body).subscribe({
      next: (response) => {
        ...
        if (code !== "200" && code !== "201") {
          this.status = 1;
          this.errorMessage = typeof result["message"] === "string" ? result["message"] : "N\xE3o foi poss\xEDvel confirmar a submiss\xE3o. Tente novamente.";
          return;
        }
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _UploadFileComponent, selectors: [["app-upload-file"]], inputs: { toolsName: "toolsName", toolsNameDescription: "toolsNameDescription", buttonName: "buttonName", endpoint: "endpoint", action: "action", emailSend: "emailSend", requireTerms: "requireTerms", termsAccepted: "termsAccepted" }, features: [\u0275\u0275NgOnChangesFeature], decls: 13, vars: 9, consts: [[1, "col-lg-6", "col-12"], ["aria-labelledby", "upload-title", 1, "livros-submit-card", "h-100"], ["id", "upload-title", 1, "mb-2"], ["message", "Anexe o arquivo do livro", 3, "action", "deferUpload", "canContinue"], ["role", "alert", 1, "alert", "alert-danger", "mt-3"], [1, "upload-head", "mt-3"], [1, "upload-process"], ["message", "Anexe o arquivo do livro", 3, "dataset", "action", "deferUpload", "canContinue"], [1, "field-hint"], [1, "big", 3, "title"], [1, "pt-3", "pb-2"], ["type", "button", 1, "btn", "btn-primary", "full", "mt-3", 3, "disabled"], [1, "mt-2", 3, "ngSubmit", "formGroup"], [1, "mb-3"], ["for", "name", 1, "form-label"], ["id", "name", "type", "text", "formControlName", "name", "required", "", "autocomplete", "name", 1, "form-control"], [1, "text-danger"], ["for", "email", 1, "form-label", "mt-3"], ["id", "email", "type", "email", "formControlName", "email", "required", "", "autocomplete", "email", 1, "form-control"], ["for", "agree", 1, "form-check-label", "mt-3"], ["type", "submit", 1, "btn", "btn-primary", "full", 3, "disabled"], ["id", "agree", "type", "checkbox", "formControlName", "agree", "required", "", 1, "form-check-input", "me-2"], ["type", "button", 1, "btn", "btn-primary", "full", "mt-3", 3, "click", "disabled"], ["role", "status", 1, "alert", "alert-info"], ["type", "button", 1, "btn", "btn-secondary", "full", "mt-2", 3, "click"], [3, "title"], [1, "alert", "alert-success", "mt-2"], [1, "alert", "alert-warning", "mt-2"]], template: function UploadFileComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275text(5);
      \u0275\u0275elementEnd();
      \u0275\u0275conditionalCreate(6, UploadFileComponent_Conditional_6_Template, 1, 3, "app-form-file-input", 3);
      ...
      \u0275\u0275conditionalCreate(11, UploadFileComponent_Conditional_11_Template, 5, 0, "div", 6);
      \u0275\u0275conditionalCreate(12, UploadFileComponent_Conditional_12_Template, 26, 4, "div", 6);
      \u0275\u0275elementEnd()();
    }
    if (rf & 2) {
      \u0275\u0275advance(3);
...
\r
    @if (status === 0) {\r
      <app-form-file-input\r
        [action]="action"\r
        [deferUpload]="requireTerms"\r
        [canContinue]="termsAccepted"\r
          ...
          <div class="pt-3 pb-2">\r
            ...
            <form class="mt-2" [formGroup]="emailForm" (ngSubmit)="onSubmitEmail()">\r
              <div class="mb-3">\r
                ...
                <input id="name" type="text" class="form-control" formControlName="name" required autocomplete="name" />\r
                @if (emailForm.controls.name.invalid && emailForm.controls.name.touched) {\r
                  <div class="text-danger">Informe o nome completo do autor.</div>\r
                }\r
\r
                <label for="email" class="form-label mt-3">Informe seu e-mail</label>\r
                <input id="email" type="email" class="form-control" formControlName="email" required autocomplete="email" />\r
...
\r
                ...
                <label for="agree" class="form-check-label mt-3">\r
                  <input id="agree" type="checkbox" class="form-check-input me-2" formControlName="agree" required />\r
                  Concordo com os termos\r
                </label>\r
                }\r
              </div>\r
              <button type="submit" class="btn btn-primary full" [disabled]="emailForm.invalid || !termsAccepted">\r
                Confirmar submiss\xE3o\r
              </button>\r
            </form>\r
          </div>\r
        } @else {\r
          <button type="button" class="btn btn-primary full mt-3" (click)="process()" [disabled]="!termsAccepted">\r
            {{ buttonName }}\r
          </button>\r
        }\r
      </div>\r
...
\r
    @if (status === 4) {\r
      <div class="upload-process">\r
        <div class="alert alert-info" role="status">\r
          Este arquivo j\xE1 possui uma submiss\xE3o na base de dados.\r
          Consulte o e-mail utilizado na submiss\xE3o original para confirmar a autoriza\xE7\xE3o.\r
          Verifique tamb\xE9m a pasta de spam. Em caso de d\xFAvida, contate brapcici@gmail.com.\r
        </div>\r
...
\r
    @if (status === 3 && dataset) {\r
      <div class="upload-process">\r
        ...
        <p>Verifique seu e-mail para confirmar a autoriza\xE7\xE3o de indexa\xE7\xE3o.</p>\r
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(UploadFileComponent, { className: "UploadFileComponent", filePath: "src/app/components/upload-file/upload-file.component.ts", lineNumber: 15 });
})();

// src/app/pages/livros-submit/livros-submit.page.ts
var LivrosSubmitPage = class _LivrosSubmitPage {
  acceptedTerms = signal([false, false, false], ...ngDevMode ? [{ debugName: "acceptedTerms" }] : []);
  setTerm(index, event) {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _LivrosSubmitPage, selectors: [["app-livros-submit-page"]], decls: 33, vars: 5, consts: [["aria-labelledby", "livros-submit-title", 1, "livros-submit-wrap", "py-4"], [1, "container", "livros-submit-shell"], [1, "row", "g-4"], [1, "col-lg-6", "col-12"], [1, "livros-submit-card", "h-100"], ["id", "livros-submit-title"], [1, "livros-submit-terms"], [1, "d-flex", "gap-2", "mb-3", "align-items-start"], ["type", "checkbox", "required", "", 1, "form-check-input", "flex-shrink-0", 3, "change", "checked"], [1, "livros-submit-list"], ["href", "mailto:brapcici@gmail.com"], [3, "requireTerms", "termsAccepted"]], template: function LivrosSubmitPage_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275element(0, "app-banner-livros");
      \u0275\u0275elementStart(1, "section", 0)(2, "div", 1);
      \u0275\u0275element(3, "app-breadcrumbs");
      \u0275\u0275elementStart(4, "div", 2)(5, "div", 3)(6, "article", 4)(7, "h2", 5);
      \u0275\u0275text(8, "Termo de Indexacao");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(9, "p");
      \u0275\u0275text(10, " Ao submeter seu livro para indexacao na Brapci Livros, voce, como autor ou representante autorizado, declara que: ");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(11, "div", 6)(12, "label", 7)(13, "input", 8);
      \u0275\u0275listener("change", function LivrosSubmitPage_Template_input_change_13_listener($event) {
        return ctx.setTerm(0, $event);
      });
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(14, "span");
      \u0275\u0275text(15, " Voce detem os direitos autorais ou esta devidamente autorizado a submeter o conteudo para indexacao. Certifica que o material enviado e original e nao infringe direitos de terceiros. ");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(16, "label", 7)(17, "input", 8);
      \u0275\u0275listener("change", function LivrosSubmitPage_Template_input_change_17_listener($event) {
        return ctx.setTerm(1, $event);
      });
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(18, "span");
      \u0275\u0275text(19, " O conteudo do livro esta relacionado a temas pertinentes as areas de Ciencia da Informacao, Biblioteconomia, Arquivologia, Museologia ou disciplinas correlatas, alinhando-se ao escopo da Brapci Livros. ");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(20, "label", 7)(21, "input", 8);
      \u0275\u0275listener("change", function LivrosSubmitPage_Template_input_change_21_listener($event) {
        return ctx.setTerm(2, $event);
      });
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(22, "span");
      \u0275\u0275text(23, " Autoriza a Brapci Livros a disponibilizar os metadados do livro para consulta publica em sua plataforma. Esta autorizacao nao implica a disponibilizacao do texto completo da obra, salvo indicacao explicita e consentimento do autor. ");
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(24, "h5");
      \u0275\u0275text(25, "Contato e Suporte");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(26, "ul", 9)(27, "li");
      \u0275\u0275text(28, " Em caso de duvidas ou solicitacoes relacionadas ao processo de indexacao, entre em contato com a equipe da Brapci Livros por meio do e-mail: ");
      \u0275\u0275elementStart(29, "a", 10);
      \u0275\u0275text(30, "brapcici@gmail.com");
      \u0275\u0275elementEnd();
      \u0275\u0275text(31, ". ");
      \u0275\u0275elementEnd()()()();
      \u0275\u0275element(32, "app-upload-file", 11);
      \u0275\u0275elementEnd()()();
    }
    if (rf & 2) {
      \u0275\u0275advance(13);
      \u0275\u0275property("checked", ctx.acceptedTerms()[0]);
      \u0275\u0275advance(4);
      \u0275\u0275property("checked", ctx.acceptedTerms()[1]);
      \u0275\u0275advance(4);
      \u0275\u0275property("checked", ctx.acceptedTerms()[2]);
      \u0275\u0275advance(11);
      \u0275\u0275property("requireTerms", true)("termsAccepted", ctx.allTermsAccepted());
    }
  }, dependencies: [BannerLivrosComponent, CommonModule, BreadcrumbsComponent, UploadFileComponent], styles: ["\n\n.livros-submit-wrap[_ngcontent-%COMP%] {\n  min-height: calc(100vh - 70px);\n  background:\n    radial-gradient(\n      circle at top left,\n      rgba(208, 223, 255, 0.84),\n      transparent 34%),\n    linear-gradient(\n      180deg,\n      #f6f1e8 0%,\n      #efe5d5 100%);\n}\n.livros-submit-shell[_ngcontent-%COMP%] {\n  display: grid;\n  gap: 1.2rem;\n}\n.livros-submit-card[_ngcontent-%COMP%] {\n  padding: 1.3rem;\n  border-radius: 18px;\n  background: rgba(255, 255, 255, 0.86);\n  border: 1px solid rgba(124, 86, 46, 0.12);\n  box-shadow: 0 16px 30px rgba(92, 63, 29, 0.08);\n}\n.livros-submit-card[_ngcontent-%COMP%]   h2[_ngcontent-%COMP%], \n.livros-submit-card[_ngcontent-%COMP%]   h3[_ngcontent-%COMP%], \n.livros-submit-card[_ngcontent-%COMP%]   h5[_ngcontent-%COMP%] {\n  color: #35210f;\n}\n.livros-submit-card[_ngcontent-%COMP%]   p[_ngcontent-%COMP%], \n.livros-submit-card[_ngcontent-%COMP%]   li[_ngcontent-%COMP%] {\n  color: #5a4634;\n  line-height: 1.55;\n}\n.livros-submit-list[_ngcontent-%COMP%] {\n  margin: 0 0 1rem;\n  padding-left: 1.2rem;\n}\n.livros-submit-list[_ngcontent-%COMP%]   li[_ngcontent-%COMP%]    + li[_ngcontent-%COMP%] {\n  margin-top: 0.55rem;\n}\nbody.theme-master.theme-dark[_nghost-%COMP%]   .livros-submit-wrap[_ngcontent-%COMP%], body.theme-master.theme-dark   [_nghost-%COMP%]   .livros-submit-wrap[_ngcontent-%COMP%] {\n  background:\n    radial-gradient(\n      circle at top left,\n      rgba(89, 117, 168, 0.18),\n      transparent 34%),\n    linear-gradient(\n      180deg,\n      #181512 0%,\n      #241e19 100%);\n}\nbody.theme-master.theme-dark[_nghost-%COMP%]   .livros-submit-card[_ngcontent-%COMP%], body.theme-master.theme-dark   [_nghost-%COMP%]   .livros-submit-card[_ngcontent-%COMP%] {\n  background: rgba(37, 31, 26, 0.9);\n  border-color: rgba(232, 213, 190, 0.1);\n  box-shadow: 0 18px 36px rgba(0, 0, 0, 0.24);\n}\nbody.theme-master.theme-dark[_nghost-%COMP%]   .livros-submit-card[_ngcontent-%COMP%]   h2[_ngcontent-%COMP%], body.theme-master.theme-dark   [_nghost-%COMP%]   .livros-submit-card[_ngcontent-%COMP%]   h2[_ngcontent-%COMP%], \nbody.theme-master.theme-dark[_nghost-%COMP%]   .livros-submit-card[_ngcontent-%COMP%]   h3[_ngcontent-%COMP%], body.theme-master.theme-dark   [_nghost-%COMP%]   .livros-submit-card[_ngcontent-%COMP%]   h3[_ngcontent-%COMP%], \nbody.theme-master.theme-dark[_nghost-%COMP%]   .livros-submit-card[_ngcontent-%COMP%]   h5[_ngcontent-%COMP%], body.theme-master.theme-dark   [_nghost-%COMP%]   .livros-submit-card[_ngcontent-%COMP%]   h5[_ngcontent-%COMP%] {\n  color: #f7ecdf;\n}\nbody.theme-master.theme-dark[_nghost-%COMP%]   .livros-submit-card[_ngcontent-%COMP%]   p[_ngcontent-%COMP%], body.theme-master.theme-dark   [_nghost-%COMP%]   .livros-submit-card[_ngcontent-%COMP%]   p[_ngcontent-%COMP%], \nbody.theme-master.theme-dark[_nghost-%COMP%]   .livros-submit-card[_ngcontent-%COMP%]   li[_ngcontent-%COMP%], body.theme-master.theme-dark   [_nghost-%COMP%]   .livros-submit-card[_ngcontent-%COMP%]   li[_ngcontent-%COMP%], \nbody.theme-master.theme-dark[_nghost-%COMP%]   .livros-submit-card[_ngcontent-%COMP%]   a[_ngcontent-%COMP%], body.theme-master.theme-dark   [_nghost-%COMP%]   .livros-submit-card[_ngcontent-%COMP%]   a[_ngcontent-%COMP%] {\n  color: #d6c4b2;\n}\n.livros-submit-terms[_ngcontent-%COMP%]   .form-check-input[_ngcontent-%COMP%] {\n  border: 2px solid #000;\n}\n.livros-submit-terms[_ngcontent-%COMP%]   .form-check-input[_ngcontent-%COMP%]:not(:checked) {\n  background-color: #fff;\n}\nbody.theme-master.theme-dark[_nghost-%COMP%]   .livros-submit-terms[_ngcontent-%COMP%]   .form-check-input[_ngcontent-%COMP%], body.theme-master.theme-dark   [_nghost-%COMP%]   .livros-submit-terms[_ngcontent-%COMP%]   .form-check-input[_ngcontent-%COMP%] {\n  outline: 1px solid #fff;\n}\n/*# sourceMappingURL=livros-submit.page.css.map */"] });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(LivrosSubmitPage, [{
    type: Component,
    args: [{ selector: "app-livros-submit-page", standalone: true, imports: [BannerLivrosComponent, CommonModule, BreadcrumbsComponent, UploadFileComponent], template: '<app-banner-livros></app-banner-livros>\r\n\r\n<section class="livros-submit-wrap py-4" aria-labelledby="livros-submit-title">\r\n  <div class="container livros-submit-shell">\r\n    <app-breadcrumbs></app-breadcrumbs>\r\n\r\n    <div class="row g-4">\r\n      <div class="col-lg-6 col-12">\r\n        <article class="livros-submit-card h-100">\r\n          <h2 id="livros-submit-title">Termo de Indexacao</h2>\r\n\r\n          <p>\r\n            Ao submeter seu livro para indexacao na Brapci Livros, voce, como autor ou\r\n            representante autorizado, declara que:\r\n          </p>\r\n\r\n          <div class="livros-submit-terms">\r\n            <label class="d-flex gap-2 mb-3 align-items-start">\r\n              <input type="checkbox" class="form-check-input flex-shrink-0" required [checked]="acceptedTerms()[0]" (change)="setTerm(0, $event)" />\r\n              <span>\r\n              Voce detem os direitos autorais ou esta devidamente autorizado a submeter o conteudo\r\n              para indexacao. Certifica que o material enviado e original e nao infringe direitos de\r\n              terceiros.\r\n            </span></label>\r\n            <label class="d-flex gap-2 mb-3 align-items-start">\r\n              <input type="checkbox" class="form-check-input flex-shrink-0" required [checked]="acceptedTerms()[1]" (change)="setTerm(1, $event)" />\r\n              <span>\r\n              O conteudo do livro esta relacionado a temas pertinentes as areas de Ciencia da\r\n              Informacao, Biblioteconomia, Arquivologia, Museologia ou disciplinas correlatas,\r\n              alinhando-se ao escopo da Brapci Livros.\r\n            </span></label>\r\n            <label class="d-flex gap-2 mb-3 align-items-start">\r\n              <input type="checkbox" class="form-check-input flex-shrink-0" required [checked]="acceptedTerms()[2]" (change)="setTerm(2, $event)" />\r\n              <span>\r\n              Autoriza a Brapci Livros a disponibilizar os metadados do livro para consulta publica em\r\n              sua plataforma. Esta autorizacao nao implica a disponibilizacao do texto completo da\r\n              obra, salvo indicacao explicita e consentimento do autor.\r\n            </span></label>\r\n          </div>\r\n\r\n          <h5>Contato e Suporte</h5>\r\n          <ul class="livros-submit-list">\r\n            <li>\r\n              Em caso de duvidas ou solicitacoes relacionadas ao processo de indexacao, entre em\r\n              contato com a equipe da Brapci Livros por meio do e-mail:\r\n              <a href="mailto:brapcici@gmail.com">brapcici@gmail.com</a>.\r\n            </li>\r\n          </ul>\r\n        </article>\r\n      </div>\r\n\r\n      <app-upload-file [requireTerms]="true" [termsAccepted]="allTermsAccepted()" />\r\n    </div>\r\n  </div>\r\n</section>\r\n', styles: ["/* src/app/pages/livros-submit/livros-submit.page.scss */\n.livros-submit-wrap {\n  min-height: calc(100vh - 70px);\n  background:\n    radial-gradient(\n      circle at top left,\n      rgba(208, 223, 255, 0.84),\n      transparent 34%),\n    linear-gradient(\n      180deg,\n      #f6f1e8 0%,\n      #efe5d5 100%);\n}\n.livros-submit-shell {\n  display: grid;\n  gap: 1.2rem;\n}\n.livros-submit-card {\n  padding: 1.3rem;\n  border-radius: 18px;\n  background: rgba(255, 255, 255, 0.86);\n  border: 1px solid rgba(124, 86, 46, 0.12);\n  box-shadow: 0 16px 30px rgba(92, 63, 29, 0.08);\n}\n.livros-submit-card h2,\n.livros-submit-card h3,\n.livros-submit-card h5 {\n  color: #35210f;\n}\n.livros-submit-card p,\n.livros-submit-card li {\n  color: #5a4634;\n  line-height: 1.55;\n}\n.livros-submit-list {\n  margin: 0 0 1rem;\n  padding-left: 1.2rem;\n}\n.livros-submit-list li + li {\n  margin-top: 0.55rem;\n}\n:host-context(body.theme-master.theme-dark) .livros-submit-wrap {\n  background:\n    radial-gradient(\n      circle at top left,\n      rgba(89, 117, 168, 0.18),\n      transparent 34%),\n    linear-gradient(\n      180deg,\n      #181512 0%,\n      #241e19 100%);\n}\n:host-context(body.theme-master.theme-dark) .livros-submit-card {\n  background: rgba(37, 31, 26, 0.9);\n  border-color: rgba(232, 213, 190, 0.1);\n  box-shadow: 0 18px 36px rgba(0, 0, 0, 0.24);\n}\n:host-context(body.theme-master.theme-dark) .livros-submit-card h2,\n:host-context(body.theme-master.theme-dark) .livros-submit-card h3,\n:host-context(body.theme-master.theme-dark) .livros-submit-card h5 {\n  color: #f7ecdf;\n}\n:host-context(body.theme-master.theme-dark) .livros-submit-card p,\n:host-context(body.theme-master.theme-dark) .livros-submit-card li,\n:host-context(body.theme-master.theme-dark) .livros-submit-card a {\n  color: #d6c4b2;\n}\n.livros-submit-terms .form-check-input {\n  border: 2px solid #000;\n}\n.livros-submit-terms .form-check-input:not(:checked) {\n  background-color: #fff;\n}\n:host-context(body.theme-master.theme-dark) .livros-submit-terms .form-check-input {\n  outline: 1px solid #fff;\n}\n/*# sourceMappingURL=livros-submit.page.css.map */\n"] }]
  }], null, null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(LivrosSubmitPage, { className: "LivrosSubmitPage", filePath: "src/app/pages/livros-submit/livros-submit.page.ts", lineNumber: 14 });
})();
export {
  LivrosSubmitPage
};
//# sourceMappingURL=chunk-Z3VLRCO6.mjs.map
