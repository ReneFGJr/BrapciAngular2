...
.book-panel__backdrop[_ngcontent-ng-c2684776839] {
  position: fixed;
  inset: 0;
  z-index: 1040;
...
.book-panel__backdrop--visible[_ngcontent-ng-c2684776839] {
  opacity: 1;
  pointer-events: all;
}
.book-panel__drawer[_ngcontent-ng-c2684776839] {
  position: fixed;
  top: 0;
  right: 0;
  z-index: 1050;
...
.book-panel__drawer--open[_ngcontent-ng-c2684776839] {
  transform: translateX(0);
}
.book-panel__drawer--embedded[_ngcontent-ng-c2684776839] {
  position: static;
  width: 100%;
  height: auto;
  transform: none;
...
.book-panel__close[_ngcontent-ng-c2684776839] {
  position: absolute;
  top: 1rem;
  left: -2.8rem;
  width: 2.4rem;
...
.book-panel__close[_ngcontent-ng-c2684776839]:hover {
  background: color-mix(in srgb, var(--theme-sand) 75%, transparent);
  transform: scale(1.1);
}
.book-panel__content[_ngcontent-ng-c2684776839] {
  flex: 1 1 auto;
  overflow-y: auto;
  padding: 2rem 2rem 3rem;
}
.book-panel__drawer--embedded[_ngcontent-ng-c2684776839]   .book-panel__content[_ngcontent-ng-c2684776839] {
  overflow: visible;
  padding: 0;
}
.book-panel__details[_ngcontent-ng-c2684776839] {
  margin-top: 2rem;
...
.book-panel__meta-grid[_ngcontent-ng-c2684776839] {
  display: grid;
  grid-template-columns: repeat(auto-fit, minmax(180px, 1fr));
  gap: 0.75rem;
}
.book-panel__meta-card[_ngcontent-ng-c2684776839] {
  border: 1px solid var(--theme-line);
  border-radius: 12px;
  background: var(--theme-card-bg);
  padding: 0.85rem 0.95rem;
}
.book-panel__meta-card[_ngcontent-ng-c2684776839]   h3[_ngcontent-ng-c2684776839] {
  margin: 0;
  font-size: 0.68rem;
...
.book-panel__meta-card[_ngcontent-ng-c2684776839]   p[_ngcontent-ng-c2684776839] {
  margin: 0.32rem 0 0;
  color: var(--theme-ink);
  line-height: 1.45;
  font-weight: 600;
}
.book-panel__meta-card--publisher[_ngcontent-ng-c2684776839] {
  justify-self: start;
  width: min(100%, 430px);
}
.book-panel__stats[_ngcontent-ng-c2684776839] {
  display: flex;
  flex-wrap: wrap;
  gap: 0.6rem;
}
.book-panel__stats[_ngcontent-ng-c2684776839]   span[_ngcontent-ng-c2684776839] {
  display: inline-flex;
  gap: 0.35rem;
...
.book-panel__pdf-link[_ngcontent-ng-c2684776839] {
...
.book-panel__pdf-link[_ngcontent-ng-c2684776839]:hover {
  transform: translateY(-1px);
  filter: brightness(1.04);
}
.book-panel__section-block[_ngcontent-ng-c2684776839]   h3[_ngcontent-ng-c2684776839] {
  margin: 0 0 0.45rem;
  color: var(--theme-ink);
  font-size: 1rem;
}
.book-panel__section-block[_ngcontent-ng-c2684776839]   p[_ngcontent-ng-c2684776839] {
  margin: 0;
  color: var(--theme-ink);
  line-height: 1.68;
}
.book-panel__person-list[_ngcontent-ng-c2684776839] {
  margin: 0;
  padding-left: 1.1rem;
}
.book-panel__person-list[_ngcontent-ng-c2684776839]   li[_ngcontent-ng-c2684776839] {
  color: var(--theme-ink);
  line-height: 1.55;
}
.book-panel__person-name[_ngcontent-ng-c2684776839] {
  font-weight: 600;
}
.book-panel__person-complement[_ngcontent-ng-c2684776839] {
  margin-left: 0.35rem;
  color: var(--theme-muted);
}
.book-panel__chips[_ngcontent-ng-c2684776839] {
  display: flex;
  flex-wrap: wrap;
  gap: 0.45rem;
}
.book-panel__chip[_ngcontent-ng-c2684776839] {
...
.book-panel__chapter-list[_ngcontent-ng-c2684776839] {
  margin: 0.85rem 0 0;
  padding: 0;
  list-style: none;
  display: grid;
...
.book-panel__chapter-item[_ngcontent-ng-c2684776839] {
  display: grid;
...
.book-panel__chapter-item[_ngcontent-ng-c2684776839]   h4[_ngcontent-ng-c2684776839] {
  grid-column: 2;
  grid-row: 1;
  margin: 0;
  color: var(--theme-ink);
...
.book-panel__chapter-item[_ngcontent-ng-c2684776839]   .book-panel__chapter-pages[_ngcontent-ng-c2684776839] {
  grid-column: 3;
  grid-row: 1/span 2;
  justify-self: end;
  margin: 0;
...
.book-panel__chapter-item[_ngcontent-ng-c2684776839]   .book-panel__chapter-authors[_ngcontent-ng-c2684776839] {
  grid-column: 2;
  margin: 0;
  color: var(--theme-muted);
  font-size: 0.88rem;
...
.book-panel__chapter-number[_ngcontent-ng-c2684776839] {
  grid-column: 1;
  grid-row: 1/span 2;
  display: grid;
  place-items: center;
...
.book-panel__chapter-link[_ngcontent-ng-c2684776839] {
  color: var(--theme-link);
  text-decoration: none;
}
.book-panel__chapter-link[_ngcontent-ng-c2684776839]:hover, 
.book-panel__chapter-link[_ngcontent-ng-c2684776839]:focus-visible {
  text-decoration: underline;
}
