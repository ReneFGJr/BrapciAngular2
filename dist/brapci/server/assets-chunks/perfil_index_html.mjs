...
.perfil-wrap[_ngcontent-ng-c2301928083] {
  color: var(--theme-ink);
}
.perfil-card[_ngcontent-ng-c2301928083] {
  background: var(--theme-card-bg);
  border: 1px solid var(--theme-line);
  border-radius: 1rem;
}
.perfil-empty-state[_ngcontent-ng-c2301928083] {
  background: var(--theme-sand);
  border: 1px solid var(--theme-line);
  border-radius: 0.85rem;
  padding: 1rem;
}
.perfil-header[_ngcontent-ng-c2301928083] {
  align-items: center;
  display: flex;
  gap: 0.9rem;
}
.perfil-tabs[_ngcontent-ng-c2301928083] {
  display: flex;
  gap: 0.5rem;
  border-bottom: 1px solid var(--theme-line);
}
.perfil-tabs[_ngcontent-ng-c2301928083]   button[_ngcontent-ng-c2301928083] {
  display: inline-flex;
  margin-bottom: -1px;
  padding: 0.7rem 1rem;
  align-items: center;
...
.perfil-tabs[_ngcontent-ng-c2301928083]   button[_ngcontent-ng-c2301928083]:hover {
  color: var(--theme-link);
}
.perfil-tabs[_ngcontent-ng-c2301928083]   button.active[_ngcontent-ng-c2301928083] {
  border-bottom-color: var(--theme-link);
  color: var(--theme-link);
}
.perfil-avatar[_ngcontent-ng-c2301928083] {
  align-items: center;
  background: #483d8b;
  border-radius: 999px;
  color: #fff;
...
.perfil-overline[_ngcontent-ng-c2301928083] {
  color: var(--theme-hint);
  font-size: 0.8rem;
  letter-spacing: 0.05rem;
  text-transform: uppercase;
}
.perfil-name[_ngcontent-ng-c2301928083] {
  font-size: 1.3rem;
  font-weight: 700;
}
.perfil-section[_ngcontent-ng-c2301928083] {
  background: rgba(255, 255, 255, 0.45);
  border: 1px solid var(--theme-line);
  border-radius: 0.85rem;
  padding: 1rem;
}
.perfil-grid[_ngcontent-ng-c2301928083] {
  display: grid;
  gap: 1rem;
  grid-template-columns: repeat(auto-fit, minmax(180px, 1fr));
}
.perfil-item[_ngcontent-ng-c2301928083] {
  background: var(--theme-card-bg);
  border: 1px solid var(--theme-line);
  border-radius: 0.7rem;
  padding: 0.7rem 0.8rem;
}
.perfil-grid[_ngcontent-ng-c2301928083]   dt[_ngcontent-ng-c2301928083] {
  color: var(--theme-hint);
  font-size: 0.85rem;
  margin-bottom: 0.25rem;
  text-transform: uppercase;
}
.perfil-grid[_ngcontent-ng-c2301928083]   dd[_ngcontent-ng-c2301928083] {
  font-size: 1rem;
  margin: 0;
}
.perfil-actions[_ngcontent-ng-c2301928083] {
  display: flex;
  flex-wrap: wrap;
  gap: 0.6rem;
}
.perfil-api-row[_ngcontent-ng-c2301928083] {
  align-items: center;
  display: flex;
  flex-wrap: wrap;
  gap: 0.6rem;
}
.perfil-api-input[_ngcontent-ng-c2301928083] {
  flex: 1;
  font-family:
    ui-monospace,
    SFMono-Regular,
...
.perfil-copy-feedback[_ngcontent-ng-c2301928083] {
  font-size: 0.9rem;
  margin-top: 0.55rem;
}
.perfil-monitor-header[_ngcontent-ng-c2301928083] {
  display: flex;
  align-items: center;
  gap: 0.85rem;
}
.perfil-monitor-header[_ngcontent-ng-c2301928083]   p[_ngcontent-ng-c2301928083] {
  color: var(--theme-muted);
}
.perfil-monitor-icon[_ngcontent-ng-c2301928083] {
  display: grid;
  width: 3rem;
  height: 3rem;
  place-items: center;
...
.perfil-monitor-actions[_ngcontent-ng-c2301928083] {
  display: grid;
  margin-top: 1.25rem;
  gap: 0.8rem;
  grid-template-columns: repeat(2, minmax(0, 1fr));
}
.perfil-monitor-link[_ngcontent-ng-c2301928083] {
  display: grid;
  padding: 1rem;
  align-items: center;
...
.perfil-monitor-link[_ngcontent-ng-c2301928083]    > i[_ngcontent-ng-c2301928083]:first-child {
  color: var(--theme-link);
  font-size: 1.35rem;
}
.perfil-monitor-link[_ngcontent-ng-c2301928083]   span[_ngcontent-ng-c2301928083] {
  display: grid;
  gap: 0.12rem;
}
.perfil-monitor-link[_ngcontent-ng-c2301928083]   small[_ngcontent-ng-c2301928083] {
  color: var(--theme-muted);
}
.perfil-monitor-link[_ngcontent-ng-c2301928083]:hover, 
.perfil-monitor-link[_ngcontent-ng-c2301928083]:focus-visible {
  border-color: var(--theme-link);
  color: var(--theme-ink);
  transform: translateY(-2px);
}
body.theme-master.theme-dark[_nghost-ng-c2301928083]   .perfil-wrap[_ngcontent-ng-c2301928083], body.theme-master.theme-dark   [_nghost-ng-c2301928083]   .perfil-wrap[_ngcontent-ng-c2301928083], 
body.theme-master.theme-dark[_nghost-ng-c2301928083]   .perfil-wrap[_ngcontent-ng-c2301928083]   h1[_ngcontent-ng-c2301928083], body.theme-master.theme-dark   [_nghost-ng-c2301928083]   .perfil-wrap[_ngcontent-ng-c2301928083]   h1[_ngcontent-ng-c2301928083], 
body.theme-master.theme-dark[_nghost-ng-c2301928083]   .perfil-wrap[_ngcontent-ng-c2301928083]   h2[_ngcontent-ng-c2301928083], body.theme-master.theme-dark   [_nghost-ng-c2301928083]   .perfil-wrap[_ngcontent-ng-c2301928083]   h2[_ngcontent-ng-c2301928083], 
body.theme-master.theme-dark[_nghost-ng-c2301928083]   .perfil-wrap[_ngcontent-ng-c2301928083]   p[_ngcontent-ng-c2301928083], body.theme-master.theme-dark   [_nghost-ng-c2301928083]   .perfil-wrap[_ngcontent-ng-c2301928083]   p[_ngcontent-ng-c2301928083], 
body.theme-master.theme-dark[_nghost-ng-c2301928083]   .perfil-wrap[_ngcontent-ng-c2301928083]   dt[_ngcontent-ng-c2301928083], body.theme-master.theme-dark   [_nghost-ng-c2301928083]   .perfil-wrap[_ngcontent-ng-c2301928083]   dt[_ngcontent-ng-c2301928083], 
body.theme-master.theme-dark[_nghost-ng-c2301928083]   .perfil-wrap[_ngcontent-ng-c2301928083]   dd[_ngcontent-ng-c2301928083], body.theme-master.theme-dark   [_nghost-ng-c2301928083]   .perfil-wrap[_ngcontent-ng-c2301928083]   dd[_ngcontent-ng-c2301928083], 
body.theme-master.theme-dark[_nghost-ng-c2301928083]   .perfil-wrap[_ngcontent-ng-c2301928083]   a[_ngcontent-ng-c2301928083], body.theme-master.theme-dark   [_nghost-ng-c2301928083]   .perfil-wrap[_ngcontent-ng-c2301928083]   a[_ngcontent-ng-c2301928083], 
body.theme-master.theme-dark[_nghost-ng-c2301928083]   .perfil-wrap[_ngcontent-ng-c2301928083]   button[_ngcontent-ng-c2301928083], body.theme-master.theme-dark   [_nghost-ng-c2301928083]   .perfil-wrap[_ngcontent-ng-c2301928083]   button[_ngcontent-ng-c2301928083] {
  color: var(--theme-ink);
}
body.theme-master.theme-dark[_nghost-ng-c2301928083]   .perfil-card[_ngcontent-ng-c2301928083], body.theme-master.theme-dark   [_nghost-ng-c2301928083]   .perfil-card[_ngcontent-ng-c2301928083], 
body.theme-master.theme-dark[_nghost-ng-c2301928083]   .perfil-empty-state[_ngcontent-ng-c2301928083], body.theme-master.theme-dark   [_nghost-ng-c2301928083]   .perfil-empty-state[_ngcontent-ng-c2301928083], 
body.theme-master.theme-dark[_nghost-ng-c2301928083]   .perfil-section[_ngcontent-ng-c2301928083], body.theme-master.theme-dark   [_nghost-ng-c2301928083]   .perfil-section[_ngcontent-ng-c2301928083], 
body.theme-master.theme-dark[_nghost-ng-c2301928083]   .perfil-item[_ngcontent-ng-c2301928083], body.theme-master.theme-dark   [_nghost-ng-c2301928083]   .perfil-item[_ngcontent-ng-c2301928083] {
...
body.theme-master.theme-dark[_nghost-ng-c2301928083]   .perfil-avatar[_ngcontent-ng-c2301928083], body.theme-master.theme-dark   [_nghost-ng-c2301928083]   .perfil-avatar[_ngcontent-ng-c2301928083] {
  background:
    linear-gradient(
      180deg,
      rgba(33, 47, 70, 0.96),
...
body.theme-master.theme-dark[_nghost-ng-c2301928083]   .perfil-overline[_ngcontent-ng-c2301928083], body.theme-master.theme-dark   [_nghost-ng-c2301928083]   .perfil-overline[_ngcontent-ng-c2301928083] {
  color: var(--theme-muted);
}
body.theme-master.theme-dark[_nghost-ng-c2301928083]   .perfil-name[_ngcontent-ng-c2301928083], body.theme-master.theme-dark   [_nghost-ng-c2301928083]   .perfil-name[_ngcontent-ng-c2301928083] {
  color: var(--theme-ink);
}
body.theme-master.theme-dark[_nghost-ng-c2301928083]   .perfil-grid[_ngcontent-ng-c2301928083]   dt[_ngcontent-ng-c2301928083], body.theme-master.theme-dark   [_nghost-ng-c2301928083]   .perfil-grid[_ngcontent-ng-c2301928083]   dt[_ngcontent-ng-c2301928083] {
  color: var(--theme-muted);
}
body.theme-master.theme-dark[_nghost-ng-c2301928083]   .perfil-grid[_ngcontent-ng-c2301928083]   dd[_ngcontent-ng-c2301928083], body.theme-master.theme-dark   [_nghost-ng-c2301928083]   .perfil-grid[_ngcontent-ng-c2301928083]   dd[_ngcontent-ng-c2301928083] {
  color: var(--theme-ink);
}
body.theme-master.theme-dark[_nghost-ng-c2301928083]   .perfil-wrap[_ngcontent-ng-c2301928083]   .btn-primary[_ngcontent-ng-c2301928083], body.theme-master.theme-dark   [_nghost-ng-c2301928083]   .perfil-wrap[_ngcontent-ng-c2301928083]   .btn-primary[_ngcontent-ng-c2301928083] {
  background:
    linear-gradient(
      180deg,
      rgba(33, 47, 70, 0.96),
...
body.theme-master.theme-dark[_nghost-ng-c2301928083]   .perfil-wrap[_ngcontent-ng-c2301928083]   .btn-primary[_ngcontent-ng-c2301928083]:hover, body.theme-master.theme-dark   [_nghost-ng-c2301928083]   .perfil-wrap[_ngcontent-ng-c2301928083]   .btn-primary[_ngcontent-ng-c2301928083]:hover, 
body.theme-master.theme-dark[_nghost-ng-c2301928083]   .perfil-wrap[_ngcontent-ng-c2301928083]   .btn-primary[_ngcontent-ng-c2301928083]:focus-visible, body.theme-master.theme-dark   [_nghost-ng-c2301928083]   .perfil-wrap[_ngcontent-ng-c2301928083]   .btn-primary[_ngcontent-ng-c2301928083]:focus-visible {
  background:
    linear-gradient(
      180deg,
      rgba(45, 62, 90, 0.96),
...
body.theme-master.theme-dark[_nghost-ng-c2301928083]   .perfil-wrap[_ngcontent-ng-c2301928083]   .btn-outline-primary[_ngcontent-ng-c2301928083], body.theme-master.theme-dark   [_nghost-ng-c2301928083]   .perfil-wrap[_ngcontent-ng-c2301928083]   .btn-outline-primary[_ngcontent-ng-c2301928083] {
  background: rgba(18, 32, 51, 0.92);
  border-color: rgba(100, 132, 173, 0.6);
  color: var(--theme-ink);
}
body.theme-master.theme-dark[_nghost-ng-c2301928083]   .perfil-wrap[_ngcontent-ng-c2301928083]   .btn-outline-primary[_ngcontent-ng-c2301928083]:hover, body.theme-master.theme-dark   [_nghost-ng-c2301928083]   .perfil-wrap[_ngcontent-ng-c2301928083]   .btn-outline-primary[_ngcontent-ng-c2301928083]:hover, 
body.theme-master.theme-dark[_nghost-ng-c2301928083]   .perfil-wrap[_ngcontent-ng-c2301928083]   .btn-outline-primary[_ngcontent-ng-c2301928083]:focus-visible, body.theme-master.theme-dark   [_nghost-ng-c2301928083]   .perfil-wrap[_ngcontent-ng-c2301928083]   .btn-outline-primary[_ngcontent-ng-c2301928083]:focus-visible {
  background: rgba(28, 44, 68, 0.96);
  border-color: rgba(128, 160, 196, 0.7);
  color: var(--theme-ink);
}
body.theme-master.theme-dark[_nghost-ng-c2301928083]   .perfil-api-input[_ngcontent-ng-c2301928083], body.theme-master.theme-dark   [_nghost-ng-c2301928083]   .perfil-api-input[_ngcontent-ng-c2301928083] {
  background: rgba(18, 32, 51, 0.92);
  border-color: rgba(100, 132, 173, 0.6);
  color: var(--theme-ink);
}
