...
[_nghost-ng-c2467712429] {
  display: block;
}
.statistics-page[_ngcontent-ng-c2467712429] {
  background: var(--theme-bg, #f5f8fb);
  min-height: calc(100vh - 4rem);
}
.statistics-hero[_ngcontent-ng-c2467712429] {
  background:
    radial-gradient(
      circle at 85% 15%,
...
.back-link[_ngcontent-ng-c2467712429] {
  align-items: center;
...
.back-link[_ngcontent-ng-c2467712429]:hover, 
.back-link[_ngcontent-ng-c2467712429]:focus-visible {
  color: #fff;
}
.statistics-kicker[_ngcontent-ng-c2467712429] {
  font-size: 0.76rem;
  font-weight: 700;
...
h1[_ngcontent-ng-c2467712429] {
  font-size: clamp(1.6rem, 3vw, 2.5rem);
  font-weight: 750;
  letter-spacing: -0.04em;
  margin: 0;
}
.statistics-intro[_ngcontent-ng-c2467712429] {
...
.update-date[_ngcontent-ng-c2467712429] {
  align-items: center;
  display: flex;
  font-size: 0.85rem;
  gap: 0.45rem;
...
.statistics-content[_ngcontent-ng-c2467712429] {
  margin-top: clamp(-2rem, -3vw, -2.5rem);
  padding-bottom: 5rem;
  position: relative;
}
.statistics-grid[_ngcontent-ng-c2467712429] {
  display: grid;
  gap: 1rem;
  grid-template-columns: repeat(auto-fit, minmax(min(100%, 15rem), 1fr));
}
.stat-card[_ngcontent-ng-c2467712429] {
...
.stat-card[_ngcontent-ng-c2467712429]:not(.stat-card--loading):hover {
  box-shadow: 0 1.3rem 3rem rgba(11, 54, 83, 0.16);
  transform: translateY(-4px);
}
.stat-card__icon[_ngcontent-ng-c2467712429] {
  align-items: center;
...
.stat-card__total[_ngcontent-ng-c2467712429] {
...
.stat-card__label[_ngcontent-ng-c2467712429] {
...
.statistics-message[_ngcontent-ng-c2467712429] {
  align-items: center;
  background: var(--theme-card-bg, #fff);
  border: 1px solid var(--theme-line, #dce5ec);
  border-radius: 1rem;
...
.statistics-message[_ngcontent-ng-c2467712429]    > i[_ngcontent-ng-c2467712429] {
  font-size: 2rem;
}
.statistics-message[_ngcontent-ng-c2467712429]   h2[_ngcontent-ng-c2467712429] {
  font-size: 1rem;
  margin: 0;
}
.statistics-message--error[_ngcontent-ng-c2467712429]    > i[_ngcontent-ng-c2467712429] {
  color: #b42318;
}
.skeleton[_ngcontent-ng-c2467712429] {
  animation: _ngcontent-ng-c2467712429_pulse 1.35s ease-in-out infinite;
  background: #e7edf1;
  border-radius: 0.5rem;
  display: block;
}
.skeleton-icon[_ngcontent-ng-c2467712429] {
  height: 2.35rem;
  width: 2.35rem;
}
.skeleton-number[_ngcontent-ng-c2467712429] {
  height: 2rem;
  margin-top: auto;
  width: 58%;
}
.skeleton-label[_ngcontent-ng-c2467712429] {
  height: 0.8rem;
  margin-top: 0.7rem;
  width: 78%;
}
@keyframes _ngcontent-ng-c2467712429_pulse {
  50% {
    opacity: 0.48;
  }
}
...
/*# sourceMappingURL=/statistics.page.css.map */</style></head>
