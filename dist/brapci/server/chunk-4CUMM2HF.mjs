...
var ToolsTextPage = class _ToolsTextPage {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ToolsTextPage, selectors: [["app-tools-text-page"]], decls: 30, vars: 21, consts: [["aria-labelledby", "tools-text-title", 1, "tools-wrap", "py-4"], [1, "container"], [1, "tools-card", "p-4", "p-md-5"], [1, "tools-eyebrow", "mb-2"], ["id", "tools-text-title", 1, "h2", "mb-2"], [1, "tools-subtitle", "mb-4"], [1, "row", "g-3"], [1, "col-12", "col-md-6"], [1, "tool-item", "p-3", "h-100"], [1, "h5", "mb-2"], [1, "mb-0"]], template: function ToolsTextPage_Template(rf, ctx) {
    if (rf & 1) {
    ...
    if (rf & 2) {
      ...
      \u0275\u0275advance(6);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(18, 13, "tools.text.card1Title"));
      \u0275\u0275advance(3);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(21, 15, "tools.text.card1Text"));
      \u0275\u0275advance(5);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(26, 17, "tools.text.card2Title"));
      \u0275\u0275advance(3);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(29, 19, "tools.text.card2Text"));
    }
...
//# sourceMappingURL=chunk-4CUMM2HF.mjs.map
