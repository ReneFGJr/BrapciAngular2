...
function DocPage_Conditional_12_For_21_For_7_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "h3", 26);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(endpoint_r5.subgrupo);
  }
}
...
function DocPage_Conditional_12_For_21_For_7_Conditional_32_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div")(1, "dt");
...
function DocPage_Conditional_12_For_21_For_7_Conditional_35_For_20_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "tr")(1, "th", 39)(2, "code");
    \u0275\u0275text(3);
    \u0275\u0275elementEnd()();
...
function DocPage_Conditional_12_For_21_For_7_Conditional_35_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 32)(1, "table", 36)(2, "caption", 37);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "thead")(5, "tr")(6, "th", 38);
    \u0275\u0275text(7, "Nome");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275repeaterCreate(19, DocPage_Conditional_12_For_21_For_7_Conditional_35_For_20_Template, 17, 6, "tr", null, _forTrack2);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const endpoint_r5 = \u0275\u0275nextContext().$implicit;
...
function DocPage_Conditional_12_For_21_For_7_Conditional_37_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "h4", 31);
    \u0275\u0275text(1, "Exemplo de requisi\xE7\xE3o");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(2, "pre", 34)(3, "code");
    \u0275\u0275text(4);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
function DocPage_Conditional_12_For_21_For_7_Conditional_48_For_14_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "tr")(1, "th", 39)(2, "code");
    \u0275\u0275text(3);
    \u0275\u0275elementEnd()();
...
function DocPage_Conditional_12_For_21_For_7_Conditional_48_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(13, DocPage_Conditional_12_For_21_For_7_Conditional_48_For_14_Template, 9, 3, "tr", null, _forTrack2);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const endpoint_r5 = \u0275\u0275nextContext().$implicit;
...
function DocPage_Conditional_12_For_21_For_7_Conditional_49_Template(rf, ctx) {
  if (rf & 1) {
...
function DocPage_Conditional_12_For_21_For_7_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275conditionalCreate(0, DocPage_Conditional_12_For_21_For_7_Conditional_0_Template, 2, 1, "h3", 26);
    \u0275\u0275elementStart(1, "article", 27)(2, "h3", 28)(3, "span", 29);
    \u0275\u0275text(4);
    \u0275\u0275elementEnd();
    \u0275\u0275text(5);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "dl", 30)(7, "div")(8, "dt");
    \u0275\u0275text(9, "Endpoint da API");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(10, "dd")(11, "code");
    \u0275\u0275text(12);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(13, "div")(14, "dt");
    \u0275\u0275text(15, "Endpoint relativo");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(16, "dd")(17, "code");
    \u0275\u0275text(18);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(19, "div")(20, "dt");
    \u0275\u0275text(21, "Content-Type");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(22, "dd")(23, "code");
    \u0275\u0275text(24);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(25, "div")(26, "dt");
    \u0275\u0275text(27, "Precisa de APIKEY?");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(28, "dd");
    \u0275\u0275text(29);
    \u0275\u0275conditionalCreate(30, DocPage_Conditional_12_For_21_For_7_Conditional_30_Template, 1, 1);
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(31, DocPage_Conditional_12_For_21_For_7_Conditional_31_Template, 5, 1, "div");
    \u0275\u0275conditionalCreate(32, DocPage_Conditional_12_For_21_For_7_Conditional_32_Template, 6, 1, "div");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(33, "h4", 31);
    \u0275\u0275text(34, "Vari\xE1veis da API");
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(35, DocPage_Conditional_12_For_21_For_7_Conditional_35_Template, 21, 1, "div", 32)(36, DocPage_Conditional_12_For_21_For_7_Conditional_36_Template, 2, 0, "p", 33);
    \u0275\u0275conditionalCreate(37, DocPage_Conditional_12_For_21_For_7_Conditional_37_Template, 5, 1);
    \u0275\u0275elementStart(38, "h4", 31);
    \u0275\u0275text(39, "Resultado da API");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(40, "p");
    \u0275\u0275text(41);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(42, "pre", 34)(43, "code");
    \u0275\u0275text(44);
    \u0275\u0275pipe(45, "json");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(46, "h4", 31);
    \u0275\u0275text(47, "Vari\xE1veis de retorno");
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(48, DocPage_Conditional_12_For_21_For_7_Conditional_48_Template, 15, 1, "div", 32)(49, DocPage_Conditional_12_For_21_For_7_Conditional_49_Template, 2, 0, "p", 35);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const endpoint_r5 = ctx.$implicit;
    const $index_r8 = ctx.$index;
    const \u0275$index_77_r9 = ctx.$index;
    const group_r10 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275conditional(endpoint_r5.subgrupo && (\u0275$index_77_r9 === 0 || endpoint_r5.subgrupo !== group_r10.endpoints[$index_r8 - 1].subgrupo) ? 0 : -1);
    \u0275\u0275advance(4);
    ...
    \u0275\u0275advance();
    \u0275\u0275conditional((endpoint_r5.apikey == null ? null : endpoint_r5.apikey.descricao) ? 30 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(endpoint_r5.autenticacao ? 31 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(endpoint_r5.metodo_servico ? 32 : -1);
    \u0275\u0275advance(3);
    \u0275\u0275conditional(endpoint_r5.variaveis_api.length ? 35 : 36);
    \u0275\u0275advance(2);
    \u0275\u0275conditional(endpoint_r5.exemplo_requisicao ? 37 : -1);
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(endpoint_r5.resultado_api.descricao);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(45, 15, endpoint_r5.resultado_api.exemplo));
    \u0275\u0275advance(4);
    \u0275\u0275conditional(endpoint_r5.variaveis_retorno_api.length ? 48 : 49);
  }
}
function DocPage_Conditional_12_For_21_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(5);
    \u0275\u0275elementEnd()();
    \u0275\u0275repeaterCreate(6, DocPage_Conditional_12_For_21_For_7_Template, 50, 17, null, null, _forTrack1);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const group_r10 = ctx.$implicit;
    const $index_r11 = ctx.$index;
    \u0275\u0275attribute("aria-labelledby", "group-" + $index_r11);
    \u0275\u0275advance(2);
    \u0275\u0275property("id", "group-" + $index_r11);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(group_r10.nome);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(group_r10.descricao);
    \u0275\u0275advance();
    \u0275\u0275repeater(group_r10.endpoints);
  }
}
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(DocPage, [{
    type: Component,
    args: [{ selector: "app-doc-page", imports: [CommonModule, BreadcrumbsComponent], template: `<main class="doc-wrap py-4" aria-labelledby="doc-title">\r
  <div class="container">\r
    <app-breadcrumbs></app-breadcrumbs>\r
\r
    <section class="doc-card p-4 p-md-5">\r
      <p class="doc-eyebrow mb-2">Documenta\xE7\xE3o</p>\r
      <h1 id="doc-title" class="h2 mb-2">Documenta\xE7\xE3o da API</h1>\r
      <p class="doc-subtitle mb-4">Consulte os grupos e endpoints utilizados pela Brapci.</p>\r
\r
      @if (loading()) {\r
        <p class="doc-status mb-0" role="status">Carregando documenta\xE7\xE3o\u2026</p>\r
      } @else if (error()) {\r
        <div class="alert alert-danger mb-0" role="alert">\r
          <p class="mb-3">{{ error() }}</p>\r
          <button type="button" class="btn btn-outline-danger" (click)="loadDocumentation()">Tentar novamente</button>\r
        </div>\r
      } @else {\r
        <section class="doc-filters mb-4" aria-labelledby="filters-title">\r
          <h2 id="filters-title" class="visually-hidden">Filtros da documenta\xE7\xE3o</h2>\r
          <div>\r
            <label for="api-group" class="form-label">Grupo da API</label>\r
            <select\r
              id="api-group"\r
              class="form-select"\r
              [value]="selectedGroup()"\r
              (change)="setSelectedGroup($any($event.target).value)"\r
            >\r
              <option value="">Todos os grupos</option>\r
              @for (group of groups(); track group.arquivo) {\r
                <option [value]="group.nome">{{ group.nome }}</option>\r
              }\r
            </select>\r
          </div>\r
          <div>\r
            <label for="api-search" class="form-label">Buscar na documenta\xE7\xE3o</label>\r
            <input\r
              id="api-search"\r
              type="search"\r
              class="form-control"\r
              placeholder="Endpoint, vari\xE1vel ou descri\xE7\xE3o"\r
              [value]="searchQuery()"\r
              (input)="setSearchQuery($any($event.target).value)"\r
            />\r
          </div>\r
          <div class="filter-action">\r
            <button type="button" class="btn btn-outline-secondary" (click)="clearFilters()">Limpar filtros</button>\r
          </div>\r
        </section>\r
\r
        <p class="doc-status mb-4" role="status" aria-live="polite">\r
          {{ visibleEndpointCount() }} {{ visibleEndpointCount() === 1 ? 'endpoint encontrado' : 'endpoints encontrados' }}.\r
        </p>\r
\r
        @for (group of visibleGroups(); track group.arquivo) {\r
          <section class="api-group mb-5" [attr.aria-labelledby]="'group-' + $index">\r
            <header class="group-header mb-3">\r
              <h2 [id]="'group-' + $index" class="h3 mb-2">{{ group.nome }}</h2>\r
              <p class="doc-subtitle mb-0">{{ group.descricao }}</p>\r
            </header>\r
\r
            @for (endpoint of group.endpoints; track endpoint.endpoint_api.metodo + endpoint.endpoint_api.url) {\r
              @if (endpoint.subgrupo && ($first || endpoint.subgrupo !== group.endpoints[$index - 1].subgrupo)) {\r
                <h3 class="h4 mt-4 mb-3">{{ endpoint.subgrupo }}</h3>\r
              }\r
              <article class="endpoint-card mb-4">\r
                <h3 class="h5 mb-3">\r
                  <span class="method-badge">{{ endpoint.endpoint_api.metodo }}</span>\r
                  {{ endpoint.nome || endpoint.endpoint_api.endpoint_relativo }}\r
                </h3>\r
\r
                <dl class="endpoint-grid mb-4">\r
                  <div><dt>Endpoint da API</dt><dd><code>{{ endpoint.endpoint_api.url }}</code></dd></div>\r
                  <div><dt>Endpoint relativo</dt><dd><code>{{ endpoint.endpoint_api.endpoint_relativo }}</code></dd></div>\r
                  <div><dt>Content-Type</dt><dd><code>{{ endpoint.endpoint_api.content_type_resposta }}</code></dd></div>\r
                  <div>\r
                    <dt>Precisa de APIKEY?</dt>\r
                    <dd>{{ endpoint.precisa_apikey ? 'Sim' : 'N\xE3o' }}@if (endpoint.apikey?.descricao) { \u2014 {{ endpoint.apikey?.descricao }} }</dd>\r
                  </div>\r
                  @if (endpoint.autenticacao) { <div><dt>Autentica\xE7\xE3o</dt><dd>{{ endpoint.autenticacao }}</dd></div> }\r
                  @if (endpoint.metodo_servico) { <div><dt>M\xE9todo no servi\xE7o</dt><dd><code>{{ endpoint.metodo_servico }}</code></dd></div> }\r
                </dl>\r
\r
                <h4 class="h6 mt-4">Vari\xE1veis da API</h4>\r
                @if (endpoint.variaveis_api.length) {\r
                  <div class="table-responsive">\r
                    <table class="table doc-table align-middle mb-0">\r
                      <caption class="visually-hidden">Par\xE2metros de {{ endpoint.endpoint_api.endpoint_relativo }}</caption>\r
                      <thead><tr><th scope="col">Nome</th><th scope="col">Local</th><th scope="col">Tipo</th><th scope="col">Obrigat\xF3ria</th><th scope="col">Descri\xE7\xE3o</th><th scope="col">Exemplo</th></tr></thead>\r
                      <tbody>\r
                        @for (variable of endpoint.variaveis_api; track variable.nome) {\r
                          <tr><th scope="row"><code>{{ variable.nome }}</code></th><td><code>{{ variable.local || '\u2014' }}</code></td><td><code>{{ variable.tipo }}</code></td><td>{{ variable.obrigatoria ? 'Sim' : 'N\xE3o' }}</td><td>{{ variable.descricao }}</td><td><code>{{ variable.exemplo || '\u2014' }}</code></td></tr>\r
                        }\r
                      </tbody>\r
                    </table>\r
                  </div>\r
                } @else { <p class="doc-status">Este endpoint n\xE3o recebe vari\xE1veis.</p> }\r
\r
                @if (endpoint.exemplo_requisicao) {\r
                  <h4 class="h6 mt-4">Exemplo de requisi\xE7\xE3o</h4>\r
                  <pre class="code-block"><code>{{ endpoint.exemplo_requisicao }}</code></pre>\r
                }\r
\r
                <h4 class="h6 mt-4">Resultado da API</h4>\r
                <p>{{ endpoint.resultado_api.descricao }}</p>\r
                <pre class="code-block"><code>{{ endpoint.resultado_api.exemplo | json }}</code></pre>\r
\r
                <h4 class="h6 mt-4">Vari\xE1veis de retorno</h4>\r
                @if (endpoint.variaveis_retorno_api.length) {\r
                  <div class="table-responsive">\r
                    <table class="table doc-table align-middle mb-0">\r
                      <caption class="visually-hidden">Campos retornados por {{ endpoint.endpoint_api.endpoint_relativo }}</caption>\r
                      <thead><tr><th scope="col">Nome</th><th scope="col">Tipo</th><th scope="col">Descri\xE7\xE3o</th></tr></thead>\r
                      <tbody>\r
                        @for (variable of endpoint.variaveis_retorno_api; track variable.nome) {\r
                          <tr><th scope="row"><code>{{ variable.nome }}</code></th><td><code>{{ variable.tipo }}</code></td><td>{{ variable.descricao }}</td></tr>\r
                        }\r
                      </tbody>\r
                    </table>\r
                  </div>\r
                } @else { <p class="doc-status mb-0">Este endpoint n\xE3o retorna conte\xFAdo documentado.</p> }\r
              </article>\r
            }\r
          </section>\r
        } @empty {\r
          <div class="alert alert-info mb-0" role="status">Nenhuma documenta\xE7\xE3o corresponde aos filtros informados.</div>\r
        }\r
      }\r
    </section>\r
  </div>\r
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(DocPage, { className: "DocPage", filePath: "src/app/pages/doc/doc.page.ts", lineNumber: 63 });
})();
export {
  DocPage
};
//# sourceMappingURL=chunk-RULMUBHI.mjs.map
