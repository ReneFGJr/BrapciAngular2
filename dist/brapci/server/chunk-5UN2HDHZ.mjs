...
var ToolsBibliograficsPage = class _ToolsBibliograficsPage {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ToolsBibliograficsPage, selectors: [["app-tools-bibliografics-page"]], decls: 30, vars: 21, consts: [["aria-labelledby", "tools-title", 1, "tools-wrap", "py-4"], [1, "container"], [1, "tools-card", "p-4", "p-md-5"], [1, "tools-eyebrow", "mb-2"], ["id", "tools-title", 1, "h2", "mb-2"], [1, "tools-subtitle", "mb-4"], [1, "row", "g-3"], [1, "col-12", "col-md-6"], [1, "tool-item", "p-3", "h-100"], [1, "h5", "mb-2"], [1, "mb-0"]], template: function ToolsBibliograficsPage_Template(rf, ctx) {
    if (rf & 1) {
    ...
    if (rf & 2) {
      ...
      \u0275\u0275advance(3);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(9, 9, "tools.bibliographics.title"));
      \u0275\u0275advance(3);
      \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(12, 11, "tools.bibliographics.subtitle"), " ");
      \u0275\u0275advance(6);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(18, 13, "tools.bibliographics.card1Title"));
      \u0275\u0275advance(3);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(21, 15, "tools.bibliographics.card1Text"));
      \u0275\u0275advance(5);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(26, 17, "tools.bibliographics.card2Title"));
      \u0275\u0275advance(3);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(29, 19, "tools.bibliographics.card2Text"));
    }
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(ToolsBibliograficsPage, [{
    type: Component,
    args: [{ selector: "app-tools-bibliografics-page", imports: [CommonModule, TranslateModule, BreadcrumbsComponent], template: `<section class="tools-wrap py-4" aria-labelledby="tools-title">\r
      ...
      <div class="row g-3">\r
        <div class="col-12 col-md-6">\r
          <article class="tool-item p-3 h-100">\r
            <h2 class="h5 mb-2">{{ 'tools.bibliographics.card1Title' | translate }}</h2>\r
            <p class="mb-0">{{ 'tools.bibliographics.card1Text' | translate }}</p>\r
          </article>\r
        </div>\r
        <div class="col-12 col-md-6">\r
          <article class="tool-item p-3 h-100">\r
            <h2 class="h5 mb-2">{{ 'tools.bibliographics.card2Title' | translate }}</h2>\r
            <p class="mb-0">{{ 'tools.bibliographics.card2Text' | translate }}</p>\r
          </article>\r
        </div>\r
      </div>\r
    </div>\r
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ToolsBibliograficsPage, { className: "ToolsBibliograficsPage", filePath: "src/app/pages/tools-bibliografics/tools-bibliografics.page.ts", lineNumber: 12 });
})();
export {
  ToolsBibliograficsPage
};
//# sourceMappingURL=chunk-5UN2HDHZ.mjs.map
