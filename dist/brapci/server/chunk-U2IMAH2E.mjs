...
`)+`
`+p);let A=S+m+o,T=S+p+s,R=rf(r,r.VERTEX_SHADER,A),I=rf(r,r.FRAGMENT_SHADER,T);r.attachShader(b,R),r.attachShader(b,I),t.index0AttributeName!==void 0?r.bindAttribLocation(b,0,t.index0AttributeName):t.morphTargets===!0&&r.bindAttribLocation(b,0,"position"),r.linkProgram(b);function O(k){if(n.debug.checkShaderErrors){let F=r.getProgramInfoLog(b)||"",X=r.getShaderInfoLog(R)||"",Z=r.getShaderInfoLog(I)||"",j=F.trim(),Y=X.trim(),G=Z.trim(),de=!0,oe=!0;if(r.getProgramParameter(b,r.LINK_STATUS)===!1)if(de=!1,typeof n.debug.onShaderError=="function")n.debug.onShaderError(r,b,R,I);else{let ve=of(r,R,"vertex"),Pe=of(r,I,"fragment");We("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(b,r.VALIDATE_STATUS)+`
